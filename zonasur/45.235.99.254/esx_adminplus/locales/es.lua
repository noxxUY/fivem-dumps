Locales['es'] = {
  ...
  ['report']           = '^1REPORTE ^2[%s | %s]^0 : %s',
  ['invalid_input']    = '^1[%s]^0 ID inválido',
  ['admin_announce']   = '^1Anuncio ^2[^0%s^2] ^0: %s',
  ['server_announce']  = '^1Anuncio ^0: %s',
  ...
  ['playerkicked']     = '^1[WARN] : ^0El jugador[^1%s^0] ha sido enviado a la JAILOOC por tener ^4[%s/%s advertencias^4]',
