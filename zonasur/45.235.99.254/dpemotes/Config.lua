...
-- Set this to true to enable some extra prints
	DebugDisplay = false,
-- Establezca esto en falso si tiene algo más en X, y luego use / e c para cancelar emoticonos.
	EnableXtoCancel = true,
-- Establezca esto en verdadero si desea desarmar al jugador cuando juega un emote.
	DisarmPlayer = true,
-- Configure esto si realmente desea deshabilitar los gestos en los automóviles, a partir de 1.7.2 solo juegan la parte superior del cuerpo si están en el vehículo
    AllowedInCars = true,
...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.imgur.com/4DBkN38.png",
-- You can change the menu position here
	MenuPosition = "right", -- (left, right)
-- You can disable the Ragdoll keybinding here.
	RagdollEnabled = true,
	RagdollKeybind = 312, -- Get the button number here https://docs.fivem.net/game-references/controls/
