...
Config.MotelPrice = 10000
Config.HoraDeCobro = {["h"] = 7, ["m"]=5}
...
Config.MotelInterior = {
    ["exit"] = vector3(351.9689, -92.6139, 20.939),
    ["drawer"] = vector3(351.9404, -88.0518, 20.939), --inventario
    ["wardrobe"] = vector3(352.4155, -86.1244, 20.939), --ropa
    ["invite"] = vector3(353.4301, -92.7301, 20.939)
}

--Motel abajo de plaza Cubos
--[[
Config.MotelInterior = {
...
Config.Garage = {
	["Motel"] = {
		Marker = {x=313.31,y=-224.99,z=54.22},
		Spawner = {x=321.3110, y=-216.011, z=53.318},
		Deleter = {x=327.49, y=-205.39, z=54.08},
		Heading = 159.29
	}	
}
...
--[[
Config.MotelInterior = {
    ["exit"] = vector3(326.48,-214.38,40.52),
    ["drawer"] = vector3(321.77,-212.79,40.52),
    ["wardrobe"] = vector3(320.42,-211.69,40.52),
    ["invite"] = vector3(326.89,-212.05,40.52)
}
]]
Config.ActionLabel = {
    ["exit"] = "Salir",
