WeaponNames = {
			   ...
			   [tostring(GetHashKey('WEAPON_DOUBLEACTION'))] = 'Revolver Doble Accion',
			   ...
			   [tostring(GetHashKey('WEAPON_ASSAULTRIFLE_MK2'))] = 'AK47 MK2',
			   [tostring(GetHashKey('WEAPON_CARBINERIFLE_MK2'))] = 'CARABINA MK2',
}
