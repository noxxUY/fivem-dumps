...
Config.AuthorizedVehicles = {
	{model = 'taxi', label = 'Corsa'},
	{model = 'taxi2', label = 'Impala'},
}

Config.Zones = {

	VehicleSpawner = {
		Pos   = {x = 893.48, y = -162.89, z = 76.89},
