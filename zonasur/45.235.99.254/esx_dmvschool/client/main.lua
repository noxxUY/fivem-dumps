...
function StartTheoryTest()
	...
	TriggerServerEvent('esx_dmvschool:pay_zs', Config.Prices['dmv'])
end
...
function StopTheoryTest(success)
	...
	if success then
		TriggerServerEvent('esx_dmvschool:addLicense_zs', 'dmv')
...
function StartDriveTest(type)
	...
	TriggerServerEvent('esx_dmvschool:pay_zs', Config.Prices[type])
end

function StopDriveTest(success)
	if success then
		TriggerServerEvent('esx_dmvschool:addLicense_zs', CurrentTestType)
		ESX.ShowNotification(_U('passed_test'))
		start = true
	else
		ESX.ShowNotification(_U('failed_test'))
...
function OpenDMVSchoolMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'dmvschool_actions', {
		...
		if data.current.value == 'theory_test' then
			menu.close()
			StartTheoryTest()
		elseif data.current.value == 'drive_test' and start then
			start = false
