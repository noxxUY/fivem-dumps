...
RegisterNetEvent("gcPhone:tchat_channel_zs")
AddEventHandler("gcPhone:tchat_channel_zs", function(channel, messages)
...
RegisterNUICallback('tchat_getChannel', function(data, cb)
  TriggerServerEvent('gcPhone:tchat_channel_zs', data.channel)
end)
