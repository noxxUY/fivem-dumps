...
AddEventHandler('gcphone:bankTransferByPhoneNumber', function(data)
	ESX.TriggerServerCallback('1974_drogas:check', function(serial)	
		TriggerServerEvent('gcPhone:bankTransferByPhoneNumber', serial, data.phoneNumber, data.amount)
...
AddEventHandler('gcphone:bankTransferById', function(data)
	ESX.TriggerServerCallback('1974_drogas:check', function(serial)	
		TriggerServerEvent('bank:transfer_zs', serial, tonumber(data.id), tonumber(data.amount))
		TriggerServerEvent('bank:balance')
	end)
end)