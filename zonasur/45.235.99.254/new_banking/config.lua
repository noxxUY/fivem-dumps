...
Config.Bank = {
    [1] = {coords = vector3(150.266, -1040.203, 29.374), name = 'Banco Macro'},
    [2] = {coords = vector3(-1212.980, -330.841, 37.787), name = 'Banco Santander'},
    [3] = {coords = vector3(-2962.582, 482.627, 15.703), name = 'Banco Galicia'},--Galicia!
    [4] = {coords = vector3(-112.202, 6469.295, 31.626), name = 'Banco Paleto'}, --Paleto
    [5] = {coords = vector3(314.187, -278.621, 54.170), name = 'Banco HSBC'}, --Frente motel de ciudad
    [6] = {coords = vector3(-351.534, -49.529, 49.042), name = 'Banco Provincia'},--Provincia
    [7] = {coords = vector3(1175.0643310547, 2706.6435546875, 38.094036102295), name = 'Banco Sandy'},
	[8] = {coords = vector3(-1373.914,-496.2545,32.23553), name = 'Maze Bank'},--mazebank
}


Config.ATM = {
	--vector3(-1308.63, -823.621, 17.148),--mazebank
	--vector3(150.266, -1040.203, 29.374),--Macro
    --vector3(-1212.980, -330.841, 37.787), --santander
    --vector3(-2962.582, 482.627, 15.703),--Galicia!
    --vector3(-112.202, 6469.295, 31.626), --Paleto
    --vector3(314.187, -278.621, 54.170), --Frente motel de ciudad
    --vector3(-351.534, -49.529, 49.042),--Provincia
    --vector3(241.727, 220.706, 106.286),
	vector3(816.6347,-929.357,32.277), --mapeo meca atras de comisaria
	vector3(360.0302, -580.3787, 27.82706), --PILLBOX VIEJO
	vector3(904.3262, -164.39, 73.21091),
	vector3(-1110.228, -1691.154, 3.378482),
	--vector3(349.7129,-595.0529,27.77245), pillbox gabz
	--vector3(314.5653,-593.5123,42.29851),
	vector3(-3030.781,60.8292,10.60544), --cajero skyboys boliche playa
	vector3(120.6105, -3019.658, 6.043144), --Cajero Mecanico Camionero
    vector3(1175.0643310547, 2706.6435546875, 38.094036102295),
	vector3(424.6979, -990.8044, 30.02898), --Policia Ciudad
	vector3(-1232.243, -905.6893, 11.04545), --TIENDA
	vector3(328.5948, -1373.231, 31.17219), --hospital central medical v2 depo
	vector3(-809.8352, -1237.863, 6.35179), --HOSPITAL viceroy
	vector3(-322.3208, -1538.853, 26.76085), --BASURERO
    vector3(155.631, -3210.594, 6.064701), --CAMIONEROS 155.631, -3210.594, 6.064701 //155.631, -3210.594, 6.064701
	--vector3(349.7129, -595.0529, 27.77245), --hospital nuevo
	--vector3(314.5653, -593.5123, 42.29851), --hospital nuevo2
	vector3(231.0896, -758.5712, 29.81948), --GC
	vector3(1032.858, -2313.242, 29.56746), --mecanico
	vector3(408.0962, -1614.769, 28.29205), --deposito
	vector3(-37.66431, -1115.599, 25.43752), --venta de autos -37.66431, -1115.599, 25.43752
	vector3(-30.3456, 6308.201, 30.2649), --polleria -30.3456, 6308.201, 30.2649
	--vector3(924.3036, 40.13145, 79.89788), --casino
	vector3(-1385.719, -597.2892, 29.31816), --Bahamas
	...
	vector3(2683.05, 3286.66, 54.24),
	vector3(-1091.887, 2709.053, 17.91941),
	vector3(1646.285, 3807.284, 34.11143),
	vector3(1094.043, 215.8757, -49.99838),
}
