...
mumbleConfig = {
	...
	voiceModes = {
		{2.5, "Susurrar"}, -- Whisper speech distance in gta distance units
		{8.0, "Normal"}, -- Normal speech distance in gta distance units
		{20.0, "Gritar"}, -- Shout speech distance in gta distance units
	},
	...
	externalPort = 30120,
	use2dAudioInVehicles = false, -- Solución alternativa para escuchar a los pasajeros del vehículo a altas velocidades
