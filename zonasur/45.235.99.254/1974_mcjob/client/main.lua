...
function IsJobTrue()
    if PlayerData.job ~= nil then
        ...
        if PlayerData.job.name == 'mc' or PlayerData.identifier == Config.Owner then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function OpenPutArmas()
	ESX.TriggerServerCallback('esx_mcjob:getPlayerInventory', function(inventory)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			menu.close()
			TriggerServerEvent('esx_mcjob:putStockItems', data.current.type, data.current.value, data.current.ammo)
			Citizen.Wait(300)
			OpenPutArmas()
...
function OpenGetStocksMenuArmas()
	ESX.TriggerServerCallback('esx_mcjob:getStockItems', function(inventory)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu_armas',
		{
			...
			menu.close()
			TriggerServerEvent('esx_mcjob:getStockItem', data.current.type, data.current.value, data.current.ammo)
			Citizen.Wait(300)
			OpenGetStocksMenuArmas()
		end, function(data, menu)
			menu.close()
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'mc', vehicleProps)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'mc_actions',
    {
      title    = _U('mc'),
      align    = 'bottom-right',
      elements = elements
      ...
      if data.current.value == 'menu_crafting' then
          ...
          ESX.UI.Menu.Open(
              ...
              function(data2, menu2)
                ...
                TriggerServerEvent('esx_mcjob:craftingCoktails', data2.current.value)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill_zs', GetPlayerServerId(player), 'society_mc_boss', _U('billing'), amount)
        end
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if count == nil then
					...
					menu.close()
					TriggerServerEvent('esx_mcjob:getStockItem', tipo, itemName, count)
					Citizen.Wait(300)
					OpenGetStocksMenu()
				end
			end, function(data, menu)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu',
		{
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
					...
					if count == nil then
						...
						--menu2.close()
						menu.close()
						TriggerServerEvent('esx_mcjob:putStockItems', tipo, itemName, count)
						Citizen.Wait(300)
						OpenPutStocksMenu(enclosure)
					end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_mcjob:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mcjob:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mcjob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_mcjob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_mcjob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_mcjob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'mc_shop',
        {
            title    = _U('shop'),
			align = 'bottom-right',
            elements = elements
        ...
        function(data, menu)
            TriggerServerEvent('esx_mcjob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('esx_mcjob:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_mcjob:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_mcjob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_mcjob:hasExitedMarker', LastZone)
            end
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlJustReleased(0,  38) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'mc', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'mc')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
			...
			ESX.UI.Menu.CloseAll()
				...
				TriggerEvent('esx_society:openBossMenu_zs', 'mc', function(data, menu)
					menu.close()
					CurrentAction     = 'menu_boss_actions'
					CurrentActionMsg  = _U('open_bossmenu')
					CurrentActionData = {}
	...
	--[[
    if IsControlJustReleased(0,  167) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mc_actions') then
...
AddEventHandler('esx_mcjob:teleportMarkers', function(position)
  ...
  while true do
    ...
    if IsJobTrue() then
        ...
        if IsControlJustReleased(0, 38) and isInPublicMarker then
          TriggerEvent('esx_mcjob:teleportMarkers', position)
        end
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if data.current.value == 'comprar' then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'compra_menu',
			{
				...
				TriggerServerEvent('esx_mcjob:comprar_item', data2.current.value, data2.current.price)	
				menu2.close()
