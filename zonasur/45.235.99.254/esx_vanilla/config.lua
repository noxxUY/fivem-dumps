...
Config.Venta = {
	Barman1 = vector3(95.61722,-1274.93,21.111),
...
Config.Sillones = {
	vector4(119.3196, -1302.806, 28.27024, 209.60009765625),
	vector4(117.0966, -1304.093, 28.26131, 209.9994354248),
	vector4(115.0163, -1305.305, 28.27035, 209.99961853027),
	vector4(113.0544, -1306.443, 28.27139, 209.99971008301),
}
...
Config.AuthorizedVehicles = {
    { name = 'rentalbus',  label = 'Vanilla Bus' },
}

Config.Blips = {  
    Blip = {
      Pos     = { x = 120.72, y = -1281.12, z = 29.48 },
      Sprite  = 121,
      Display = 4,
      Scale   = 0.8,
      Colour  = 48,
...
Config.Zones = {
    ...
    Cloakrooms = {
        Pos   = { x=93.26782, y=-1291.64, z=29.268 - 0.95},
    ...
    Vaults = {
        Pos   = { x=108.7396, y=-1304.39, z=28.768 - 0.95},
    ...
    BossActions = {
        Pos   = { x=94.78189, y=-1292.53, z=29.268 -1.0 },
        Size  = { x = 1.5, y = 1.5, z = 1.0 },
        Color = { r = 0, g = 100, b = 0 },
        Type  = 1,
    },
