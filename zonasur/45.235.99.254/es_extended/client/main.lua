...
AddEventHandler('esx:playerLoaded', function(playerData)
	...
	ESX.Game.Teleport(PlayerPedId(), {
		...
		TriggerServerEvent('1974_armor:get')
		
		--TriggerEvent('tm1_mafias:spawn')
		--[[
		TriggerServerEvent('esx:onPlayerSpawn')
		TriggerEvent('esx:onPlayerSpawn')
		TriggerEvent('playerSpawned') -- compatibility with old scripts, will be removed soon
...
AddEventHandler('esx:spawnVehicle', function(vehicleName)
	...
	if IsModelInCdimage(model) then
		...
		TriggerEvent('chat:addMessage', {args = {'^1ZONASUR-RP', 'Invalid vehicle model.'}})
	end
end)
...
RegisterNetEvent('esx:deleteVehicleDv')
AddEventHandler('esx:deleteVehicleDv', function()
    local playerPed = PlayerPedId()
...
AddEventHandler('esx:daritem', function(item)
	if item == 'bread' then
	...
	elseif item == 'apple' then
		prop = 'ng_proc_food_aple1a'
	elseif item == 'bkr_prop_meth_openbag_01a' then
		prop = 'bkr_prop_meth_openbag_01a'
	elseif item == 'bkr_prop_weed_bigbag_01a' then
		prop = 'bkr_prop_weed_bigbag_01a'
	elseif item == 'bkr_prop_coke_cutblock_01' then
...
--prop_choc_meto
	...
	if not IsAnimated then
		...
		Citizen.CreateThread(function()
			...
			AttachEntityToEntity(prop, playerPed, GetPedBoneIndex(playerPed, 28422), 0.0, 0.0, 0.001, 10.0, 175.0, 0.0, true, true, false, true, 1, true)
			RequestAnimDict('mp_common')
			while not HasAnimDictLoaded('mp_common') do
				Citizen.Wait(10)
			end
			TaskPlayAnim(playerPed, 'mp_common', 'givetake1_a', 8.0, -8, -1, 0, 0, false, false, false )
			Citizen.Wait(3000)
			IsAnimated = false
	...
	--[[
	if arma then
		AddAmmoToPed(playerPed, item, balas)
	end
	]]
end)

RegisterNetEvent('esx:reciveitem')
AddEventHandler('esx:reciveitem', function()
if not IsAnimated then
		local prop_name = prop
		IsAnimated = true
		local playerPed = GetPlayerPed(-1)
