...
Config.JobVehiclePlate = 'ZONASUR' -- Plaque des vehicules du job (maximun 8 caractères)
...
Config.Caution 		   = 2000
Config.PricePerLetter  = 400
Config.PricePerColis   = 550
...
Config.Livraisons = {
	...
	SLS = {
		Pos = {
			...
			{x=-24.2865, y=-1846.51, z=25.323, letter = true, colis = false},
