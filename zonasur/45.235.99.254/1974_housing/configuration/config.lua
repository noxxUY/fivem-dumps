...
Config.EnableGarage = true -- requires my (loaf) garage
...
Config.IKEA = {
    EnterIKEA = vector4(63.95, -1728.98, 29.62, 250.0),
...
Config.ResellHouse = {
    ResellPercent = 80, -- the percent of money they get back from the original price
}
...
Shells = {
    ["k4mb1"] = {
        ...
        ['HighEndHouse'] = {
            {
                object = "interior_002_int",
            },
            {
                object = "interior_001_int",
            },
			{
                object = "interior_010",
            },
...
Config.ShellOffsets = {
	...
	['interior_010'] = vector3(2.159008, -1.723267, -1.6966553),
	['interior_001_int'] = vector3(3.569976, -4.723633, -1.8398764),
	['interior_002_int'] = vector3(4.978963, 5.327271, -4.94317),
	['shell_ranch'] = vector3(-0.6, -5.39, -2.41),
...
Config.Houses = {
	...
	--casa numero 10
    {
        ...
        ShellType = "HighEndHouse",
        Garage = {
            Exit = vector4(-684.561,493.7623,109.79,194.2008972168),
            Entrance = vector3(-691.913,504.7825,110.26),
        },
    },
    {
        Label = "Vinewood Hills",
    ...
    },
    {
		...
		Garage = {
            Entrance = vector3(1375.677,-1517.92,57.696),
            Exit = vector4(1372.834,-1520.48,56.687,195.35256958008),
        }
    },
    {
        Label = "Grove St",
    ...
    },
    {
		...
		Garage = {
            Entrance = vector3(481.6802,-1716.02,29.364),
            Exit = vector4(482.4519,-1719.14,28.709,248.19543457031),
        }
    },
    {
        Label = "Jamestown St",
	...
	--205
    {
        ...
        Garage = {
            Entrance = vector3(1392.789,-607.894,74.347),
            Exit = vector4(1378.182,-596.475,73.568,54.899791717529),
        }
    },
    {
        Label = "Mirror Park",
    ...
    },
	{
        ...
        ShellType = "HighEndHouse",
        Price = 6000000,
        Entrance = vector4(-339.479, 625.6582, 171.35, 57.56),
        Garage = {
            Entrance = vector3(-338.015, 630.1168, 172.35),
            Exit = vector4(-340.622, 632.1862, 171.58, 54.63),
        }
    },
	{
        Label = "Costa Pesquero",
        Type = "house",
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-3017.00,746.7830,27.783,124.36694335938),
        Garage = {
            Entrance = vector3(-3014.78,740.8417,27.587),
            Exit = vector4(-3017.87,739.9531,26.808,108.09582519531),
        }
    },
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-3107.88,718.7935,20.660,286.6328125),
        Garage = {
            Entrance = vector3(-3106.77,723.2990,20.530),
            Exit = vector4(-3103.08,724.1152,20.069,284.15832519531),
        }
    },
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-3101.75,744.0142,21.284,229.27586364746),
        Garage = {
            Entrance = vector3(-3098.49,747.1825,21.284),
            Exit = vector4(-3095.92,744.9988,20.303,229.99420166016),
        }
    },
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-3077.98,658.8157,11.665,309.35696411133),
        Garage = {
            Entrance = vector3(-3075.44,655.3234,11.613),
            Exit = vector4(-3072.19,657.8665,10.231,309.16381835938),
        }
    },
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-3030.05,568.5498,7.8823,280.41864013672),
        Garage = {
            Entrance = vector3(-3030.23,572.8647,7.8216),
            Exit = vector4(-3026.43,573.6914,6.8937,281.39196777344),
        }
    },
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-3037.34,559.2146,7.5076,272.51376342773),
        Garage = {
            Entrance = vector3(-3035.68,555.3652,7.5076),
            Exit = vector4(-3031.95,555.6179,6.7375,272.19396972656),
        }
    },
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-2997.53,723.2318,28.688,197.83639526367),
        Garage = {
            Entrance = vector3(-2991.04,706.4907,28.496),
            Exit = vector4(-2996.64,703.9468,27.567,112.1196975708),
        }
    },
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-2994.40,682.5889,25.054,107.52179718018),
        Garage = {
            Entrance = vector3(-2996.39,688.4145,25.476),
            Exit = vector4(-3000.57,686.8758,23.874,107.56629943848),
        }
    },
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-2972.54,642.5335,25.992,105.35264587402),
        Garage = {
            Entrance = vector3(-2977.53,655.8581,25.797),
            Exit = vector4(-2982.86,654.3002,24.188,106.38461303711),
        }
    },
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-2972.20,598.8835,24.441,68.10417175293),
        Garage = {
            Entrance = vector3(-2977.86,613.4588,20.245),
            Exit = vector4(-2982.12,612.4039,19.363,103.97897338867),
        }
    },
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-3088.87,392.2810,11.447,251.12216186523),
        Garage = {
            Entrance = vector3(-3078.18,392.9513,6.9685),
            Exit = vector4(-3073.52,391.6345,6.2003,250.89733886719),
        }
    },
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-3071.06,442.7268,6.3580,155.44973754883),
        Garage = {
            Entrance = vector3(-3060.66,442.4910,6.3617),
            Exit = vector4(-3056.50,440.5307,5.5937,244.7247467041),
        }
    },
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-3039.62,492.7984,6.7726,259.62677001953),
        Garage = {
            Entrance = vector3(-3035.08,498.6889,6.7679),
            Exit = vector4(-3030.78,497.8379,6.0502,259.56140136719),
        }
    },
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-3031.92,524.9496,7.4252,262.20849609375),
        Garage = {
            Entrance = vector3(-3032.26,520.5747,7.4210),
            Exit = vector4(-3027.12,520.3775,6.4681,265.20452880859),
        }
    }, 
	{
        Label = "Costa Pesquero",
        ...
        ShellType = "HighEndHouse",
        Price = 8000000,
        Entrance = vector4(-3105.46,246.6711,12.496,290.3479309082),
        Garage = {
            Entrance = vector3(-3107.57,252.7434,12.496),
            Exit = vector4(-3102.72,254.7850,11.052,291.36877441406),
        }
    },
}
-- HighEndApartment, HighEndHouse, MidTierApartment, MidTierHouse, LowTierHouse, ShitTier, Trailer
