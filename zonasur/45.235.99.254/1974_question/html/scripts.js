$(document).ready(function(){
  ...
  var goodAnswer = [];
  var questionUsed = [];
  var nbQuestionToAnswer = 20; // no olvide cambiar el valor máximo de la barra de progreso en html
  var nbAnswerNeeded = 18; // out of nbQuestionToAnswer
  var nbPossibleQuestions = 20; //number of questions in database questions.js
  ...
  $(".btnQuestion").click(function(){
		$.post('http://1974_question/question', JSON.stringify({}));
  });
  $(".btnClose").click(function(){
		$.post('http://1974_question/close', JSON.stringify({}));
  });
  $(".btnKick").click(function(){
		$.post('http://1974_question/kick', JSON.stringify({}));
  });
