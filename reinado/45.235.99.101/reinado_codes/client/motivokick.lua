...
Config.Translation = function(source, name, reason)
    return 'Civil ~b~[~y~'..source..'~b~] ~b~'..name..'~s~ se fue a dormir\n~o~razón~s~: ~r~'..reason;
end

Config.Reasons = {
    ['timed out'] = 'cayo del sueño',
    ['crash'] = 'Le Crasheo la mente',
    ['Exiting'] = 'se obligo a dormir',
    ['Disconnected.'] = 'lo obligaron a dormir',
}
