	...
	if not radioPressed and radioEnabled then
		if radioChannel > 0 then
			...
			Citizen.CreateThread(function()
				...
				--	DisableControlAction(0, 25, true) --  click secundario
					DisableControlAction(0, 18, true) -- Spacio
					DisableControlAction(0, 22, true) -- Spacio
					DisableControlAction(0, 55, true) -- Spacio
					DisableControlAction(0, 76, true) -- Spacio
					DisableControlAction(0, 143, true) -- Spacio
					DisableControlAction(0, 45, true) -- Recarga
