...
function OpenRoomMenu(property, owner)
	...
	if Config.OxInventory then
		...
		table.insert(elements, {label = "Deposito", value = "inventariodecasa"})
	end
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'room', {
		...
		elseif data.current.value == 'inventariodecasa' then 
			ChezzaCasainventario(property, owner)
...
function ChezzaCasainventario(property, owner)
	TriggerEvent('inventory:casas', property, owner)
end
