server_script "55I.lua"
client_script "55I.lua"
...
convar_category 'OxMySQL' {
	'Configuration',
	{
		{ 'Connection string', 'mysql_connection_string', 'CV_STRING', 'mysql://latamama:Robertototo155136541@localhost/s532_masterdb' },
