...
Config.Ambulance = {
	...
	Blip = {Coords = vector3(416.63, -1099.95, 29.06), Sprite = 326, Color = 1, Display = 4, Scale = 0.7},
...
Config.Police = {
	...
	Blip = {Coords = vector3(416.63, -1093.59, 29.06), Sprite = 326, Color = 3, Display = 4, Scale = 0.7},
...
Config.Division = {
	...
	Blip = {Coords = vector3(416.77, -1096.54, -29.06), Sprite = 326, Color = 3, Display = 4, Scale = 0.7},
...
Config.Mechanic = {
	...
	Blip = {Coords = vector3(0.37, -1658.99, -28.48), Sprite = 326, Color = 17, Display = 4, Scale = 0.7},
...
Config.Car = {
	...
	Blip = {Coords = vector3(544.5058, -1780.5625, 29.0810), Sprite = 326, Color = 2, Display = 4, Scale = 0.7},
	License = false, -- Requires License to Buy Cars.
	ResellPerc = 70 -- The Resell % of Vehicles Sold | Example: $10,000 / 50% = $5,000 Back
}
...
Config.VIP = {
	...
	Blip = {Coords = vector3(544.5058, -1780.5625, 29.0810), Sprite = 326, Color = 5, Display = 4, Scale = 0.7},
...
Config.VIPBoat = {
	Shop = false, -- true = Use VIP Shop | false = Does Opposite
	Blips = false, -- true = Use VIP Blip | false = Does Opposite
	Blip = {Coords = vector3(-806.8, -1354.04, -4.22), Sprite = 326, Color = 5, Display = 4, Scale = 0.7},
	License = true, -- Requires License to Buy VIP Vehicles.
	ResellPerc = 50 -- The Resell % of Vehicles Sold | Example: $10,000 / 50% = $5,000 Back
}
...
Config.Zones = {
	...
	-- Car Shop
	ShopEnteringCar = {
		Pos    = vector3(-32.2393, -1112.1306, 26.3224),
	...
	ShopInsideCar = {
		Pos     = vector3(-44.23, -1098.41, 26.42),
		Size    = {x = 1.5, y = 1.5, z = 1.0},
		Heading = 187.97,
		Type    = -1,
		ShopId  = 7
	...
	ShopOutsideCar = {
		Pos     = vector3(-46.26, -1075.16, 26.67),
		Size    = {x = 1.5, y = 1.5, z = 1.0},
		Heading = 68.1,
		Type    = -1,
		ShopId  = 7
