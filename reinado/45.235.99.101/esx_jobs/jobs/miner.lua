Config.Jobs.miner = {
	...
	Zones = { 
		...
		StoneWash = {
			Pos = {x = 1885.5477, y = 284.0513, z = 163.2741},
			Size = {x = 5.0, y = 5.0, z = 1.0},
			Color = {r = 50, g = 200, b = 50},
			Marker = 1,
			Blip = true,
			...
			GPS = {x = 1885.5477, y = 284.0513, z = 164.2741}
		},
		...
		VehicleSpawner = { 
			Pos = {x = 56.7823, y = -638.6403, z = -30.6806},
		...
		VehicleSpawnPoint = {
			Pos = {x = 46.4241, y = -624.4720, z = -32.3381},
			Size = {x = 5.0, y = 5.0, z = 1.0},
			Marker = -1,
			Blip = false,
			Name = _U('service_vh'),
		...
		VehicleDeletePoint = {
			Pos = {x = -19.7248, y = -702.4954, z = -31.6381},
			Size = {x = 5.0, y = 5.0, z = 1.0},
			Color = {r = 255, g = 0, b = 0},
			Marker = 1,
			Blip = false,
