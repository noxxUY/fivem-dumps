				...
				if shouldDie then
					...
					Wait(1000)
						...
						if isDead then
							...
							print('¿Que miras la consola pelado?')
						end	
...
RegisterNetEvent('radio:muerto')
AddEventHandler('radio:muerto', function()
	exports["pma-voice"]:setRadioChannel(0)
end)
	...
	CreateThread(function()
		...
		while bleedoutTimer > 0 and isDead do
			...
			if not Config.EarlyRespawnFine then
				...
				if IsControlJustReleased(0, 38) and timeHeld > 60 then
					RemoveItemsAfterRPDeath()
					break
				elseif IsControlJustReleased(0, 45) and timeHeld2 > 60 then
					RemoveItemsAfterRPDeathSandy()
					break
				end
...
function RemoveItemsAfterRPDeathSandy()
	TriggerServerEvent('esx_ambulancejob:setDeathStatus', false)
