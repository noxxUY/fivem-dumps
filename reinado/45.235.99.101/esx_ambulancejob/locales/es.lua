...
Locales['es'] = {
  ...
  -- Death
 -- ['respawn_available_in'] = 'Puedes revivirte escribiendo /revivir o esperar un same.',
  ['respawn_available_in'] = 'Reaparición disponible en ~b~%s minutos %s segundos~s~',
  ['respawn_bleedout_in'] = 'te desangrarás en ~b~%s minutes %s segundos~s~\n',
 -- ['respawn_bleedout_prompt'] = 'Puedes revivirte escribiendo ~r~/revivir~s~ o esperar un same.',
  ['respawn_bleedout_prompt'] = 'Reaparece en [~b~E~s~] Ciudad - [~b~R~s~] Sandy',
  ['respawn_bleedout_fine'] = 'Has pagado ~g~$%s~s~ para reaparecer',
  ['respawn_bleedout_promptpolice'] = 'Mantén [~b~F~s~] reaparecer',
