...
RegisterNetEvent('esx_basicneeds:onTomarCerveza')
AddEventHandler('esx_basicneeds:onTomarCerveza', function()

RequestAnimSet("move_m@drunk@verydrunk")
	while not HasAnimSetLoaded("move_m@drunk@verydrunk") do
		Citizen.Wait(0)
	end
	TaskStartScenarioInPlace(GetPlayerPed(-1), "WORLD_HUMAN_DRINKING_FACILITY", 0, true)
	Citizen.Wait(15000)
    ...
    ShakeGameplayCam("DRUNK_SHAKE", 8.5)
