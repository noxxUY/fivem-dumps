Locales['en'] = {
    ...
    ["pbnumber"] = "Number",
    ["phone_booth"] = "You don't have enough money on you to use the phone booth. $",
    ...
    -- Bank
    ["bank_yourself"] = "You can't transfer to your self!",
    ...
    ["bak_cancelq"] = " The contact isn't active, so the transaction didn't occur",
