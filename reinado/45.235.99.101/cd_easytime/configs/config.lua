...
Config.TsunamiWarning_time = 5 --(in minutes) How long the tsunami warning should last. Read the docs for more info.
...
Config.ThunderChance = 5 --The percent chance for it to thunder when raining out of 100.
