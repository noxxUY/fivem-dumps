...
Config.Zones = {
	...
	grooveps1 = {
		Pos   = { x = -324.8426, y = -132.8699, z = 38.9741},
	...
	grooveps2 = {
		Pos   = { x = -327.8204, y = -144.3648, z = 39.0600},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	grooveps3 = {
		Pos   = { x = -323.6466, y = -131.8919, z = 38.9576},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	grooveps4 = {
		Pos   = { x = -320.6745, y = -126.3519, z = 38.9723},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	grooveps5 = {
		Pos   = { x = -318.7883, y = -120.2968, z = 39.0096},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	grooveps6 = {
		Pos   = { x = -357.6411, y = -91.3490, z = 45.6583},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	grooveps7 = {
		Pos   = {x= -317.75891113281, y= -94.35961151123, z= 39.025024414063},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	grooveps8 = {
		Pos   = {x= -324.94827270508, y= -91.707206726074, z= 39.025016784668},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	grooveps9 = {
		Pos   = {x= -325.74514770508, y= -138.5972442627, z= 38.666557312012},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	grooveps10 = {
		Pos   = {x= -315.96325683594, y= -113.24117279053, z= 38.666198730469},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	grooveps11 = {
		Pos   = {x= -314.16619873047, y= -107.97662353516, z= 38.666770935059},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	grooveps12 = {
		Pos   = {x= 835.04925537109, y= -959.51776123047, z= 26.498928070068},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	grooveps13 = {
		Pos   = {x= 835.40502929688, y= -968.4365234375, z= 26.498928070068},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	grooveps14 = {
		Pos   = {x= 835.72644042969, y= -976.97631835938, z= 26.64630317688},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	grooveps15 = {
		Pos   = {x= 835.173828125, y= -985.72607421875, z= 26.646286010742},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
