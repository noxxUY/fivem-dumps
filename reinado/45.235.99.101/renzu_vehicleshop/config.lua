...
VehicleShop = {
    ...
    -- BOAT shop
    ['Los Barcos del Patron'] = { -- same with name
        name = "Los Barcos del Patron", --LEGION
        type = 'boat', -- type of shop
        title = "Los Barcos del Patron",
        ...
        shop = { -- if not vehicle is setup in Database SQL, we will use this
            {shop='Los Barcos del Patron',category='Lanchas',stock=50,price=3000000,model='dinghy',name="Dinghy"},
            {shop='Los Barcos del Patron',category='Lanchas',stock=50,price=150000,model='seashark',name="seashark"},
            {shop='Los Barcos del Patron',category='Lanchas',stock=50,price=2000000,model='dinghy2',name="Dinghy2"},
            {shop='Los Barcos del Patron',category='Lanchas',stock=50,price=7000000,model='marquis',name="Marquiz"},
            {shop='Los Barcos del Patron',category='Lanchas',stock=50,price=7000000,model='toro2',name="toro2"},
        },
    },
...
Refund = {
    ['pdm'] = { -- same with name
        ...
        shop_x = 901.3821,  
        shop_y = -54.5803,
        shop_z = -78.7641, -- coordinates for selling / refunding the vehicle
    },
}