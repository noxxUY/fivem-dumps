    ...
    if (currentcar !== currentTarget) {
        ...
        if(!itemDisabled && garage_id != 'impound') {
            ...
            $('#contentVehicle').append(`
                ...
                <div class="row spacebetween">
                    <span class="title">CABALLOS DE FUERZA</span>
                ...
                <div class="row spacebetween">
                    <span class="title">ESFUERZO DE TORSIÓN</span>
...
function BuyVehicle(n,c,p) {
    ...
    $('#closemenu').append(`
        ...
        <div class="modal-content">
            <p class="title">Confirmar compra:</p>
            <br>
            <p class="vehicle">Vehículo: `+n+`</p>
            <p style="float:left;" class="vehicle">Clase: `+c+`</p>
...
function TestDrive(n,c,p,m) {
    ...
    $('#closemenu').append(`
        <div class="background-circle"></div>
        <div class="modal-content">
            <p class="title">Confirmar prueba de manejo:</p>
            <br>
            <p class="vehicle">Vehículo: `+n+`</p>
            <p style="float:left;" class="vehicle">Clase: `+c+`</p>
            <p style="float:right;" class="vehicle">Tiempo: 5 minutos</p>
        </div>
