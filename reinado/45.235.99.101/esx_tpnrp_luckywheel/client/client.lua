...
local _wheelPos = vector3(976.90, 48.94, 74.68) -- Apretar E
local _baseWheelPos = vector3(976.73, 48.37, -74.68) -- BASE DE RULETA 
local Keys = {
...
Citizen.CreateThread(function()
    ...
    if ESX.IsPlayerLoaded() then
        ...
        Citizen.CreateThread(function()
            ...
            _wheel = CreateObject (model, 978.02, 50.37, 73.90, false, false, true) -- Ruleta (Giratorio)
            SetEntityHeading(_wheel, 328.22)
         ...
         --[[   RequestModel(carmodel)
            ...
            local vehicle = CreateVehicle(carmodel, 963.79, 47.62, 72.99, 0.0, false, false)
           ...
           -- RequestModel(carmodel)
			...
			-- local vehicle =  ESX.Game.SpawnLocalVehicle(carmodel, 1100.39, 220.09, -51.0, 0.0, false, false)
...
function doRoll()
    if not _isRolling then
        ...
        ESX.Streaming.RequestAnimDict(lib, function()
            local _movePos = vector3(976.65, 50.58, 73.68) -- A donde va a tirar la palanca (no apreta E)
