...
--This will group different jobs together. Eg., so 2 jobs {'police', 'sheriff'} can both see can see each other on the large UI and the pause menu/mini-map blips.
    ...
    [4] = {'mechanicvip'}, --mechanic group
    [5] = {'prosegur'}, --mechanic group
    [6] = {'militar'}, --mechanic group
...
Config.UpdateDistanceUI = { --Do you want the distance (how far the player is from the call) to be constantly updated on the small & large UI?
    ENABLE = true,
    timer = 10 --(in seconds) How often the distance should be updated.
}
...
Config.BlipData = { --You need to add all the jobs that will be able to use the dispatch to the table below.
    ...
    ['mechanic'] =  {largeui_blip_colour = 'mech',    pausemenu_blip_colour = {17, 0}},
    ['mechanicvip'] =  {largeui_blip_colour = 'red',    pausemenu_blip_colour = {17, 0}},
    -- ['mafia03'] =  {largeui_blip_colour = 'red',    pausemenu_blip_colour = {17, 0}},
    ['prosegur'] =  {largeui_blip_colour = 'orange',    pausemenu_blip_colour = {17, 0}},
    ['militar'] =  {largeui_blip_colour = 'orange',    pausemenu_blip_colour = {17, 0}},
...
Config.JobCallCommands = { 
    ...
    Civilian_Commands = {
        { job_label = 'Policia',        command = 'entorno',        anonymous = false, 	job_table = {'police'} },
        { job_label = 'SAME',      		command = 'auxilio',     anonymous = false,	job_table = {'ambulance'} },
        { job_label = 'Mecanico',       command = 'grua',   anonymous = false,	job_table = {'mechanic'} },
...
Config.PanicButton = {
    ...
    job_table = {'police', 'ambulance', 'mechanic', 'prosegur', 'militar', 'mechanicvip'} --A list of jobs who can use the panic button (every job in this list will be notified if a panic button is pressed).
}
...
Config.PoliceAlerts = {
    ...
    police_jobs = {'police'}, --The jobs who will be notified from these alerts.
    whitelisted_jobs = {'police', 'ambulance', 'mechanic', 'prosegur', 'militar'}, --These jobs will NOT trigger these alerts.
