...
---------------------------
CreateThread(function()
    Utils.AddBlip(vector3(1710.66, 3252.53, 41.1), 38, 0, 0.65, "Picadas")
    exports["polyzones"]:AddBoxZone("finish_line_1", vector3(1321.63, 3143.66, 41.182), 13.0, 2.8, {
        heading = 0,
        debugPoly = false,
        minZ = 35.5,
        maxZ = 48.9,
    ...
    exports["polyzones"]:AddBoxZone("finish_line_2", vector3(1319.11, 3153.17, 41.182), 10.2, 3.0, {
        heading = 0,
        debugPoly = false,
        minZ = 35.5,
        maxZ = 48.9,
...
racestart = function(dragRaceId)
    if Data.Player.DragRaceId ~= 0 and Data.Player.DragRaceId == dragRaceId then
        ...
        exports["mythic_notify"]:SendAlert("success", "A PICAR!")
