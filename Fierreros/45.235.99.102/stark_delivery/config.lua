...
Config.Locales = {
	['EndJob'] = 'Trabajado ~r~encerrado~w~ felicitaciones por el servicio prestado',
	['NotVehicle'] = 'Este no es el vehiculo proporcionado por ~y~la Empresa',
	['Payment'] = 'Ganaste ~g~ARS$: ',
	['NextLocation'] = 'Localizando una nueva entrega...',
	['ReturnCompany'] = 'Regrese a la empresa, sus ~y~pedidos~w~ han terminado',
	['DeliverClient'] = 'Presione ~INPUT_CONTEXT~ para ~y~Entregar al cliente',
	['ReturnVehicle'] = "No recogiste el pedido, vuelve a la moto para ~y~recoger.",
	['MissionText'] = 'Entregar el producto a ~y~el Cliente marcado',
	['GetDeliver'] = 'Presione ~INPUT_CONTEXT~ para continuar ~y~Entrega',
	['ExitVehicle'] = 'Salga del vehiculo para hacer ~y~Entrega',
	['DeliverFound'] = 'Se ha encontrado una encomanda, vaya a ~y~Ubicacion comprobada',
	['EnterVehicle'] = 'Subete a la moto para empezar ~b~Entregas',
	['NotFoundLocation'] = 'No se encontro la ubicacion~b~seguro~w~ para su moto, intentelo de nuevo',
	['SearchLocation'] = 'Buscando un lugar seguro...',
	['LoadingVehicle'] = 'Cargando vehiculo...',
	['PressEndJob'] = 'Presione ~INPUT_CONTEXT~ para terminar ~y~el trabajo',
	['StartJob'] = 'Presione ~INPUT_CONTEXT~ para iniciar ~y~el trabajo',
	['IsWorking'] = 'Ya estás ~y~trabajando',
}
...
Config.MaxEntregas = 10
Config.Pagamento = 2400

Config.VehicleName = 'motodelivery'