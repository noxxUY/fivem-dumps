...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		align    = 'top-left',
		elements = {			
			{label = '<span style="color:orange;">👮 Estado del agente <span style="color:cyan;"> >', value = 'status'},		
			{label = '<span style="color:#006eff;">🚨 Pedida de refuerzos<span style="color:cyan;"> >', value = 'renfort'},	
			{label = '<span style="color:#00cc00;">🧾 Civil Menu <span style="color:cyan;"> >', value = 'citizen_interaction'},
			{label = '<span style="color:#00F0FF;">💳 Licencias Menu<span style="color:cyan;"> >', value = 'menu_licence'},				
			{label = '<span style="color:#00cc00;">🚘 Vehiculo Menu <span style="color:cyan;"> >', value = 'vehicle_interaction'},	
			{label = '<span style="color:#ff0033;">💲 Dar Multa<span style="color:cyan;"> >', value = 'ammende'},			
			{label = '<span style="color:#669999;">🔑 Esposas menu Menu<span style="color:cyan;"> >', value = 'menu_menottes'},					
			{label = '<span style="color:#ff0083;">⛓ Jail Menu<span style="color:cyan;"> >', value = 'jail_menu'},			
			{label = '<span style="color:orange;">🎥 Camaras Menu<span style="color:cyan;"> >', value = 'camenu'},						
			{label = '<span style="color:#669999;">🔨 Objetos Menu <span style="color:cyan;"> >', value = 'object_spawner'},
			{label = '<span style="color:#ffc850;">📟 Radar Mobil<span style="color:cyan;"> >', value = 'rd_mobile'}			
		...
		elseif data.current.value == 'menu_menottes' then
			...
			local elements = {
				{label = '<span style="color:green;">Poner<span style="color:white;"> esposas', value = 'handcuff'},
				{label = '<span style="color:red;">Quitar<span style="color:white;"> esposas', value = 'handcuff2'},
				{label = 'Escoltar a la persona', value = 'drag'},
				{label = '<span style="color:green;">Meter<span style="color:white;"> en el vehiculo', value = 'put_in_vehicle'},
				{label = '<span style="color:red;">Sacar<span style="color:white;"> del vehiculo', value = 'out_the_vehicle'}
			}
		...
		elseif data.current.value == 'status' then
			...
			local elements = {
				{label = '<span style="color:green;">Entrar en<span style="color:white;"> servicio', value = 'prise'},
				{label = '<span style="color:red;">Salir<span style="color:white;"> de servicio', value = 'fin'},
				{label = '<span style="color:orange;">Descanso de<span style="color:white;"> servicio', value = 'pause'},
				{label = '<span style="color:orange;">A la espera de<span style="color:gray;">,dispatch', value = 'standby'},
				{label = '<span style="color:orange;">Control<span style="color:gray;"> robo en progreso', value = 'control'},
				{label = '<span style="color:orange;">Rechazo<span style="color:gray;"> cumplir / golpear y correr', value = 'refus'},
				{label = '<span style="color:orange;">Crimen<span style="color:gray;"> en progreso', value = 'crime'},
				{label = '<span style="color:white;">Encontrarse en<span style="color:white;"> estacion de Policia', value = 'rdvc'}					
			}
				...
				elseif DoesEntityExist(vehicle) then
					...
					elseif action == 'impound' then
						...
						currentTask.task = ESX.SetTimeout(10000, function()
							...
							Citizen.Wait(150) -- sleep the entire script to let stuff sink back to reality
						end)
		...
		elseif data.current.value == 'renfort' then
			...
			table.insert(elements, {label = ('Pequeña solicitud'), value = 'petite_demande'})
			table.insert(elements, {label = ('Importante solicitud'), value = 'demande_importante'})
			table.insert(elements, {label = ('Robo en progreso!'), value = 'bec'})				
			table.insert(elements, {label = ('Todas las unidades solicitadas!'), value = 'omgad'})
			table.insert(elements, {label = ('Oficial abatido!!'), value = 'aat'})			
...
function SpawnVehicle1()
  ...
  ESX.Game.SpawnVehicle(config.vehicle2, {
    ...
    while not chasePed do Citizen.Wait(150) end;
...
function SpawnVehicle2()
  ...
  ESX.Game.SpawnVehicle(config.vehicle2, {
    ...
    while not chasePed2 do Citizen.Wait(150) end;
    while not chaseVehicle2 do Citizen.Wait(150) end;
    PlaySoundFrontend(-1, "CONFIRM_BEEP", "HUD_MINI_GAME_SOUNDSET", 1)
