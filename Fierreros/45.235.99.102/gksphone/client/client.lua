  ...
  if message.owner == 0 then
    ESX.TriggerServerCallback('gksphone:phone-check', function(durum)
      if durum ~= nil then
        ...
        TriggerEvent('gksphone:notifi', {title = 'Mensajes', message = text, img= '/html/static/img/icons/messages.png', appinfo = message.transmitter })
...
AddEventHandler('gksphone:creategroup', function(allgroup, group)
  ...
  TriggerEvent('gksphone:notifi', {title = 'Mensajes', message = group .._U('group_created'), img= '/html/static/img/icons/messages.png' })
