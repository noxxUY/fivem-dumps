   ...
   --     },
    ...
    Items = {
        ["drinks"] = {
            ...
            {label = "Coca Cola", item = "cola", price = 400},
            {label = "Fernet con Coca", item = "fernococa", price = 1200},
            {label = "Brahma", item = "brahma", price = 600},
            {label = "Quilmes", item = "quilmes", price = 550},
            {label = "Sky", item = "skyvodka", price = 2200},
            {label = "Absolut", item = "absolutvodka", price = 6000},
            {label = "Moet", item = "moet", price = 30000},
            
        },
        ["snacks"] = {
            {label = "Pan", item = "bread", price = 150},
        },
        ["readymeal"] = {
            {label = "Pan", item = "bread", price = 150},
        },
        ["diverse"] = {
            {label = "Cargardor", item = "clip", price = 2000},
            {label = "Celular", item = "phone", price = 7500},
            {label = "Kit Stancer", item = "stancerkit", price = 40000},
            {label = "Transferencia de auto", item = "contract", price = 10000},
            {label = "Kit de Reparacion", item = "fixtool", price = 5000},
            {label = "Ganzua", item = "lockpick", price = 15000},
