...
------NO TOCAR ------
--ESTO ES PARA QUE SE ABRA CON LA LETRA [E]
...
------NO TOCAR ------
--PARA CONFIGURAR QUE TRABAJO PUEDE ABRIR ESTE GARAGE
...
Config.CarZones = { --COORDENADAS - COCHE
	PoliceCarGarage = {
		Pos = {
			{x = 453.63,  y = -1017.6, z = 29.45},
...
Config.HeliZones = {  --COORDENADAS - HELICOPTERO
	PoliceHeliGarage = {
		Pos = {
...
Config.ExtraGarageScale = 0.1
Config.ExtraGarageColour = 38
Config.ExtraGarageName = "Accesorios de Coche"
Config.EnableExtraGarageBlip = false
--BLIPS - FINAL

--MARKERS -INICIO
--COCHE									--EJEMPLOS DE CONFIGURACION
Config.PoliceCarMarker = 2 										--MARKERS TIPO		
Config.PoliceCarMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 			--COLORES 
Config.PoliceCarMarkerScale = { x = 0.2, y = 0.2, z = 0.09 }  				--X Y Z 
Config.CarDraw3DText = "Presiona [E] para abrir el garage"			--TEXTO 

--HELICOPTERO
Config.PoliceHeliMarker = 1 												
Config.PoliceHeliMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		
Config.PoliceHeliMarkerScale = { x = 5.5, y = 5.5, z = 0.1 }  				
Config.HeliDraw3DText = "Presiona [E] para abrir el garage"		
	

--EXTRA MENU
Config.PoliceExtraMarker = 1												
Config.PoliceExtraMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		
Config.PoliceExtraMarkerScale = { x = 2.5, y = 2.5, z = 0.1 }  				
Config.ExtraDraw3DText = "Presiona ~g~[E]~s~ para abrir ~y~accesorios extra~s~"	

-------------IMPORTANTE----------
--------------------AQUI SE CONFIGURA LOS COCHES RECOMIENDO EDITARLO 
---EL MODELO ES LO DEL COCHE POR EJEMPLO "taxi" Y LABEL "Taxi Mastodonte mamadisimio"
Config.PoliceVehicles = {
	{ model = '', label = '----- Autos ----- '},
	{ model = 'fbi2', label = 'Ranger'},
	{ model = 'hiluxpol', label = 'Hilux'},
	{ model = 'bearcatBCSO', label = 'Camion Blindado'},
	{ model = 'ivecopol', label = 'Iveco'},
	{ model = 'hcbr500rgn', label = 'Moto'},
	{ model = 'policer8', label = 'Audi R8'},
	{ model = 'mondeopol', label = 'Mondeo'},

}

-- HELICOPTEROS
Config.PoliceHelicopters = {
	{ model = '', label = '----- Helicopteros -----', livery = 0, price = 0 },
	{ model = 'policemav', label = 'Helicoptero de Reconocimiento', livery = 0, price = 0 }
}


-- NO TOCAR SON COMANDOS PERO PARA RP ES PG O NO SE :P 
Config.RepairCommand = 'adadasdadasddada'
Config.CleanCommand = 'fasdfaasddadadad'

-- TRADUCCION
Config.LabelStoreVeh = "Devolver vehiculo"
Config.LabelGetVeh = "Sacar un vehiculo"
Config.LabelPrimaryCol = "Primaria"
Config.LabelSecondaryCol = "Secundaria"
Config.LabelExtra = "Extras"
Config.LabelLivery = "Livery"
Config.TitlePoliceGarage = "Garage Essalud"
Config.TitlePoliceExtra = "Extras"
Config.TitlePoliceLivery = "Livery"
Config.TitleColorType = "Tipo de Color"
Config.TitleValues = "Valor"

-- TRADUCCION -NOTIFIACIONES
Config.VehicleParked = "Su vehiculo esta guardado!"
Config.NoVehicleNearby = "No tienes un vehiculo!"
Config.CarOutFromPolGar = "Sacaste un ~b~vehículo~s~ del~y~Garaje~s~!"
Config.HeliOutFromPolGar = "Sacaste un ~b~helicóptero~s~ del ~y~Helipuerto~s~!"
Config.VehRepNotify = "Su ~b~vehículo~s~ está siendo ~y~reparado~s~, espere!"
Config.VehRepDoneNotify = "Su ~b~vehículo~s~ ha sido ~y~reparado~s~!"
Config.VehCleanNotify = "Su ~b~vehículo~s~ está siendo ~y~limpiado~s~, por favor espere!"
Config.VehCleanDoneNotify = "Su ~b~vehículo~s~ ha sido ~y~limpiado~s~!"


Config.Progress1 = "REPARANDO AUTO"
Config.Progress2 = "LIMPIANDO AUTO"


Config.RepairTime = 5					
Config.CleanTime = 3.5					

Config.VehicleLoadText = "Espere a que traigan el vehículo"			
