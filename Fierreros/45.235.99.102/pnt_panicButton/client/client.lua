...
function createBlip(policeCoords, policeName)
    blip = AddBlipForCoord(policeCoords.xyz)
        ...
        options = {
            {
                ...
                disabled = disabled,
                onSelect = function()
                    blips[args.tableId].blipId = createBlip(args.policeCoords, args.name)
                end
            },
            {
...
lib.callback.register('pnt_panicButton:client:reciveAlert', function(policeCoords, policeName)
