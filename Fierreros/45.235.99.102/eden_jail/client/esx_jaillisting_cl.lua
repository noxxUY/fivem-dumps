...
function ShowJailListingMenu(data)
		...
		ESX.UI.Menu.Open(
			...
			if data.current.value == 'jail_wear' then 
				...
				ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jailSkin)
					if skin.sex == 0 then
						SetPedComponentVariation(PlayerPedId(), 3, 5, 0, 0)--Gants
						SetPedComponentVariation(PlayerPedId(), 4, 9, 4, 0)--Jean
						SetPedComponentVariation(PlayerPedId(), 6, 61, 0, 0)--Chaussure
						SetPedComponentVariation(PlayerPedId(), 11, 5, 0, 0)--Veste
						SetPedComponentVariation(PlayerPedId(), 8, 15, 0, 0)--GiletJaune
					elseif skin.sex == 1 then
                        SetPedComponentVariation(PlayerPedId(), 3, 14, 0, 0)--Gants
                        SetPedComponentVariation(PlayerPedId(), 4, 3, 15, 0)--Jean
                        SetPedComponentVariation(PlayerPedId(), 6, 52, 0, 0)--Chaussure
                        SetPedComponentVariation(PlayerPedId(), 11, 73, 0, 0)--Veste
                        SetPedComponentVariation(PlayerPedId(), 8, 14, 0, 0)--GiletJaune
					else
