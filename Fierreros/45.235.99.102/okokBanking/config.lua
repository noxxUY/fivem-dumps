...
Config.IBANPrefix = "B-" -- the prefix of the IBAN

Config.IBANNumbers = 6 -- How many characters the IBAN has by default

Config.CustomIBANMaxChars = 7 -- How many characters the IBAN can have when changing it to a custom one (on Settings tab)
