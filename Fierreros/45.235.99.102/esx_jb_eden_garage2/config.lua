Config = {}
Config.Blip			= {sprite= 357, color = 3, scale = 0.5}
Config.BoatBlip		= {}
Config.AirplaneBlip	= {}
Config.MecanoBlip	= {sprite= 357, color = 26, scale = 0.5}
...
Config.Garages = {
	...
	Garage_Nashe = {
		Pos = {x = -998.191,y = -168.017,z = 63.596},
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = _U('garage_name'),
		HelpPrompt = _U('open_car_garage'),
		SpawnPoint = {
			Pos = {x = -992.22,y = -175.582,z = 64.442},
			Heading = 16.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = _U('spawn_car')
		},
		DeletePoint = {
			Pos = {x = -968.022,y = -176.280,z = 64.442},
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = _U('store_car')
		}, 	
	},
	...
	Garage_cordobes = {
		Pos = {x = 149.52,y = -130.56,z = 54.1 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = _U('garage_name'),
		HelpPrompt = _U('open_car_garage'),
		SpawnPoint = {
			Pos = {x = 154.95,y = -125.4,z = 54.1 },
			Heading = 71.92,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = _U('spawn_car')
		},
		DeletePoint = {
			Pos = {x = 142.7816772461,y = -128.78955078125,z = 54.1 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = _U('store_car')
		}, 	
	},
		...
		Garage_shalamar = {
		Pos = {x = -1148.52,y = -1777.56,z = 4.1 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = _U('garage_name'),
		HelpPrompt = _U('open_car_garage'),
		SpawnPoint = {
			Pos = {x = -1156.95,y = -1780.4,z = 4.1 },
			Heading = 37.92,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = _U('spawn_car')
		},
		DeletePoint = {
			Pos = {x = -1152.7816772461,y = -1785.78955078125,z = 4.1 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = _U('store_car')
		}, 	
	},
