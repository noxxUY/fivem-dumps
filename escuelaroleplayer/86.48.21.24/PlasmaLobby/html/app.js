  ...
  switch (v.action) {
    ...
    case "lstGame":
      ...
      $(`#${v.GameID}`).click(function () {
        ...
        $.post(
          "https://PlasmaLobby/RequestGameDetails",
          JSON.stringify({
            reportid: this.id,
          })
        );
    ...
    case "OpenGame":
      ...
      document.getElementById("JoinBoxID").style.backgroundImage =
        "url('" + img + "')";
...
$(function () {
  ...
  $(".JoinGame").click(function () {
    ...
    $(".titre").text("PLASMAGAME");
    $.post(
      "https://PlasmaLobby/OpenJoinGame",
      JSON.stringify({ curshop: currentShop })
    );
  });
...
function changeListMap(map) {
  ...
  document.getElementById("CreateIMGMapBoxID").style.backgroundImage =
    "url('" + img + "')";
...
function SpectateGame() {
  ...
  $.post(
    "https://PlasmaLobby/SpectateAGame",
    JSON.stringify({
      Game: game,
    })
  );
