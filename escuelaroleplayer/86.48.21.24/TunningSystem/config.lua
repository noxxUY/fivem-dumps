...
Config.WebHook = "https://discord.com/api/webhooks/951655456324059197/9Lbqm7xSiPAyBGyzc8-cPXlZvdFbd6-dr0mve1Iwsa6fHqCnltxTIKzoVSwWoozccDnU"--your webhook here

Config.Currency = "$"

Config.Range = 3.5 -- The range that you can open the menu

Config.qbcore = "QBCore" -- Your QBCore events name... Default is qb-core

Config.TunningLocations = {
	{
		name = "Ruta 68", -- Name of the Location that will appear if blipmap == true
		coords = vector3(1174.8186, 2639.3523, 37.7538), --The coords to open menu
		job = "mechanic1", --The job that have access to it (remove the line and everyone can access it)
		...
		WebHook = "https://discord.com/api/webhooks/1060619597574848612/rvzD8PFHCzH9gf3_2cEt8cbub762hMsiSWIPSnHSCfVlLR-hab5FvdjyvSV5uJzsji7T"
	},
	{
		name = "Ruta 68", -- Name of the Location that will appear if blipmap == true
		coords = vector3(1181.9069, 2639.2720, 37.7538), --The coords to open menu
		job = "mechanic1", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
...

	{
		...
		coords = vector3(544.4097, -168.9003, 54.4932), --The coords to open menu
		...
		blipsprite = 72, -- The blip sprite, there's a list of all available: https://docs.fivem.net/docs/game-references/blips/
		used = false, -- Don't tuch
		WebHook = "https://discord.com/api/webhooks/1080936087087751278/_NlcvlLhKIaM7bmlVtNq_UvJWpP5z4C6EjkazollRDUbgRzcLMJMUQtzNd-BFryRP_XG"
	},
	{
		name = "Auto Exotic", -- Name of the Location that will appear if blipmap == true
		coords = vector3(545.6100, -189.8416, 54.4932), --The coords to open menu
		job = "mechanic2", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Midnight Club", -- Name of the Location that will appear if blipmap == true
		coords = vector3(831.8115, -805.7809, 26.3326), --The coords to open menu
		...
		blipsprite = 72, -- The blip sprite, there's a list of all available: https://docs.fivem.net/docs/game-references/blips/
		used = false, -- Don't tuch
		WebHook = "https://discord.com/api/webhooks/1090099083659718727/_JYUXfI-DpBDTSY5ffuDgCLbhDbyVfnEOkvuZodmIrbKHlYA_-A10TeS6CyffaGbPyz7"
	},
	{
		name = "Midnight Club", -- Name of the Location that will appear if blipmap == true
		coords = vector3(831.9240, -820.3276, 26.3326), --The coords to open menu
		job = "mechanic3", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
...

	{
		...
		coords = vector3(-208.4045, -1335.4750, 31.3005), --The coords to open menu
		...
		blipsprite = 72, -- The blip sprite, there's a list of all available: https://docs.fivem.net/docs/game-references/blips/
		used = false, -- Don't tuch
		WebHook = "https://discord.com/api/webhooks/1103439207550160896/bftVrM4ter8oBfoarc7vtGV4k7lwaaL4klSARpvFDTbMadLO0o7G0fgOSlvZCzpfuf-H"
	},
	{
		name = "Bennys", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-195.0139, -1327.1956, 31.3005), --The coords to open menu
		job = "mechanic4", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Hayes Autos", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-1423.0795, -450.8847, 35.9097), --The coords to open menu
		job = "mechanic5", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
		blipmap = false, --Show the blip in map?
		...
		blipsprite = 72, -- The blip sprite, there's a list of all available: https://docs.fivem.net/docs/game-references/blips/
		used = false, -- Don't tuch
		WebHook = "https://discordapp.com/api/webhooks/1077728518533816390/qXQycX5ILGx2dk3nqnYVCtwjtmSjY--Ne12_kOGXqjgQCNTSZsLgvVVDCm46QPVi1lhx"
	},
	{
		name = "Hayes Autos", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-1416.5872, -446.9008, 35.9097), --The coords to open menu
		job = "mechanic5", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "East Custom", -- Name of the Location that will appear if blipmap == true
		coords = vector3(887.1227, -2125.8247, 30.5586), --The coords to open menu
		job = "mechanic6", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
		blipmap = false, --Show the blip in map?
		...
		blipsprite = 72, -- The blip sprite, there's a list of all available: https://docs.fivem.net/docs/game-references/blips/
		used = false, -- Don't tuch
		WebHook = "https://discord.com/api/webhooks/1080295217288192070/9MBUzJTITfDOlarxQ39qXR6QHgQaTdwSmH54raIPiwIw3LsqQ2EqVUmnVtdANNMYlvhC"
	},
	{
		name = "East Custom", -- Name of the Location that will appear if blipmap == true
		coords = vector3(909.1302, -2127.7449, 30.5586), --The coords to open menu
		job = "mechanic6", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Red Roses MC", -- Name of the Location that will appear if blipmap == true
		coords = vector3(2523.7341, 4113.3979, 38.5846), --The coords to open menu
		job = "mechanic7", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
		blipmap = false, --Show the blip in map?
		...
		blipsprite = 72, -- The blip sprite, there's a list of all available: https://docs.fivem.net/docs/game-references/blips/
		used = false, -- Don't tuch
		WebHook = "https://discord.com/api/webhooks/1084706242104131654/WqH-e4rFqnLv_PLkPEQbUu1a0KOSSm0JqGsmByRkCecizVW3WnXjLSv7YuhnEWExjHcW"
	},
	{
		name = "Red Roses MC", -- Name of the Location that will appear if blipmap == true
		coords = vector3(2526.6729, 4120.7842, 38.5846), --The coords to open menu
		job = "mechanic7", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Custom Motorcycles", -- Name of the Location that will appear if blipmap == true
		coords = vector3(23.9231, 6456.2622, 31.4270), --The coords to open menu
		job = "mechanic8", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
		blipmap = false, --Show the blip in map?
		...
		blipsprite = 72, -- The blip sprite, there's a list of all available: https://docs.fivem.net/docs/game-references/blips/
		used = false, -- Don't tuch
		WebHook = "https://discord.com/api/webhooks/1088620116264095744/WJiLXVJxDpL_6gE_YGGUnSI1pwwnqRur_EOMOg4KsY0eqaJ3dWkjPZjJMzor0mR-A6IW"
	},
	{
		name = "Custom Motorcycles", -- Name of the Location that will appear if blipmap == true
		coords = vector3(14.6436, 6462.2856, 31.4270), --The coords to open menu
		job = "mechanic8", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
	...
	{
		name = "Santos Custom", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-321.2986, -156.2128, 39.0098), --The coords to open menu
		job = "mechanic9", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
		blipmap = false, --Show the blip in map?
		...
		blipsprite = 72, -- The blip sprite, there's a list of all available: https://docs.fivem.net/docs/game-references/blips/
		used = false, -- Don't tuch
		WebHook = "https://discord.com/api/webhooks/1091749516564234342/8la3r-KlFLc7PTGnTzRqGzRLZnz7162utqpmdHJne027HZ-8cW4Bn8glnnDQFNdXF8tU"
	},
	{
		name = "Santos Custom", -- Name of the Location that will appear if blipmap == true
		coords = vector3(-313.5706, -134.7237, 39.0097), --The coords to open menu
		job = "mechanic9", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
...
---------------- TUNEO DE AERONAVES --------------------------
	...
	{
		name = "Ruta 68", -- Name of the Location that will appear if blipmap == true
		coords = vector3(1772.1626, 3305.8743, 41.1825), --The coords to open menu
		job = "mechanic1", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
...
---------------
	...
	{
		name = "Administrativo", -- Name of the Location that will appear if blipmap == true
		coords = vector3(55.8345, 7240.3413, 2.6023), --The coords to open menu
		job = "staff", --The job that have access to it (remove the line and everyone can access it)
		howmuchtopay = 100, -- The percentage to pay. In this blip, the player/society will pay the normal price (100%), you can change it, for example, if you change it to 190, the player will pay 1.9x the original price, if the tunning costs 1000, the player will pay 1900
		society = true, -- The money that the client pay goes to the society account? (will only work if job isn't nil.)
		societypercentage = 50, --50% of the money goes to society and the other 50% goes to the mechanic (will only work if society = true.)
		blipmap = false, --Show the blip in map?
		...
		blipsprite = 72, -- The blip sprite, there's a list of all available: https://docs.fivem.net/docs/game-references/blips/
		used = false, -- Don't tuch
		WebHook = "https://discord.com/api/webhooks/1064525272386371704/k0S1KGObcJOkGnVu5rBri6jsm57NPFputjUWAqAt4_0ogEOPmHcRZ9Cyfp3ueNQR2zFi"
	},
}
