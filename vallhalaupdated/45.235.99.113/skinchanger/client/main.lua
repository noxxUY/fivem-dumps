local Components = {
	...
	{label = _U('hair_1'),					name = 'hair_1',			value = 21,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	...
	{label = _U('tshirt_1'),				name = 'tshirt_1',			value = 15,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15,	componentId	= 8},
	{label = _U('tshirt_2'),				name = 'tshirt_2',			value = 0,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15,	textureof	= 'tshirt_1'},
	{label = _U('torso_1'),					name = 'torso_1',			value = 235,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15,	componentId	= 11},
	...
	{label = _U('pants_1'),					name = 'pants_1',			value = 12,		min = 0,	zoomOffset = 0.8,		camOffset = -0.5,	componentId	= 4},
	{label = _U('pants_2'),					name = 'pants_2',			value = 0,		min = 0,	zoomOffset = 0.8,		camOffset = -0.5,	textureof	= 'pants_1'},
	{label = _U('shoes_1'),					name = 'shoes_1',			value = 6,		min = 0,	zoomOffset = 0.8,		camOffset = -0.8,	componentId	= 6},
