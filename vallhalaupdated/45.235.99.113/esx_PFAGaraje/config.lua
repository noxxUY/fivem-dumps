...
Config.pfaDatabaseName = 'police'	-- set the exact name from your jobs database for pfa

--pfa Car Garage:
Config.CarZones = {
	pfaCarGarage = {
		Pos = {
			{x = 454.6,  y = -1017.4, z =  28.9},
		}
	}
}
...
-- pfa Car Garage Marker Settings:
Config.pfaCarMarker = 36 												-- marker type
Config.pfaCarMarkerColor = { r = 0, g = 0, b = 255, a = 100 } 			-- rgba color of the marker
Config.pfaCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.CarDraw3DText = "[E] Presione para abrir el garage"			-- set your desired text here

-- pfa Heli Garage Marker Settings:
Config.pfaHeliMarker = 27 												-- marker type
Config.pfaHeliMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.pfaHeliMarkerScale = { x = 5.5, y = 5.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.HeliDraw3DText = "[E] Para abrir el garaje"		-- set your desired text here

-- pfa Boat Garage Marker Settings:
Config.pfaBoatMarker = 27 												-- marker type
Config.pfaBoatMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.pfaBoatMarkerScale = { x = 3.0, y = 3.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.BoatDraw3DText = "[E] Para abrir el garaje"		-- set your desired text here

-- pfa Extra Garage Marker Settings:
Config.pfaExtraMarker = 27 												-- marker type
Config.pfaExtraMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker
Config.pfaExtraMarkerScale = { x = 2.5, y = 2.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis
Config.ExtraDraw3DText = "Pulse ~ g ~ [E] ~ s ~ para ~ y ~ Menú extra de EMS ~ s ~"		-- set your desired text here

-- pfa Cars:
Config.pfaVehicles = {
	{ model = 'pfa1', label = '<i class="fas fa-car"></i> Patrulla #1 - BMW'},
	{ model = 'pfa2', label = '<i class="fas fa-car"></i> Patrulla #2 - Maserati Ghibli'},
	{ model = 'pfa3', label = '<i class="fas fa-truck"></i> Camioneta #1 - Gresley'},

	{ model = 'spacer', label = '── High PFA'},
	{ model = 'pfa4', label = '<i class="fas fa-car"></i> Patrulla #1 - Mercedes A6'},
	{ model = 'pfa5', label = '<i class="fas fa-car"></i> Patrulla #2 - Ford Mustang'},
	{ model = 'pfa6', label = '<i class="fas fa-car"></i> Patrulla #3 - Dodge Charger'},
	{ model = 'pfa7', label = '<i class="fas fa-truck"></i> Camioneta #1 - Caracara 4x4'},

	{ model = 'spacer', label = '── Head PFA'},
	{ model = 'pfa8', label = '<i class="fas fa-truck"></i> Camioneta #1 - Cadillac Escalade'},
	{ model = 'pfa9', label = '<i class="fas fa-car"></i> Patrulla #1 - Lamborghini Aventador'},
	{ model = 'pfa10', label = '<i class="fas fa-car"></i> Patrulla #2 - Bentley'},
	{ model = 'pfa11', label = '<i class="fas fa-car"></i> Patrulla #3 - Ferrari 458 Interventor'},

	{ model = 'spacer', label = '── Grupo Halcon'},
	{ model = 'pfa12', label = '<i class="fas fa-truck"></i> Camioneta #1 - Ford Ranger Raptor'},
	--{ model = 'pfa14', label = '<i class="fas fa-truck"></i> Camioneta #3 - Unidad de Traslado', grade = 5 },
	{ model = 'riot', label = '<i class="fas fa-truck"></i> Blindado #1 - Blindado Insurgent'},

	{ model = 'spacer', label = '── Unidad Motorizada'},
	{ model = 'pfa15', label = '<i class="fas fa-motorcycle"></i> Motorizada #1 - HCBR 500'},
	{ model = 'pfa16', label = '<i class="fas fa-motorcycle"></i> Motorizada #2 - Cuatriciclo Off-Road'},
		
}

-- pfa Helicopters:
Config.pfaHelicopters = {
	{ model = 'helicopteropfa', label = 'PFA helicoptero', livery = 0, price = 0 }
}

-- pfa Boats:
Config.pfaBoats = {
	{ model = 'predator', label = 'pfa Predator', livery = 0, price = 0 }
}
...
Config.TitlepfaGarage = "Garaje de PFA"
Config.TitlepfaExtra = "Extra"
Config.TitlepfaLivery = "Livery"
...
Config.CarOutFromPolGar ="¡Sacaste un Vehículo de Garage de PFA!"
Config.HeliOutFromPolGar = "¡Sacaste un helicóptero de PFA Helicoptero Garage!"
Config.BoatOutFromPolGar = "¡Sacaste un Barco de Garage de barcos de PFA!"
