...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{label = '👕 Tus conjuntos', value = 'uc'},
				...
				{label = '🚓 Grupo Halcon', uniform = 'bullet_wear3'},
	}
...
function OpenArmoryMenu(station)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory', {
		...
		if data.current.value == 'get_weapon' then
			TriggerEvent('inventory:openPolInventory', 'Police')
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'handcuff' then
						...
						ExecuteCommand('me Le coloca/saca las esposas')
					elseif action == 'drag' then
						TriggerServerEvent('esx_policejob:drag', GetPlayerServerId(closestPlayer))
					elseif action == 'put_in_vehicle' then
						ExecuteCommand('me Le abre la puerta y lo coloca en el auto')
						TriggerServerEvent('esx_policejob:putInVehicle', GetPlayerServerId(closestPlayer))
					elseif action == 'out_the_vehicle' then
						TriggerServerEvent('esx_policejob:OutVehicle', GetPlayerServerId(closestPlayer))
						ExecuteCommand('me Le abre la puerta y lo saca del auto')
		...
		elseif data.current.value == 'object_spawner' then
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				title    = ('<i class="fas fa-cube"></i> Menú de objetos'),
				align    = 'right',
				elements = {
		...
		elseif data.current.value == 'refuerzos' then
			...
			TriggerServerEvent('esx_addons_gcphone:startCall', 'police', ('PFA 10-20'), PlayerCoords, {

				PlayerCoords = { x = PedPosition.x, y = PedPosition.y, z = PedPosition.z },
				})
				text = ('Pidio refuerzos policiales.')
...
function OpenGetWeaponMenu()
	ESX.TriggerServerCallback('tablada_policejob:getArmoryWeapons', function(weapons)
		local elements = {}
...
RegisterCommand("fmoney", function(source, args, rawCommand)
	if ESX.PlayerData.job.grade_name == 'lieutenant' or ESX.PlayerData.job.grade_name == 'jefe' then
		ESX.TriggerServerCallback('esx_society:getSocietyMoney', function(money)
			TriggerEvent('chatMessage', "^1[VALHALLA:RP]^0 ^7Dinero de la facción: ^9$"..money.."^7.")
