...
Config.Delays = {
	WeedProcessing = 1000 * 9,
	MethProcessing = 1000 * 9,
	CokeProcessing = 1000 * 9,
	lsdProcessing = 1000 * 9,
	HeroinProcessing = 1000 * 9,
	thionylchlorideProcessing = 1000 * 9,
}
