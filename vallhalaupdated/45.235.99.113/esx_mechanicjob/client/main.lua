...
RegisterCommand('mechanic_f6', function()
	if (ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic') then
		OpenMobileMechanicActionsMenu()
	end
end)
RegisterKeyMapping('mechanic_f6', 'Mechanic F6', 'keyboard', 'F6')

RegisterCommand('mechanic_routes', function()
	if (ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic') then
		if NPCOnJob then
...
RegisterKeyMapping('mechanic_routes', 'Mechanic Routes', 'keyboard', 'DELETE')
