function OpenInventory(otherInv, gang)
    ...
    SendNUIMessage({
        action = 'open',
        inventory = {type = 'main', title = 'Tu <b>Inventario</b>', weight = Config.PlayerWeight},
    ...
    GetInventory()
    if otherInv then
        GetInventory(otherInv, false, gang)
    end
...
function GetInventory(otherInv, refresh, gang)
    if otherInv then
