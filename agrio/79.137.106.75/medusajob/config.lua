...
Config.AuthorizedVehicles = {
    { name = 'g63mg',  label = 'Medusa Vehiculo 1' },
    { name = 'gl63', label = 'Medusa Vehiculo 2'},
    { name = 'chiron17', label = 'Medusa Vehiculo 3'}
}
...
Config.Zones = {
    ...
    Vehicles = {
        Pos          = { x = 735.57, y = -553.38, z = 26.78 },
        SpawnPoint   = { x = 723.90, y = -551.11, z = 26.16 },
