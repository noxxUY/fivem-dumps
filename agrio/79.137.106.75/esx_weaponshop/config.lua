...
Config.Zones = {
	...
	GunShop = {
		...
		Items = {
			...
			{ weapon = 'WEAPON_MACHETE', price = 6000},
			{ weapon = 'WEAPON_FLASHLIGHT', price = 11000},
			{ weapon = 'WEAPON_KNIFE', price = 3250},	
			{ weapon = 'WEAPON_BOTTLE', price = 2500},	
			{ weapon = 'WEAPON_KNUCKLE', price = 6000},	
			{ weapon = 'WEAPON_WRENCH', price = 4000},	
