...
RegisterNetEvent("esx_motel2:eventHandler")
AddEventHandler("esx_motel2:eventHandler", function(response, eventData)
			...
			if dstCheck <= 3.0 then
				...
				if dstCheck <= 0.9 then
					...
					if IsControlJustPressed(0, 74) then
						ESX.TriggerServerCallback("esx_motel2:deleteMotel", function (confirmed)
							if confirmed then
