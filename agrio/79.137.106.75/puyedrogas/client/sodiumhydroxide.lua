...
RegisterNetEvent('snowiCheckPosSodium', function()
TriggerServerEvent('snowiCallBSodium', isPickingUp)
checkLlega = true end)
Citizen.CreateThread(function()
	while true do
		Citizen.Wait(0)
		...
		if nearbyObject3 and IsPedOnFoot(playerPe3) then
			...
			if not isPickingUp then
				ESX.ShowFloatingHelpNotification(_U('SodiumHydroxide_pickupprompt'))
			end
