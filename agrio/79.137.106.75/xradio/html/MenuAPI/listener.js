...
var AppInput = new Vue({
    ...
    methods: {
        Choose: function(){
            $.post('https://xradio/inputmethod', JSON.stringify({
                identifier: this.identifier,
                message: this.message,
            }));
        },
        Close: function(){
            $.post('https://xradio/close', JSON.stringify({
                identifier: this.identifier,
            }));
        },
    },
	...
	window.addEventListener('message', function(event) {
	    ...
	    if(App.visible && !AppInput.visible){
            if (item.type_menu === "enter"){
                $.post('https://xradio/clickItem', JSON.stringify({
            ...
            if (item.type_menu === "up"){
                ...
                $.post('https://xradio/selectNew', JSON.stringify({
                    index: App.menu[index].number,
                    identifier: App.identifier,
