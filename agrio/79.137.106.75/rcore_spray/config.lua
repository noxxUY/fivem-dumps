...
Config = {
    ...
    Text = {
        CANCEL = 'Cancelar',
        SPRAY_ERRORS = {
            NOT_FLAT = 'La superficie no es suficientemente plana!',
            TOO_FAR = 'La superficie está demasiado lejos!',
            INVALID_SURFACE = 'No se puede pintar sobre esa superficie',
            AIM = 'Apunta el spray hacia una pared plana',
        },
        NO_SPRAY_NEARBY = 'No hay spray cerca para eliminar',
        NEED_SPRAY = 'No tienes spray para hacer un graffity',
        WORD_LONG = 'El graffity solo puede tener 9 caracteres MAXIMO',
        USAGE = 'Uso: /spray',
        NUI_TEXT = {
            ['text'] = 'TEXTO',
            ['image'] = 'Imagen',
            ['word-not-allowed'] = 'Palabra no permitida!',
            ['color'] = 'color',
            ['spray'] = 'SPRAY',
            ['click-to-select'] = 'CLICK PARA SELECIONAR',
            ['cancel'] = 'CANCELAR',
            ['keybind-spray'] = 'Spray',
            ['keybind-change-size'] = 'Editar tamaño',
            ['keybind-back'] = 'Volver',
            ['input-placeholder'] = 'Texto del graffity',
