...
Config.AuthorizedVehicles = {
    { name = 'g63mg',  label = 'tequilala Vehiculo 1' },
    { name = 'gl63', label = 'tequilala Vehiculo 2'},
    { name = 'chiron17', label = 'tequilala Vehiculo 3'}
}

Config.Blips = {
    
    Blip = {
        Pos     ={ x = -562.2, y = 289.09, z = 82.12 },
        Sprite  = 93,
        Display = 4,
        Scale   = 0.8,
        Colour  = 27,
...
Config.Zones = {
    ...
    Vehicles = {
        Pos          = { x = -554.37, y = 309.98, z = 83.28 },
        SpawnPoint   ={ x = -554.37, y = 309.98, z = 83.28 },
