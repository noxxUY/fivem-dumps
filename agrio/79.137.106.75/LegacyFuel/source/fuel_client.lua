	...
	while isFueling do
		...
		if not pumpObject then
			if GetAmmoInPedWeapon(ped, 883325847) - fuelToAdd * 100 >= 0 then
				...
				isFueling = false
				TriggerEvent('esx:showNotification', 'El bidón de gasolina se ha quedado vacio! Compra otro o ve a una gasolinera!')
				print('Fuelin false 1')
			end
		else
			currentFuel = oldFuel + fuelToAdd
		end
		...
		if currentFuel > 100.0 then
			currentFuel = 100.0
			isFueling = false
			print('Fuelin false 2')
			TriggerEvent('esx:showNotification', 'El depósito de gasolina ya esta lleno!')
		end
		...
		if currentCash >= currentCost then
			...
			isFueling = false
			print('Fuelin false 3')
			TriggerEvent('esx:showNotification', 'No tienes dinero suficiente para pagar la gasolina!!')
		end
	end
...
--[[RegisterCommand('desbugGasolina', function(source, args) 
TriggerEvent('fuel:refuelFromPump', GetPlayerPed(-1), GetPlayersLastVehicle())
end)--]]
AddEventHandler('fuel:refuelFromPump', function(pumpObject, ped, vehicle)
	print('Envia evento refuerlfrompum')
