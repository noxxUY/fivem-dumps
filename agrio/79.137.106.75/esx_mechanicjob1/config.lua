...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -197.83, y = -1318.01, z = 30.09 },
	...
	Craft = {
		Pos   = { x = -199.31, y = -1315.41, z = 30.09 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -206.12, y = -1302.34, z = 31.3 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = -198.63, y = -1296.54, z = 30.3 },
...
Config.Zones2 = {
	...
	MechanicActions2 = {
		Pos   = { x = 1186.93, y = 2637.31, z = 38.09 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 21,
	},
	...
	Garage = {
		Pos   = { x = 1213.45, y = 2664.18, z = 37.84 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 36,
	},
	...
	VehicleSpawnPoint2 = {
		Pos   = { x = 1207.92, y = 2698.14, z = 37.3 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = 1214.33, y = 2723.04, z = 38.3 },
		Size  = { x = 3.0, y = 3.0, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
