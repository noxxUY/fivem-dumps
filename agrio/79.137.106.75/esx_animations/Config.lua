...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.imgur.com/OLVzyHD.png",
-- You can change the menu position here
	MenuPosition = "left", -- (left, right)
-- You can disable the Ragdoll keybinding here.
	RagdollEnabled = false,
	RagdollKeybind = 280, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
Config.Languages = {
  ...
  ['es'] = {
        ...
        ['doyouwanna'] = "~y~[E]~w~ para aceptar, ~r~L~w~ para rechazar (~g~",
