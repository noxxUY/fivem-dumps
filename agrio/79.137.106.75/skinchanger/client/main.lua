...
vestuario=vestuariosDefaultF[math.random(1, #vestuariosDefaultF)]
function loadC()
	Components = nil 
	Components = {
		{label = _U('sex'),						name = 'sex',				value = vestuario.sex,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
		...
		{label = _U('hair_1'),					name = 'hair_1',			value = vestuario.pelo1,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
		{label = _U('hair_2'),					name = 'hair_2',			value = vestuario.pelo2,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
		...
		{label = _U('tshirt_1'),				name = 'tshirt_1',			value = vestuario.camiseta1,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15,	componentId	= 8},
		{label = _U('tshirt_2'),				name = 'tshirt_2',			value = vestuario.camiseta2,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15,	textureof	= 'tshirt_1'},
		{label = _U('torso_1'),					name = 'torso_1',			value = vestuario.toso1,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15,	componentId	= 11},
		{label = _U('torso_2'),					name = 'torso_2',			value = vestuario.torso2,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15,	textureof	= 'torso_1'},
		...
		{label = _U('arms'),					name = 'arms',				value = vestuario.brazos1,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15},
		{label = _U('arms_2'),					name = 'arms_2',			value = vestuario.brazos2,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15},
		{label = _U('pants_1'),					name = 'pants_1',			value = vestuario.pantalones1,		min = 0,	zoomOffset = 0.8,		camOffset = -0.5,	componentId	= 4},
		{label = _U('pants_2'),					name = 'pants_2',			value = vestuario.pantalones2,		min = 0,	zoomOffset = 0.8,		camOffset = -0.5,	textureof	= 'pants_1'},
		{label = _U('shoes_1'),					name = 'shoes_1',			value = vestuario.calzado1,		min = 0,	zoomOffset = 0.8,		camOffset = -0.8,	componentId	= 6},
		{label = _U('shoes_2'),					name = 'shoes_2',			value = vestuario.calzado2,		min = 0,	zoomOffset = 0.8,		camOffset = -0.8,	textureof	= 'shoes_1'},
		...
		{label = _U('chain_1'),					name = 'chain_1',			value = vestuario.cadena1,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65,	componentId	= 7},
		{label = _U('chain_2'),					name = 'chain_2',			value = vestuario.cadena2,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65,	textureof	= 'chain_1'},
		...
		{label = _U('glasses_1'),				name = 'glasses_1',			value = vestuario.gafas1,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65,	componentId	= 1},
		{label = _U('glasses_2'),				name = 'glasses_2',			value = vestuario.gafas2,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65,	textureof	= 'glasses_1'},
		...
		{label = _U('eye_color'),				name = 'eye_color',			value = vestuario.colordeojo,		min = 0,	zoomOffset = 0.4,		camOffset = 0.65},
...
RegisterNetEvent("snowiSetDefRopaS", function(tip)
if tip =="mujer" then
	vestuario=vestuariosDefaultF[math.random(1, #vestuariosDefaultF)]
else
	vestuario=vestuariosDefaultM[math.random(1, #vestuariosDefaultM)]
end
loadC()
end)
