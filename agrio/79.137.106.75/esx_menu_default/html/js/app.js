		...
		'<div class ="pos"><hr></div>'+
				'<div class="menu-items">' + 
					...
					'<div class="footer-items"' +
							'<p>'+
								'<button class="boton1"><i class="fa fa-map-marker"></i> NAVEGAR</button>'+
								'<button class="boton3"><i class="fa fa-hand-pointer"></i> SELECC.</i></button>'+
								'<button class="boton2"><i class="fa fa-arrow-left"></i> SALIR</button>'+
							'</p>'+
					'</div>'+
				'</div>'+
			'</div>' +
