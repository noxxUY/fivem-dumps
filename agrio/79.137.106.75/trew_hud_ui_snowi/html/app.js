...
var eventCallback = {
	ui: function(data) {
		...
		//if (config.showagrio_coins == true) { document.querySelector('#agrio_coins').style.display = 'block'; }
	...
	/*setLogo: function(data)
	 {
		console.log("gologo") 
		 document.querySelector('#server gif').setAttribute('src', data.value); },
	...
	estadoAnim: function(data) {
		console.log(data.value)
		if (data.value=='normal') {
			console.log('normall')
			var voiceId = document.querySelector('#voice2');
		...
		document.querySelector('#voice2').style.display = 'block';
		}
		else {
			console.log('Puta enfado')
		var voiceId = document.querySelector('#voice');
		var voiceIdWithClasses = voiceId.classList;
		voiceIdWithClasses.remove('whisper', 'normal', 'shout');
		voiceIdWithClasses.add(data.value);
		document.querySelector('#voice2').style.display = 'none';
		document.querySelector('#voice').style.display = 'block';
		}
	...
	sendNotification: function(data) {
		...
		setTimeout(function(){ notifyID.classList.add('fadeOutRight'); }, 8000);
	},
