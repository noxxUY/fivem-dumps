...
Config.LandLord = {
    ...
    ["Great Ocean"] = {
        ...
        MotelsEntrances = {
            [50] = vector3(-103.274, 6330.782, 31.576),
            [51] = vector3(-106.432, 6334.169, 31.576),
            [52] = vector3(-107.395, 6339.592, 31.575),
            [53] = vector3(-102.050, 6345.081, 31.575),
            [54] = vector3(-98.7921, 6348.363, 31.575),
            [55] = vector3(-93.3496, 6353.699, 31.575),
            [56] = vector3(-89.9417, 6356.902, 31.575),
            [57] = vector3(-84.6049, 6362.303, 31.575),
        }
    },
}
