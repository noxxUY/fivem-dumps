...
Config.AuthorizedVehicles = {
    { name = 'stretch',  label = 'Vanilla Bahamas Limusina' },
    { name = 'patriot2', label = 'Vanilla Bahamas Patriot2'}
}
...
Config.Zones = {
    ...
    Cloakrooms = {
        Pos   = { x = -1367.54, y = -613.96, z = 30.82 },
    ...
    Vehicles = {
        Pos          = { x = -1394.13, y = -589.18, z = 29.78 },
