Locales['de'] = {
  ...
  ['only_motoconcho'] = 'Du kannst nur motoconchos parken.',
  ...
  ['must_in_motoconcho'] = 'Du musst in einem motoconchos sein umd die Mission starten zu können',
  ...
  ['inventory'] = 'inventory',
  ['motoconcho_client'] = 'motoconcho Client',
