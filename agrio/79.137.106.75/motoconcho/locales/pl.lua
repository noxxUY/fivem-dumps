Locales['pl'] = {
  ...
  ['wear_work'] = 'strój pracownika motoconcho',
  -- garage
  ...
  ['only_motoconcho'] = 'możesz przechowywać tylko taksówki.',
  ...
  ['must_in_motoconcho'] = 'musisz być w taksówce aby rozpocząć misję',
  ...
  ['inventory'] = 'ekwipunek',
  ['motoconcho_client'] = 'klient taksówki',
