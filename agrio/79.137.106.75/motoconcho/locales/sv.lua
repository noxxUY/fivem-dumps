Locales['sv'] = {
  ...
  ['must_in_motoconcho'] = 'du måste vara i en ~y~motoconcho~s~ för att starta uppdraget.',
  ...
  ['inventory'] = 'inventory',
  ['motoconcho_client'] = 'motoconcho klient',
  ...
  ['blip_motoconcho'] = 'motoconchofirman',
}