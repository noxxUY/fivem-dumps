Locales['fi'] = {
  ...
  ['only_motoconcho'] = 'Voit vain tallettaa taxeja',
  ...
  ['must_in_motoconcho'] = 'Sinun pitää olla motoconchossa että voit alottaa työn',
  ...
  ['inventory'] = 'reppu',
  ['motoconcho_client'] = 'motoconcho Asiakas',
