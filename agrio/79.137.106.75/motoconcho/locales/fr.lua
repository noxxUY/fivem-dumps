Locales['fr'] = {
  ...
  ['only_motoconcho'] = 'vous ne pouvez ranger que les motoconcho',
  ...
  ['must_in_motoconcho'] = 'vous devez être dans un motoconcho pour commencer la mission',
  ...
  ['motoconcho_client'] = 'client motoconcho',
