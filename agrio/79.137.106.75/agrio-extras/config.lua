...
Config.PoliceDatabaseName = 'police', 'sheriff', 'sc', 'ambulance'	-- set the exact name del your jobs database for police
...
Config.ExtraDraw3DText = "~p~[E]~s~ para personalizar ~p~vehiculo~s~"		-- set your desired text here
Config.LabelPrimaryCol = "Color primario"
Config.LabelSecondaryCol = "Color secundario"
Config.LabelExtra = "Extra"
Config.LabelLivery = "Pegatinas"
Config.TitlePoliceExtra = "Extra"
Config.TitlePoliceLivery = "Pegatinas"
...
Config.ExtraZones = {
	ExtraPositions = {
		Pos = {
			{x = 438.42,  y = -1018.32, z = 28.56},
			{x = -463.92,  y = 6040.32, z = 31.36}
		}
	}
}
