...
Config.MaxProperties = 1 -- the max amount of houses a player can own
Config.EnableGarage = false -- requires my (loaf) garage
Config.Use3DText = true
Config.EnableESXIdentity = true
Config.IdentitySQL = true -- use mysql for fetching username / lastname, you should only enable this if the other method doesn't work
...
Config.Houses = {
...

    {
        ...
        Price = 4000000,
        Garage = {
            Exit = vector4(-113.222, 985.8329, 235.7406, 180.0),
            Entrance = vector3(-790.32098388672, 307.93585205078, 85.702102661133),
        },
        Entrance = vector4(-113.222, 985.8329, 235.7406, 180.0),
        Type = "apartment",
        ShellType = "HighEndApartment"
    },

    {
        ...
        Entrance = vector4(1260.9, -864.09, 75.39, 180.0),
        Type = "apartment",
        ShellType = "HighEndApartment"
    },
   ...
   --[[ {
    ...
    {
        Label = "Apartamento Norte",
        Type = "house",
        ShellType = "LowTierHouse",
        Price = 20000,
        Entrance = vector4(1695.43, 3873.76, 32.75, 206.99),
    },
    {
        Label = "Apartamento Norte",
        Type = "house",
        ShellType = "LowTierHouse",
        Price = 20000,
        Entrance = vector4(-359.63, 6334.73, 29.85, 221.25),
    },
    {
        Label = "Apartamento Norte",
        Type = "house",
        ShellType = "LowTierHouse",
        Price = 20000,
        Entrance = vector4(-130.75, 6551.9, 29.07, 224.52),
    },
    {
        Label = "Apartamento Norte",
        Type = "house",
        ShellType = "LowTierHouse",
        Price = 20000,
        Entrance = vector4(-332.52, 6302.07, 33.09, 46.31),
    },
    {
        Label = "Apartamento Norte",
        Type = "house",
        ShellType = "LowTierHouse",
        Price = 20000,
        Entrance = vector4(1841.8, 3928.6, 33.72, 190.59),
    },
    {
        Label = "Apartamento Norte",
        Type = "house",
        ShellType = "LowTierHouse",
        Price = 20000,
        Entrance = vector4(1436.25, 3638.99, 34.95, 20.04),
    },
    {
        Label = "Apartamento Norte",
        Type = "house",
        ShellType = "LowTierHouse",
        Price = 20000,
        Entrance = vector4(1430.8, 3671.41, 34.03, 15.55),
    },
    {
        Label = "Apartamento Norte",
        Type = "house",
        ShellType = "LowTierHouse",
        Price = 20000,
        Entrance = vector4(1385.27, 3659.43, 34.53, 20.08),
    },
...
-----------------------------------------------------------------------------------------------------
  ...
  --[[  {
    ...
    },
    {
        ...
        ShellType = "LowTierHouse",
        Price = 40000,
        Entrance = vector4(240.711150000488, -1687.8841552734, 29.699613571167, 232.43984985352),
    },
    {
        Label = "Brouge Ave",
        Type = "house",
