...
Config.Markers = {
    Entrance = {size = 2.5, r = 0, g = 0, b = 200},
    Exit = {size = 2.5, r = 0, g = 0, b = 200},
}
...
Config.Locations = {
    ...
    {
        ShowBlip = true,
        Entrance = {x = 2527.01007, y = 4200.09414, z = 39.4686},
        Exit =     {x = 2521.20321, y = 4190.42109, z = 39.4667},
        Jets = {
            {x =  2527.01007, y = 4200.09414, z = 39.4686, xRot = -90.0, yRot = 0.0, zRot = 0.0},
            {x = 2521.20321, y = 4190.42109, z = 40.4667, xRot = -90.0, yRot = 0.0, zRot = 45.0},
            {x = 2524.20321, y = 4194.42109, z = 39.4667, xRot = -90.0, yRot = 0.0, zRot = 135.0},
        }
    },
    {
        ShowBlip = true,
