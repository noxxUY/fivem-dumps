  ...
  return function(t) {
      ...
      function p(t) {
          if (t.hasSound) {
              ...
              }), t.barDom ? t.barDom.appendChild(e) : document.querySelector(".shake").appendChild(e), e.volume = t.options.sounds.volume, t.soundPlayed || (e.play(), t.soundPlayed = !0), e.onended = function() {
                  d(e)
              }
          }
      }
      ...
      function p() {
          var t = document.querySelector(".shake"),
      ...
      function m(t) {
          ...
          t.layoutDom = document.querySelector("div#" + e), t.layoutDom || (t.layoutDom = document.createElement("div"), t.layoutDom.setAttribute("id", e), t.layoutDom.setAttribute("role", "alert"), t.layoutDom.setAttribute("aria-live", "polite"), k.addClass(t.layoutDom, "noty_layout"), document.querySelector(".shake").appendChild(t.layoutDom))
      }
