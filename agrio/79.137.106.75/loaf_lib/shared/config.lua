...
Config.DrawDistance = 100.0 -- marker draw distance
Config.DefaultColour = {125, 75, 195, 100} -- default marker colour, r, g, b, a

Config.Keybindings = { -- default keybinds
    ["primary"] = {
        defaultKey = "E",
    ...
    ["secondary"] = {
        defaultKey = "G",
        description = "Acciones secundarias"
    },
}