...
Config.Weapons = {
	...
	----CAYO PERICO
	{name = 'WEAPON_PIPEWRENCH', label = 'Llave de taller', components = {}},
	{name = 'WEAPON_SMG_MK2', label = 'Micro SMG MK2', components = {}},
	{name = 'WEAPON_SNSPISTOL_MK2', label = 'Pistola SNS MK2', components = {}},
