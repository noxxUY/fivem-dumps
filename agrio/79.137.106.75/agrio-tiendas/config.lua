Config = {
  ...
  --[[    Locations = {
           ...
           --[[ [1] = {
                ["shelfs"] = { 
                    {["x"] = 814.2246, ["y"] = -782.119, ["z"] = 26.174, ["value"] = "checkout"},
                    {["x"] = 816.6067, ["y"] = -777.617, ["z"] = 26.174, ["value"] = "drinks"},
                    {["x"] = 818.3744, ["y"] = -780.556, ["z"] = 26.174, ["value"] = "snacks"}, 
                    {["x"] = 821.5794, ["y"] = -782.387, ["z"] = 26.174, ["value"] = "readymeal"},
                    {["x"] = 814.4174, ["y"] = -779.976, ["z"] = 26.174, ["value"] = "diverse"}, 
                }, 
                ["blip"] = { 
                    ["x"] = 817.3054, ["y"] = -783.498, ["z"] = 26.174
                },
                ["cashier"] = {
                    ["x"] = 1727.87, ["y"] = 6415.25, ["z"] = 34.06, ["h"] = 242.93
                },
            ...
            [7] = { 
                ["shelfs"] = {
                    {["x"] = -1209.24, ["y"] = -1503.06, ["z"] = 4.3738, ["value"] = "checkout"},
                    {["x"] = -1211.64, ["y"] = -1505.53, ["z"] = 4.3738, ["value"] = "phone"},
            ...
            [8] = { 
                ["shelfs"] = { 
                    {["x"] = -1226.79, ["y"] = -1477.80, ["z"] = 4.3738, ["value"] = "checkout"},
                    {["x"] = -1227.91, ["y"] = -1479.69, ["z"] = 4.3738, ["value"] = "medicamentos"},
            ...
            [9] = { 
                ["shelfs"] = { 
                    {["x"] = -1226.07, ["y"] = -1483.65, ["z"] = 4.3738, ["value"] = "checkout"},
                    {["x"] = -1226.87, ["y"] = -1481.52, ["z"] = 4.3738, ["value"] = "objetos"},
            ...
            --[[ [7] = {
                ["shelfs"] =  {
                    {["x"] = 4467.610, ["y"] = -4465.17, ["z"] = 4.2467, ["value"] = "checkout"},
                    {["x"] = 4470.906, ["y"] = -4465.40, ["z"] = 4.2447, ["value"] = "drinks"},
                    {["x"] = 4468.529, ["y"] = -4467.31, ["z"] = 4.2432, ["value"] = "snacks"},
                 --  {["x"] = 32.45, ["y"] = -1342.96, ["z"] = 29.5, ["value"] = "readymeal"},
                    {["x"] = 4469.373, ["y"] = -4464.20, ["z"] = 4.2545, ["value"] = "diverse"},
                },
                ["blip"] = {
                    ["x"] = 4469.373, ["y"] = -4464.20, ["z"] = 4.2545
                },
                ["cashier"] = { 
                    ["x"] = 4467.122, ["y"] = -4463.35, ["z"] = 3.2496, ["h"] = 200.82
                },
            },]]---
    ...
    Locations = {
        ...
        [24] = { 
            ["shelfs"] = { 
                {["x"] = 103.55, ["y"] = 6621.91, ["z"] = 31.79, ["value"] = "checkout"},
                {["x"] = 103.28, ["y"] = 6625.41, ["z"] = 31.79, ["value"] = "objetos2"},
    ...
    Items = {
        ["drinks"] = {
            ...
            {label = "Redbull", item = "redbull", price = 5},
            {label = "Monster", item = "monster", price = 5},
            {label = "Cafe", item = "coffe", price = 5},
            {label = "Agua", item = "water", price = 5},
            {label = "Powerade", item = "powerade", price = 5},
            {label = "Cerveza", item = "beer", price = 5},
            {label = "Batido de proteinas", item = "protein_shake", price = 5},
        },
        ["snacks"] = {
            {label = "HotDog", item = "bread", price = 5},
            {label = "Sandwich", item = "sandwich", price = 5},
            {label = "Chocolate", item = "chocolate", price = 5},
            --{label = "Hamburguesa", item = "burguer", price = 5},
            --{label = "Croasan", item = "croasan", price = 20},
            {label = "Comida Deportiva", item = "sportlunch", price = 5},
        },
        ["readymeal"] = {
            --{label = "Chocolate", item = "chocolate", price = 5},
            {label = "Patatas Fritas", item = "chips", price = 5},
            {label = "Hamburguesa", item = "hamburguer", price = 5},
           {label = "Kebab", item = "kebab", price = 5},
           -- {label = "Tuercas", item = "tuerca", price = 100},
           -- {label = "Tornillos", item = "tornillo", price = 100},
          --  {label = "Destornillador", item = "destornillador", price = 200},
           -- {label = "Alicates", item = "alicantes", price = 200},
           -- {label = "Tijeras", item = "tijeras", price = 200},
           -- {label = "Mortero", item = "mortero", price = 200},
          --  {label = "Pegamento", item = "pegamento", price = 200},
          --  {label = "Martillo", item = "martillo", price = 1000},
          --  {label = "Cables", item = "cable", price = 100},
          --  {label = "Led", item = "led", price = 100},
         --   {label = "Pila", item = "pila", price = 3},
            --{label = "Cuerda", item = "cuerda", price = 500},
          --  {label = "Trapo", item = "tela", price = 10},
          --  {label = "Botella", item = "botella", price = 100},
         --   {label = "Bolsa de plástico", item = "bolsa", price = 5},
            --{label = "Fardo", item = "fardo", price = 10},
         --   {label = "Hierro", item = "hierro", price = 350},
         --   {label = "Aluminio", item = "aluminio", price = 400},
        --    {label = "Cutter", item = "cutter", price = 300},
        --    {label = "Pala", item = "pala", price = 230},
        },
        ["ilegal"] = {
            --{label = "Cargador", item = "clip", price = 250}
        },
        ["phone"] = {
            {label = "Telefono", item = "phone", price = 250},
            {label = "Funda Impermeable", item = "fundaimper", price = 20}
        },
        ["objetos"] = {
            {label = "Equipo de buceo", item = "scubagear", price = 150},
            --{label = "Kit De Reparacion", item = "fixkit", price = 150},
          {label = "Perforadora", item = "perforadora", price = 150},
          {label = "Altavoz", item = "boombox", price = 150},
          {label = "Gancho", item = "gancho", price = 150},
          {label = "Walki", item = "walki", price = 150},
            {label = "Spray", item = "spray", price = 150},
            {label = "Removedor de Spray", item = "spray_remover", price = 150},
            {label = "Antorcha Submarina", item = "uwtorch", price = 150}
            

        },
        ["objetos2"] = {
            {label = "Ganzua", item = "lockpick", price = 300},
            --{label = "Kit De Reparacion", item = "fixkit", price = 150},
            

        },
        ["medicamentos"] = {
            {label = "Botiquin", item = "medikit", price = 150},
            {label = "Vendas", item = "bandage", price = 150},
            {label = "Equipo de buceo", item = "scubagear", price = 150},
            {label = "Pildora Del Olvido", item = "piluleoubli", price = 50},
            {label = "Pildora Anti Estres", item = "pastillaantiestres", price = 50}
        },
        ["diverse"] = {
            --{label = "Telefono", item = "phone", price = 150},
            --{label = "Traje de Buzo Corto", item = "plongee1", price = 1000},
           -- {label = "Traje de Buzo Largo", item = "plongee2", price = 2000},
            --{label = "Trapo", item = "tela", price = 10},
          --  {label = "Llaves", item = "llaves", price = 250},
           -- {label = "Venda", item = "bandage", price = },
           -- {label = "Altavoz", item = "altavoz", price = 5},
          --  {label = "Pelota", item = "ball", price = 50},
           --{label = "Kit de reparacion", item = "fixkit", price = 100},
            {label = "Tabaco", item = "cigarette", price = 5},
            {label = "Mechero", item = "lighter", price = 5},
            --{label = "Radio", item = "radio", price = 100},
            --{label = "Vaper", item = "vaper", price = 400},
           -- {label = "Carga vaper", item = "cargavaper", price = 50},
            {label = "Chicle", item = "chicle", price = 5},
            --{label = "Vendas", item = "bandage", price = 10},
           -- {label = "Papel", item = "papel", price = 5},
           -- {label = "Rasca Loteria", item = "rasca", price = 40},
           -- {label = "Spray", item = "spray", price = 500},
           -- {label = "Limpia Spray", item = "spray_remover", price = 700},
        },
    },
}