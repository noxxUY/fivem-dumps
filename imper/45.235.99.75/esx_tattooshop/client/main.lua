           ...
           if hour < Config.OpeningHour or hour > ClosingTime then
		      ESX.ShowHelpNotification(CurrentActionMsg)
		          if IsControlJustReleased(0, Keys['E']) then
		             ESX.ShowAdvancedNotification('Insanity City', '~y~Estabelecimento', '~r~O estabelecimento está fechado~g~ Funcionamos de ' .. Config.OpeningHour .. ' - ' .. Config.ClosingHour ..'.', 'CHAR_PEGASUS_DELIVERY', 8)
			end
       else
