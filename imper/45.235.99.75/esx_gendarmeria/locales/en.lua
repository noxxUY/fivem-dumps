Locales['en'] = {
  ...
  ['policenorth_wear'] = 'police Outfit',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~Police North~s~',
  -- Vehicle interaction
