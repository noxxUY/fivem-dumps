...
Config.CostMultiplier = 50.0

-- Configure the strings as you wish here.
Config.Strings = {
	ExitVehicle = "Salga del vehículo para repostar",
	EToRefuel = "Presione ~g~E ~w~para cargar nafta",
	JerryCanEmpty = "El bidón está vacío",
	FullTank = "Tanque lleno",
	PurchaseJerryCan = "Presione ~g~E ~w~comprar un bidón para ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Presione ~g~E ~w~para cancelar el abastecimiento de combustible",
	CancelFuelingJerryCan = "Presione ~g~E ~w~para cancelar el abastecimiento de combustible",
	NotEnoughCash = "No hay suficiente efectivo",
	RefillJerryCan = "Presione ~g~E ~w~ para volver a llenar el bidón",
	NotEnoughCashJerryCan = "No hay suficiente efectivo para recargar bidón",
	JerryCanFull = "El bidón está lleno",
	TotalCost = "Costo",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presione ~g~E ~w~Agarrar un bidón"
	Config.Strings.RefillJerryCan = "Presione ~g~E ~w~ para volver a llenar el bidón"
end
