	...
	window.addEventListener('message', function (event) {
		...
		switch (event.data.action) {
			...
			case 'updatePlayerJobs':
                ...
                $('#mechanicv2').html(jobs.mechanicv2);
				$('#ems').html(jobs.ems);
				$('#gendarmerie').html(jobs.gendarmerie);
				$('#lsc').html(jobs.lsc);
				$('#mechanicv5').html(jobs.mechanicv5);
				$('#prosegur').html(jobs.prosegur);
				$('#mechanicv6').html(jobs.mechanicv6);
                $('#armeria').html(jobs.armeria);
				$('#armeriav2').html(jobs.armeriav2);
