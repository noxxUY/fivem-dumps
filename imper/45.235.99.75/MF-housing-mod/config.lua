...
Config = {
  ...
  StoreStolenPlayerVehicles = true,        -- can players store other player vehicles at their house?
  ...
  PoliceJobs = {
    ...
    police2 = {     -- JOB NAME
      minRank = 5,  -- min rank to raid house
    }
  },
}
...
Config.DiscordWebHook = "https://discord.com/api/webhooks/1062853940825301133/PcPrLlORf9fZOSzxKVwARjclYxXK6lVAbGXcGACW0dFSjW4cYmFNC1t73tKpvORFg7VT" -- Link al discord webhook matias#1111
