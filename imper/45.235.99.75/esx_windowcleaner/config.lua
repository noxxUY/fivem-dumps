...
Config.nameJobLabel               = "Limpiador de ventanas"
Config.platePrefix                = "LIMPIADOR"
Config.Locale                     = 'en'
...
Config.Zones = {
  ...
  Cloakroom = {
	...
	hint = 'Seguir adelante ~INPUT_CONTEXT~ para acceder al vestuario',
  },
  ...
  VehicleSpawner = {
	...
	BlipSprite = 384,
	BlipColor = 1,
	BlipName = Config.nameJobLabel.." : vehiculo",
	hint = 'Seguir adelante ~INPUT_CONTEXT~ para acceder al garaje',
  },
  ...
  VehicleDeleter = {
	...
	hint = 'Presione ~INPUT_CONTEXT~ para almacenar el vehículo de trabajo',
  },
  ...
  Vente = {
	...
	BlipSprite = 384,
	BlipColor = 1,
	BlipName = Config.nameJobLabel.." : Deposito",

	ItemTime = 600,
	ItemDb_name = "receipt",
	ItemName = "Recibo Limpiador",
	ItemMax = 50,
	ItemAdd = 1,
	ItemRemove = 1,
	ItemRequires = "receipt",
	ItemRequires_name = "Recibo Limpiador",
	ItemDrop = 50,
	ItemPrice  = 2000000,
	hint = 'Seguir adelante ~INPUT_CONTEXT~ sacar provecho de  Recibo Limpiador',
  },
