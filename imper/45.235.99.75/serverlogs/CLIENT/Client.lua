	...
	while true do
		...
		if IsEntityDead(PlayerPedId()) then
			...
			if DeathReason == 'committed suicide' or DeathReason == 'died' then
				TriggerServerEvent('DiscordBot:plaILovePizzayerDied', '['..GetPlayerServerId(PlayerId())..'] '..GetPlayerName(PlayerId()) .. ' ' .. DeathReason .. '.', Weapon)
			else
				TriggerServerEvent('DiscordBot:plaILovePizzayerDied', '['..GetPlayerServerId(Killer)..'] '..GetPlayerName(Killer) .. ' ' .. DeathReason .. ' ['..GetPlayerServerId(PlayerId())..'] ' .. GetPlayerName(PlayerId()) .. '.', Weapon)
			end
			Killer = nil
			DeathReason = nil
			DeathCauseHash = nil
