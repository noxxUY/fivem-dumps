...
-- You can disable the (F3) menu here / change the keybind.
	...
	MenuKeybind = 207, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
-- You can disable the Ragdoll keybinding here.
	RagdollEnabled = true,
	RagdollKeybind = 304, -- Get the button number here https://docs.fivem.net/game-references/controls/
