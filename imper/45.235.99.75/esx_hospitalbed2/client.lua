                ...
                if DoesEntityExist(v) then
                    if GetDistanceBetweenCoords(GetEntityCoords(me), GetOffsetFromEntityInWorldCoords(v, 0.0, 2.0, 0.0), true) <= 5.5 then 
                        ...
                        if IsControlJustReleased(0, 38) or IsDisabledControlJustReleased(0, 38) then
                            TriggerServerEvent('esx_beds2:gethelp', k)
                        end
                    end
                end
            end
...
RegisterNetEvent('esx_beds2:revive')
AddEventHandler('esx_beds2:revive', function(hospital)
    Cinema = true
...
RegisterNetEvent('esx_beds2:notify')
AddEventHandler('esx_beds2:notify', function(txt)
