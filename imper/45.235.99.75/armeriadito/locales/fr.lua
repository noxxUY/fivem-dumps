Locales['fr'] = {
  ...
  ['gendarmerie_wear'] = 'tenue Policier',
  ...
  ['being_searched'] = 'vous êtes ~y~recherché(e)~s~ par la ~b~Police North~s~',
  -- Vehicle interaction
  ...
  ['gendarmerie_stock'] = 'coffre de la gendarmerie',
  -- Misc
  ['remove_prop'] = 'appuyez sur ~INPUT_CONTEXT~ pour enlever l\'objet',
  ['map_blip'] = 'Gendarmerie',
  ['unrestrained_timer'] = 'vous sentez que vos menottes deviennent fragiles.',
  -- Notifications
  ['alert_gendarmerie'] = 'alerte gendarmerie',
  ['phone_gendarmerie'] = 'gendarmerie',
}
