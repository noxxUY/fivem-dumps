...
Config.Zones = {
  ...
  mechanicv5Actions = {  
	...
	Garage = {
		Pos   = { x = 33.89, y = -2006.52, z = 287.95 },
	...
	Craft = {
		Pos   = { x = 101.29, y = 6616.39, z = 31.44 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	VehicleDeleter = {
		Pos   = { x = -670.2, y = -2367.0, z = 13.9 },
		Size  = { x = 6.5, y = 6.5, z = 6.0 },
		Color = { r = 204, g = 0, b = 0 },
		Type  = 27,
	}, 

	VehicleDelivery = {
		Pos   = { x = 189.36, y = 2710.17, z = 42.3 },
