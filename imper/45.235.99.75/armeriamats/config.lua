...
Config.armeriav2Stations = {
	...
	armeriav2 = {
		...
		Vehicles = { 
			{  
				Spawner = vector3(210.8, -24.2, 69.7),
				InsideShop = vector3(230.77, -34.4, 69.71),
				SpawnPoints = {
					{ coords = vector3(210.8, -24.2, 69.7), heading = 81.18, radius = 6.0 },
		...
		Helicopters = {
			{
				...
				InsideShop = vector3(0.0, 0.0, 0.0),
				SpawnPoints = {
					{ coords = vector3(0.0, 0.0, 0.0), heading = 20.53, radius = 10.0 }
				}
			}
		},

		BossActions = {
			vector3(253.5, -52.17, 69.94)
		} 
