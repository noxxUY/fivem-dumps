...
Config.CarDraw3DText = "[E] Para abrir la cochera"			-- set your desired text here
...
Config.HeliDraw3DText = "[E] Para abrir la cochera"		-- set your desired text here
...
Config.BoatDraw3DText = "[E] Para abrir la cochera"	-- set your desired text here
...
Config.PoliceVehicles = {
		{ model = '', label = '-----VEHICULOS-----'},
		{ model = 'bcso2slick', label = 'Vehiculo: Chevrolet'},
		{ model = 'policexz6', label = 'Vehiculo: Audi'},
        { model = 'p508', label = 'Vehiculo: Peugeot'},
              { model = 'policexz4', label = 'Vehiculo: Camioneta'},
		...
		{ model = '', label = '-----Motos-----'},		
		{ model = 'psp_bmwgs', label = 'Moto bmw'},
		
		{ model = '', label = '-----Todo Terreno-----'},	
				{ model = 'anpc_l200', label = 'Patrulla Canina'},
				{ model = 'sapickup', label = 'Patrulla De Transito'},

		{ model = '', label = '-----Especiales-----'},	
				{ model = 'bearcatBCSO', label = 'G.E.O.F'},
		{ model = 'policer8', label = 'Vehiculo: Comisario'},
		{ model = 'HellcatRed', label = 'Incognito'},
		{ model = 'pbus', label = 'Prison Bus'},
		{ model = 'riot2', label = 'Anti Disturbios'}		
}

-- Police Helicopters:
Config.PoliceHelicopters = {
	{ model = 'frogger', label = 'Helicoptero de policia', livery = 0, price = 0 }
}
...
-- Menu Labels & Titles:
Config.LabelStoreVeh = "Entregar un vehiculo"
