...
Config['PacificHeist'] = {
    ...
    ['rewardItems'] = { -- Bu öğeleri veritabanına ekleyin veya paylaşın. Sıralamayı değiştirmeyin, ürün adlarını değiştirebilirsiniz. Ayrıca cam kesme ve boyama ürün isimlerini de unutmayınız.(altta)
        {itemName = 'gold', sellPrice = 1000000},
        {itemName = 'diamond', sellPrice = 4000000},
        {itemName = 'coke_pooch', sellPrice = 2000000},
    },
    ['drillReward'] = function()
        local random = math.random(1, 3)
        return Config['PacificHeist']['rewardItems'][random]['itemName'], 5
    end,
    ['trollyMoneyReward'] = 600000, -- Bu, rulo başına para miktarıdır.
    ['stackRewards'] = { -- Bu yığın ödülleri. (trolly değil) Sadece sayımı değiştirebilirsiniz (='den sonra).
        gold = 25,
        money = 40000
    },
...
Strings = {
    ['e_start'] = 'Presiona ~INPUT_CONTEXT~ para empezar el robo del Pacífico',
    ['start_heist'] = 'Ir al Banco del Pacífico',
    ['start_heist2'] = 'Cosas necesarias para el robo: Laptop, USB hack, Cutter, C4 & Thermite, Bolsa, Taladro',
    ['plant'] = 'Presiona ~INPUT_CONTEXT~ para colocar Thermite',
    ['plant_bomb'] = 'Presiona ~INPUT_CONTEXT~ para colocar C4',
    ['detonate_bombs'] = 'Presiona ~INPUT_CONTEXT~ para detonar los explosivos',
    ['grab'] = 'Presiona ~INPUT_CONTEXT~ para agarrar',
    ['hacking'] = 'Presiona ~INPUT_CONTEXT~ para usar el USB hack',
    ['vault'] = 'Presiona ~INPUT_CONTEXT~ para abrir la caja fuerte',
    ['drill'] = 'Presiona ~INPUT_CONTEXT~ para usar el taladro',
    ['wait_nextrob'] = 'Debes esperar para robar de nuevo',
    ['minute'] = 'minuto/s',
    ['start_stealing'] = 'Presiona ~INPUT_CONTEXT~ para empezar a robar',
    ['cute_right'] = 'Presiona ~INPUT_CONTEXT~ para cortar a la derecha',
    ['cute_left'] = 'Presiona ~INPUT_CONTEXT~ para cortar a la izquierda',
    ['cute_down'] = 'Presiona ~INPUT_CONTEXT~ para cortar hacia abajo',
    ['glass_cut'] = 'Presiona ~INPUT_CONTEXT~ para cortar el cristal',
    ['need_switchblade'] = 'Necesitas un cuchillo',
    ['need_this'] = 'Necesitas esto: ',
    ['deliver_to_buyer'] = 'Entrega el botín al comprador. Revisa el GPS.',
    ['buyer_blip'] = 'Comprador',
    ['need_police'] = 'No hay suficiente policía en la ciudad',
    ['total_money'] = 'Necesitas esto: ',
    ['police_alert'] = '¡Alarma de robo en el Banco del Pacífico! Revisa tu GPS.', 
}
