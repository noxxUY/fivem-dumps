	...
	window.addEventListener('message', function(event) {
		...
		if (item.type == "enable_dailyrewards") {
			...
			$("#left-side").append(
				...
				`</div>`+
					`<span id="reward_progress">ㅤDía Actual: `+ item.day + ` / 28 Días | Semana (` + currentWeek + `)ㅤ</span>`+
				`</div>`
			...
			if (item.status == "waiting"){
				...
				$("#daypacks").append(
					`<div id="rewardBox" >`+
					`<div id="day_counter" style="background-color:rgba(0, 0, 0, 0.507);">DÍA `+ dayRewardsCheck+`</div>`+
					...
					`<div id=" ">ㅤ</div>`+
						...
						`<div id=" ">ㅤ</div>`+
							...
							`<div id="reward_box_claimer" data-tooltip="` + toolTipDescription +`" >`+
								`<i class="fas fa-lock"> BLOQUEADO</i>`+
							`</div>`+
				...
				$("#daypacks").append(
					...
					`<div id="day_counter" style="background-color:rgba(255, 152, 238, 0.417);">DÍA `+ dayRewardsCheck+`</div>`+
					`<div id=" ">ㅤ</div>`+
						`<div id="day_box_det">`+
						`<div id=" ">ㅤ</div>`+
							`<img src="`+ day_detail.image +`" id="reward_box_img">`+
							...
							`<div id="reward_box_claimer" data-tooltip="` + toolTipDescription +`" >`+
								`<i class="fa fa-check"> RECLAMADO</i>`+
							`</div>`+
					...
					`<div id=" ">ㅤ</div>`+
						...
						`<div id=" ">ㅤ</div>`+
							...
							`<div id="reward_box_canClaim" data-tooltip="` + toolTipDescription +`" day='`+ dayRewardsCheck + `' >`+
								`<i class="fa fa-gift"> RECLAMAR</i></i>`+
							`</div>`+
