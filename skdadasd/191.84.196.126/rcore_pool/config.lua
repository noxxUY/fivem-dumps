Config = {
    ...
    Text = {
        BACK = "Atras",
        HIT = "Golpear",
        BALL_IN_HAND = "Mover bola",
        BALL_IN_HAND_BACK = "Dejar de mover la bola",
        AIM_LEFT = "Izquierda",
        AIM_RIGHT = "Derecha",
        AIM_SLOWER = "Despacio",
        ...
        HINT_SETUP = 'Iniciar juego',
        HINT_TAKE_CUE = 'Agarrar palo.',
        HINT_RETURN_CUE = 'Anda a jugar a la mesa.',
        HINT_HINT_TAKE_CUE = 'Para jugar necesitas un palo.',
        HINT_PLAY = 'Jugar',

        BALL_IN_HAND_LEFT = 'Izquierda',
        BALL_IN_HAND_RIGHT = 'Derecha',
        BALL_IN_HAND_UP = 'Adelante',
        BALL_IN_HAND_DOWN = 'Atras',
        BALL_POCKETED = 'Entro la bola %s',
        BALL_IN_HAND_NOTIFY = 'Tenes la bola',
        BALL_LABELS = {
            [-1] = 'Blanca',
            [1] = '~y~Lisa 1~s~',
            [2] = '~b~Lisa 2~s~',
