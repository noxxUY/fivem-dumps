...
Config.Zones = {
	...
	MechanicActions4 = {
		Pos   = vector3(892.9377, -2100.7849, 34.8886 ),
	...
	Garage4 = {
		Pos   = vector3(915.4301, -2099.9229, 30.4594 ),
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 50, g = 200, b = 50 },
		Type  = 21
	},
	...
	Craft4 = {
		Pos   = vector3( 915.3268, -2106.3406, 30.4594 ),
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 50, g = 200, b = 50 },
		Type  = 21
	},
	...
	VehicleSpawnPoint = {
		Pos   = vector3(859.7744, -2124.6807, 30.5410 ),
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = vector3(864.8927, -2125.8086, 30.0606 ),
	...
	VehicleDelivery = {
		Pos   = vector3(-164.4346, -1302.5955, 30.3137 ),
