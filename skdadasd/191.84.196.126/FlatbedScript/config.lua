config = {
    ...
    controlText2 = "[~y~5~w~] raise bed ~r~-~w~ [~y~8~w~] lower bed ~r~-~w~[~g~Safe to Attach/Detach~w~]", -- This text displays next to the "control" panel near the back left of the bed.
