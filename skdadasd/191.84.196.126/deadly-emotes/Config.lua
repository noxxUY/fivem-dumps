...
-- You can disable the Facial Expressions menu here.8x Development | 8xdev.com | Prenses Baran | https://discord.gg/fandgwjNUm
...
-- If you have the SQL imported enable this to turn on keybinding.8x Development | 8xdev.com | Prenses Baran | https://discord.gg/fandgwjNUm
    SqlKeybinding = true,
}
...
Config.Languages = {
  ['en'] = {
        ['emotes'] = 'Animations ~p~ +105 New Emotes',
        ...
        ['suggestionsinfo'] = "~p~ Thanks to dullpear_dev ❤️",
