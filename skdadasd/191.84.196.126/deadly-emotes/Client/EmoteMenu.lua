...
mainMenu = NativeUI.CreateMenu("New Animation Menu", "", menuPosition["x"], menuPosition["y"], Menuthing, Menuthing)
...
function AddInfoMenu(menu)
    if not UpdateAvailable then
      infomenu = _menuPool:AddSubMenu(menu, Config.Languages[lang]['infoupdate'], "(Who prepared this beautiful animation menu .)", "", Menuthing, Menuthing)
    else
    ...
    u170 = NativeUI.CreateItem("~p~Prenses Baran ❤️ | http://8xdev.com", "Our developer who made emotes.")
    u165 = NativeUI.CreateItem("~p~", "")
...
RegisterNetEvent("dp:RecieveMenu") -- For opening the emote menu from another resource.8x Development | 8xdev.com | Prenses Baran | https://discord.gg/fandgwjNUm
