...
Config.messages = {
    ["not on radio"] = "No estas conectado a ninguna frecuencia",
    ["on radio"] = "Ya estas conectado a esta frecuencia",
    ["joined to radio"] = "Estas conectado a: ",
    ["restricted channel error"] = "No tenes permiso para ingresar a esta frecuencia!",
    ["invalid radio"] = "Esta frecuencia no esta disponible.",
    ["you on radio"] = "Ya estas conectado a esta frecuencia",
    ["you leave"] = "Dejaste la frecuencia.",
    ['volume radio'] = 'Nuevo volumen ',
    ['decrease radio volume'] = 'La radio esta al volumen maximo',
    ['increase radio volume'] = 'La radio esta al volumen minimo',
    ['increase decrease radio channel'] = 'Nuevo canal ',
}
