...
vehicles = {
    [`hiluxpfa`] = { -- These are examples, please edit these and add your own vehicles
        name = "Camioneta policia",
        boneName = "engine",
        offSet = {0.0, 0.76, -0.4},
        rotation = {0.0, 0.0, 0.0},
    },
    [`metm`] = { -- These are examples, please edit these and add your own vehicles
        name = "MondeoPoli",
        boneName = "engine",
        offSet = {0.0, 0.76, -0.4},
        rotation = {0.0, 0.0, 0.0},
...
grapplerCommand = {
    ...
    ESX = {
        ...
        checkJob = {
            ...
            jobs = {"policejob", "police"} -- A user can have any of the following jobs, allowing you to add multiple
        }
    },
