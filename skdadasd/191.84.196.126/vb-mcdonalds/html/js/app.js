...
function sumaTotal() { //hace la suma del total.
  ...
  if (!($(combomeal).css("display") == "none")) { 
    var preciocombomeal = Number('300.79');
  ...
  if (!($(bigmac).css("display") == "none")) { 
    var preciobigmac = Number('200.99');
  ...
  if (!($(mcpollo).css("display") == "none")) {
    var preciomcpollo = Number('240.99');
  ...
  if (!($(mcroyaldeluxe).css("display") == "none")) {
    var preciomcroyaldeluxe = Number('180.99');
  ...
  if (!($(cuartodelibra).css("display") == "none")) {
    var preciocuartodelibra = Number('180.50');
  ...
  if (!($(grandmcextreme).css("display") == "none")) {
    var preciograndmcextreme = Number('180.50');
  ...
  if (!($(bigchickensupreme).css("display") == "none")) {
    var preciobigchickensupreme = Number('280.50');
  ...
  if (!($(bigcrispybbq).css("display") == "none")) {
    var preciobigcrispybbq = Number('220.45');
  ...
  if (!($(bigdoublecheese).css("display") == "none")) {
    var preciobigdoublecheese = Number('200.50');
  ...
  if (!($(hamburgesa).css("display") == "none")) {
    var preciohamburgesa = Number('140.50');
  ...
  if (!($(hamburgesadepollo).css("display") == "none")) {
    var preciohamburgesadepollo = Number('160.50');
  ...
  if (!($(mcfish).css("display") == "none")) {
    var preciomcfish = Number('120.99');
  ...
  if (!($(happymeal).css("display") == "none")) {
    var preciohappymeal = Number('300.99');
  ...
  if (!($(cocacola).css("display") == "none")) {
    var preciococacola = Number('80.99');
  ...
  if (!($(nestea).css("display") == "none")) {
    var precionestea = Number('100.99');
  ...
  if (!($(monsterenergy).css("display") == "none")) {
    var preciomonsterenergy = Number('160.99');
  ...
  if (!($(cerveza).css("display") == "none")) {
    var preciocerveza = Number('200.99');
  ...
  if (!($(aquarius).css("display") == "none")) {
    var precioaquarius = Number('140.99');
  ...
  if (!($(sprite).css("display") == "none")) {
    var preciosprite = Number('180.99');
  ...
  if (!($(colacao).css("display") == "none")) {
    var preciocolacao = Number('240.99');
  ...
  if (!($(nuggets).css("display") == "none")) {
    var precionuggets = Number('200.99');
  ...
  if (!($(patatas).css("display") == "none")) {
    var preciopatatas = Number('180.99');
  ...
  if (!($(topfries).css("display") == "none")) {
    var preciotopfries = Number('280.99');
