...
Config.UseAnim = false -- play animation when requesting vehicle list?
Config.ShowVehImpoundInGarage = true
Config.SpawnVehicleInAnyGarage = true -- if true, the fee will be multiplied.
...
Config.CmdVehDelete = 'gardel' -- Admin command for delete vehicle in the words
