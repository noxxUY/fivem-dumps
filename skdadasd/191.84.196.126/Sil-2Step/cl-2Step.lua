...
AddEventHandler("2step:Anti-lag", function()
	if antilag == false then
		antilag = true
		Notif("~c~Cortes ~b~Activados!")
	else
		antilag = false
		Notif("~c~Cortes ~r~Desactivados!")
	end
end)
...
Citizen.CreateThread(function()
	while true do
		if activated == true then
			DrawHudText("", {0, 255, 85,255},0.92,0.88,0.7,0.7,6)
		end
		if AntilagDisplay == true then
			DrawHudText("Cortes", {0, 255, 85,255},0.92,0.88,0.7,0.7,6)
		end
	  Wait(0)
	end
end)
