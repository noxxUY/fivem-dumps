...
config.job = { -- set to false (config.job = false) if you want all feature are accesible by any player, or true, required job to use repairs and upgrade menu, dyno -- job access for menu upgrade and points. ex. mechanic, tuner?
	...
	['mechanic2'] = 1, -- @jobname -- @grade_level
	['mechanic3'] = 1, -- @jobname -- @grade_level
	['mechanic4'] = 1, -- @jobname -- @grade_level
}
...
config.plateprefix = 'PRK' -- recommended 3 char
...
--redline
	[2] = { 
		label = "Dynojet", 
		platform = vec4(-571.90, -936.61, 24.37, 17.68), -- location of dyno position where vehicle will align 
		offsets = vec3(0.2,0.0,0.0), -- additional (+) offset to vehicle fittings
		coord = vec3(-571.90, -936.61, 23.37) -- location of Interaction

	},
--east
	[3] = { 
		label = "Dynojet", 
		platform = vec4(903.35, -2103.4849, 30.89, 355.55), -- location of dyno position where vehicle will align 
		offsets = vec3(0.2,0.0,0.0), -- additional (+) offset to vehicle fittings
		coord = vec3(903.35, -2103.48, 29.89) -- location of Interaction

	},
	--sportracing
	[4] = { 
		label = "Dynojet", 
		platform = vec4(817.83, -952.85, 22.52, 177.58), -- location of dyno position where vehicle will align
		offsets = vec3(0.2,0.0,0.0), -- additional (+) offset to vehicle fittings
		coord = vec3(817.83, -952.85, 21.52) -- location of Interaction
...
config.engineparts = { -- @item = item name, @handling = Affected Handling when degraded
	[1] = {item = 'engine_oil', label = 'Aceite', handling = {'fInitialDriveMaxFlatVel'}, maxdegrade = 0.05, affects = 'Top Speed', cost = 5000},
	[2] = {item = 'engine_sparkplug', label = 'Bujias', handling = {'fDriveInertia'}, maxdegrade = 0.05, affects = 'Torque', cost = 5000},
	[3] = {item = 'engine_gasket', label = 'Juntas', handling = {'fDriveInertia'}, maxdegrade = 0.05, affects = 'Torque', cost = 5000},
	[4] = {item = 'engine_airfilter', label = 'Filtro de Aire', handling = {'fInitialDriveForce'}, maxdegrade = 0.5, affects = 'Horsepower', cost = 10000},
	[5] = {item = 'engine_fuelinjector', label = 'Inyectores', handling = {'fInitialDriveForce'}, maxdegrade = 0.5, affects = 'Horsepower', cost = 15000},
	[6] = {item = 'engine_pistons', label = 'Pistones' , handling = {'fInitialDriveMaxFlatVel'}, maxdegrade = 0.05, affects = 'Top Speed', cost = 15000},
	[7] = {item = 'engine_connectingrods', label = 'Vielas' , handling = {'fInitialDriveForce'}, maxdegrade = 0.05, affects = 'Top Speed', cost = 15000},
	[8] = {item = 'engine_valves', label = 'Valvulas', handling = {'fInitialDriveForce'}, maxdegrade = 0.05, affects = 'Horsepower', cost = 10000},
	[9] = {item = 'engine_block', label = 'Bloque de Motor', handling = {'fInitialDriveMaxFlatVel'}, maxdegrade = 0.05, affects = 'Top Speed', cost = 20000},
	[10] = {item = 'engine_crankshaft', label = 'Ciguenal', handling = {'fDriveInertia'}, maxdegrade = 0.1, affects = 'Torque', cost = 15000},
	[11] = {item = 'transmition_clutch', label = 'Embrague', handling = {'fClutchChangeRateScaleUpShift'}, maxdegrade = 0.2, affects = 'Down Shifting', cost = 10000},
	[12] = {item = 'engine_flywheel', label = 'Volante de Inercia', handling = {'fClutchChangeRateScaleDownShift'}, maxdegrade = 0.2, affects = 'Up Shifting', cost = 10000},
	[13] = {item = 'engine_camshaft', label = 'Arbol de Levas', handling = {'fInitialDriveMaxFlatVel'}, maxdegrade = 0.1, affects = 'Top Speed', cost = 10000},
	[14] = {item = 'oem_brakes', label = 'Frenos', handling = {'fBrakeForce','fHandBrakeForce'}, maxdegrade = 0.1, affects = 'Brake Power', cost = 5000},
	[15] = {item = 'oem_suspension', label = 'Suspension', handling = {'fSuspensionForce','fSuspensionCompDamp','fSuspensionReboundDamp'}, maxdegrade = 0.2, affects = 'Suspension', cost = 15000},
	[16] = {item = 'oem_gearbox', label = 'Caja de Cambios', handling = {'nInitialDriveGears','fDriveInertia','fClutchChangeRateScaleUpShift','fClutchChangeRateScaleDownShift'}, maxdegrade = 0.05, affects = 'Acceleration', cost = 20000},
}
...
config.engineupgrades = {
	-- ULTIMATE
	{category = 'ultimate', state = 'engine_oil', item = 'ultimate_oil', label = 'Aceite Competicion', handling = {'fInitialDriveMaxFlatVel'}, add = 1.30, affects = 'Top Speed', cost = 40000},
	{category = 'ultimate', state = 'engine_sparkplug', item = 'ultimate_sparkplug', label = 'Bujias Competicion', stat = {ignition = 5.0}, handling = {'fDriveInertia'}, add = 1.30, affects = 'Torque', cost = 40000},
	{category = 'ultimate', state = 'engine_gasket', item = 'ultimate_gasket', label = 'Juntas Competicion', handling = {'fDriveInertia'}, add = 1.30, affects = 'Torque', cost = 40000},
	{category = 'ultimate', state = 'engine_airfilter', item = 'ultimate_airfilter', label = 'Filtro de Aire Competicion', handling = {'fInitialDriveForce'}, add = 1.30, affects = 'Horsepower', cost = 80000},
	{category = 'ultimate', state = 'engine_fuelinjector', item = 'ultimate_fuelinjector', label = 'Inyectores Competicion', stat = {fuelpressure = 60.0}, handling = {'fInitialDriveForce'}, add = 1.30, affects = 'Horsepower', cost = 100000},
	{category = 'ultimate', state = 'engine_pistons', item = 'ultimate_pistons', label = 'Pistones Competicion' , stat = {compression = 16.0, fuelpressure = -16.0, ignition = 8.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.30, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 100000},
	{category = 'ultimate', state = 'engine_connectingrods', item = 'ultimate_connectingrods', label = 'Vielas Competicion' , handling = {'fInitialDriveForce'}, add = 1.30, affects = 'Top Speed', cost = 80000},
	{category = 'ultimate', state = 'engine_valves', item = 'ultimate_valves', label = 'Valvulas Competicion', stat = {compression = 1.6, fuelpressure = -1.6}, handling = {'fInitialDriveForce'}, add = 1.30, affects = 'Horsepower', cost = 80000},
	{category = 'ultimate', state = 'engine_block', item = 'ultimate_block', label = 'Bloque de Motor Competicion', stat = {compression = 16.0, fuelpressure = -8.0, ignition = 8.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.30, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 120000},
	{category = 'ultimate', state = 'engine_crankshaft', item = 'ultimate_crankshaft', label = 'Ciguenal Competicion',  stat = {ignition = 8.0}, handling = {'fDriveInertia'}, add = 1.30, affects = 'Torque', mod = {index = 11, add = 1}, cost = 100000},
	{category = 'ultimate', state = 'transmition_clutch', item = 'ultimate_clutch', label = 'Embrague Competicion', handling = {'fClutchChangeRateScaleUpShift'}, add = 1.30, affects = 'Down Shifting', mod = {index = 13, add = 1}, cost = 80000},
	{category = 'ultimate', state = 'engine_flywheel', item = 'ultimate_flywheel', label = 'Volante de Inercia Competicion', handling = {'fClutchChangeRateScaleDownShift'}, add = 1.30, affects = 'Up Shifting', mod = {index = 13, add = 1}, cost = 80000},
	{category = 'ultimate', state = 'engine_camshaft', item = 'ultimate_camshaft', label = 'Arbol de Levas Competicion',stat = {duration = 48.0, compression = 16.0, fuelpressure = -16.0, ignition = 16.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.1, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 80000},
	{category = 'ultimate', state = 'oem_brakes', item = 'ultimate_brakes', label = 'Frenos Competicion', handling = {'fBrakeForce','fHandBrakeForce'}, add = 6.4, affects = 'Brake Power', mod = {index = 12, add = 3}, cost = 40000},
	{category = 'ultimate', state = 'oem_suspension', item = 'ultimate_suspension', label = 'Suspension Competicion', handling = {'fSuspensionForce','fSuspensionCompDamp','fSuspensionReboundDamp','fSuspensionUpperLimit','fSuspensionLowerLimit','fSuspensionRaise','fSuspensionBiasFront','fAntiRollBarForce','fAntiRollBarBiasFront','fRollCentreHeightFront','fRollCentreHeightRear'}, add = 1.6, affects = 'Suspension', mod = {index = 15, add = 4}, cost = 90000},
	{category = 'ultimate', state = 'oem_gearbox', item = 'ultimate_gearbox', label = 'Caja de Cambios Competicion', handling = {'nInitialDriveGears','fDriveInertia','fClutchChangeRateScaleUpShift','fClutchChangeRateScaleDownShift'}, add = 1.30, affects = 'Acceleration', mod = {index = 13, add = 1}, cost = 120000},
	-- RACING
	{category = 'racing', state = 'engine_oil', item = 'racing_oil', label = 'Aceite Carrera', handling = {'fInitialDriveMaxFlatVel'}, add = 1.15, affects = 'Top Speed', cost = 30000},
	{category = 'racing', state = 'engine_sparkplug', item = 'racing_sparkplug', label = 'Bujias Carreras', stat = {ignition = 4.0}, handling = {'fDriveInertia'}, add = 1.15, affects = 'Torque', cost = 30000},
	{category = 'racing', state = 'engine_gasket', item = 'racing_gasket', label = 'Juntas Carreras', handling = {'fDriveInertia'}, add = 1.15, affects = 'Torque', cost = 30000},
	{category = 'racing', state = 'engine_airfilter', item = 'racing_airfilter', label = 'Filtro de Aire Carrera', handling = {'fInitialDriveForce'}, add = 1.15, affects = 'Horsepower', cost = 60000},
	{category = 'racing', state = 'engine_fuelinjector', item = 'racing_fuelinjector', label = 'Inyectores Carreras', stat = {fuelpressure = 45.0}, handling = {'fInitialDriveForce'}, add = 1.15, affects = 'Horsepower', cost = 75000},
	{category = 'racing', state = 'engine_pistons', item = 'racing_pistons', label = 'Pistones Carreras', stat = {compression = 8.0, fuelpressure = -8.0, ignition = 4.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.15, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 75000},
	{category = 'racing', state = 'engine_connectingrods', item = 'racing_connectingrods', label = 'Vielas Carreras' , handling = {'fInitialDriveForce'}, add = 1.15, affects = 'Top Speed', cost = 60000},
	{category = 'racing', state = 'engine_valves', item = 'racing_valves', label = 'Valvulas Carreras', stat = {compression = 0.8, fuelpressure = -0.8}, handling = {'fInitialDriveForce'}, add = 1.15, affects = 'Horsepower', cost = 60000},
	{category = 'racing', state = 'engine_block', item = 'racing_block', label = 'Bloque de Motor Carrera', stat = {compression = 8.0, fuelpressure = -4.0, ignition = 4.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.15, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 90000},
	{category = 'racing', state = 'engine_crankshaft', item = 'racing_crankshaft', label = 'Ciguenal Carrera', stat = {ignition = 4.0}, handling = {'fDriveInertia'}, add = 1.15, affects = 'Torque', mod = {index = 11, add = 1}, cost = 75000},
	{category = 'racing', state = 'transmition_clutch', item = 'racing_clutch', label = 'Embrague Carrera', handling = {'fClutchChangeRateScaleUpShift'}, add = 1.15, affects = 'Down Shifting', mod = {index = 13, add = 1}, cost = 60000},
	{category = 'racing', state = 'engine_flywheel', item = 'racing_flywheel', label = 'Volante de Inercia Carrera', handling = {'fClutchChangeRateScaleDownShift'}, add = 1.15, affects = 'Up Shifting', mod = {index = 13, add = 1}, cost = 60000},
	{category = 'racing', state = 'engine_camshaft', item = 'racing_camshaft', label = 'Arbol de Levas Carrera',stat = {duration = 26.0, compression = 8.0, fuelpressure = -8.0, ignition = 8.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.08, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 60000},
	{category = 'racing', state = 'oem_brakes', item = 'racing_brakes', label = 'Frenos Carreras', handling = {'fBrakeForce','fHandBrakeForce'}, add = 4.4, affects = 'Brake Power', mod = {index = 12, add = 3}, cost = 30000},
	{category = 'racing', state = 'oem_suspension', item = 'racing_suspension', label = 'Suspension Carreraa', handling = {'fSuspensionForce','fSuspensionCompDamp','fSuspensionReboundDamp','fSuspensionUpperLimit','fSuspensionLowerLimit','fSuspensionRaise','fSuspensionBiasFront','fAntiRollBarForce','fAntiRollBarBiasFront','fRollCentreHeightFront','fRollCentreHeightRear'}, add = 1.4, affects = 'Suspension', mod = {index = 15, add = 4}, cost = 75000},
	{category = 'racing', state = 'oem_gearbox', item = 'racing_gearbox', label = 'Caja de Cambios Carreraa', handling = {'nInitialDriveGears','fDriveInertia','fClutchChangeRateScaleUpShift','fClutchChangeRateScaleDownShift'}, add = 1.15, affects = 'Acceleration', mod = {index = 13, add = 1}, cost = 90000},
	-- PRO
	{category = 'pro', state = 'engine_oil', item = 'pro_oil', label = 'Aceite Deportivo', handling = {'fInitialDriveMaxFlatVel'}, add = 1.10, affects = 'Top Speed', cost = 20000},
	{category = 'pro', state = 'engine_sparkplug', item = 'pro_sparkplug', label = 'Bujias Deportivas',stat = {ignition = 3.0}, handling = {'fDriveInertia'}, add = 1.10, affects = 'Torque', cost = 20000},
	{category = 'pro', state = 'engine_gasket', item = 'pro_gasket', label = 'Juntas Deportivas', handling = {'fDriveInertia'}, add = 1.10, affects = 'Torque', cost = 20000},
	{category = 'pro', state = 'engine_airfilter', item = 'pro_airfilter', label = 'Filtro de Aire Deportivo', handling = {'fInitialDriveForce'}, add = 1.10, affects = 'Horsepower', cost = 40000},
	{category = 'pro', state = 'engine_fuelinjector', item = 'pro_fuelinjector', label = 'Inyectores Deportivos',stat = {fuelpressure = 30.0},  handling = {'fInitialDriveForce'}, add = 1.10, affects = 'Horsepower', cost = 50000},
	{category = 'pro', state = 'engine_pistons', item = 'pro_pistons', label = 'Pistones Deportivos' , stat = {compression = 4.0, fuelpressure = -4.0, ignition = 2.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.10, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 50000},
	{category = 'pro', state = 'engine_connectingrods', item = 'pro_connectingrods', label = 'Vielas Deportiva' , handling = {'fInitialDriveForce'}, add = 1.10, affects = 'Top Speed', cost = 40000},
	{category = 'pro', state = 'engine_valves', item = 'pro_valves', label = 'Valvulas Deportivas', stat = {compression = 0.4, fuelpressure = -0.4}, handling = {'fInitialDriveForce'}, add = 1.10, affects = 'Horsepower', cost = 40000},
	{category = 'pro', state = 'engine_block', item = 'pro_block', label = 'Bloque de Motor Deportivo', stat = {compression = 4.0, fuelpressure = -4.0, ignition = 2.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.10, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 60000},
	{category = 'pro', state = 'engine_crankshaft', item = 'pro_crankshaft', label = 'Ciguenal Deportivo', stat = {ignition = 2.0}, handling = {'fDriveInertia'}, add = 1.10, affects = 'Torque', mod = {index = 11, add = 1}, cost = 50000},
	{category = 'pro', state = 'transmition_clutch', item = 'pro_clutch', label = 'Embrague Deportivo', handling = {'fClutchChangeRateScaleUpShift'}, add = 1.10, affects = 'Down Shifting', mod = {index = 13, add = 1}, cost = 40000},
	{category = 'pro', state = 'engine_flywheel', item = 'pro_flywheel', label = 'Volante de Inercia Deportivo', handling = {'fClutchChangeRateScaleDownShift'}, add = 1.10, affects = 'Up Shifting', mod = {index = 13, add = 1}, cost = 40000},
	{category = 'pro', state = 'engine_camshaft', item = 'pro_camshaft', label = 'Arbol de Levas Deportiva',stat = {duration = 12.6,compression = 4.0, fuelpressure = -4.0, ignition = 4.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.045, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 40000},
	{category = 'pro', state = 'oem_brakes', item = 'pro_brakes', label = 'Frenos Deportivos', handling = {'fBrakeForce','fHandBrakeForce'}, add = 2.4, affects = 'Brake Power', mod = {index = 12, add = 3}, cost = 20000},
	{category = 'pro', state = 'oem_suspension', item = 'pro_suspension', label = 'Suspension Deportiva', handling = {'fSuspensionForce','fSuspensionCompDamp','fSuspensionReboundDamp','fSuspensionUpperLimit','fSuspensionLowerLimit','fSuspensionRaise','fSuspensionBiasFront','fAntiRollBarForce','fAntiRollBarBiasFront','fRollCentreHeightFront','fRollCentreHeightRear'}, add = 1.2, affects = 'Suspension', mod = {index = 15, add = 4}, cost = 50000},
	{category = 'pro', state = 'oem_gearbox', item = 'pro_gearbox', label = 'Caja de Cambio Deportiva', handling = {'nInitialDriveGears','fDriveInertia','fClutchChangeRateScaleUpShift','fClutchChangeRateScaleDownShift'}, add = 1.10, affects = 'Acceleration', mod = {index = 13, add = 1}, cost = 60000},
	-- ELITE
	{category = 'elite', state = 'engine_oil', item = 'elite_oil', label = 'Aceite Callejero', handling = {'fInitialDriveMaxFlatVel'}, add = 1.05, affects = 'Top Speed', cost = 10000},
	{category = 'elite', state = 'engine_sparkplug', item = 'elite_sparkplug', label = 'Bujias Callejeras',stat = {ignition = 2.0}, handling = {'fDriveInertia'}, add = 1.05, affects = 'Torque', cost = 10000},
	{category = 'elite', state = 'engine_gasket', item = 'elite_gasket', label = 'Juntas Callejeras', handling = {'fDriveInertia'}, add = 1.05, affects = 'Torque', cost = 10000},
	{category = 'elite', state = 'engine_airfilter', item = 'elite_airfilter', label = 'Filtro de Aire Callejero', handling = {'fInitialDriveForce'}, add = 1.05, affects = 'Horsepower', cost = 15000},
	{category = 'elite', state = 'engine_fuelinjector', item = 'elite_fuelinjector', label = 'Inyectores Callejeros', stat = {fuelpressure = 10.0}, handling = {'fInitialDriveForce'}, add = 1.05, affects = 'Horsepower', cost = 20000},
	{category = 'elite', state = 'engine_pistons', item = 'elite_pistons', label = 'Pistones Callejeros' ,stat = {compression = 2.0, fuelpressure = -2.0, ignition = 1.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.05, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 20000},
	{category = 'elite', state = 'engine_connectingrods', item = 'elite_connectingrods', label = 'Vielas Callejeras' , handling = {'fInitialDriveForce'}, add = 1.05, affects = 'Top Speed', cost = 20000},
	{category = 'elite', state = 'engine_valves', item = 'elite_valves', label = 'Valvulas de Callejeras',stat = {compression = 0.2, fuelpressure = -0.2}, handling = {'fInitialDriveForce'}, add = 1.05, affects = 'Horsepower', cost = 15000},
	{category = 'elite', state = 'engine_block', item = 'elite_block', label = 'Bloque de Motor Callejero',stat = {compression = 2.0, fuelpressure = -1.0, ignition = 1.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.05, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 25000},
	{category = 'elite', state = 'engine_crankshaft', item = 'elite_crankshaft', label = 'Ciguenal Callejero',stat = {ignition = 1.0}, handling = {'fDriveInertia'}, add = 1.05, affects = 'Torque', mod = {index = 11, add = 1}, cost = 20000},
	{category = 'elite', state = 'transmition_clutch', item = 'elite_clutch', label = 'Embrague Callejero', handling = {'fClutchChangeRateScaleUpShift'}, add = 1.02, affects = 'Down Shifting', mod = {index = 13, add = 1}, cost = 15000},
	{category = 'elite', state = 'engine_flywheel', item = 'elite_flywheel', label = 'Volante de Inercia Callejero', handling = {'fClutchChangeRateScaleDownShift'}, add = 1.05, affects = 'Up Shifting', mod = {index = 13, add = 1}, cost = 15000},
	{category = 'elite', state = 'engine_camshaft', item = 'elite_camshaft', label = 'Arbol de Levas Callejero',stat = {duration = 6.3, compression = 2.0, fuelpressure = -2.0, ignition = 2.0}, handling = {'fInitialDriveMaxFlatVel'}, add = 1.02, affects = 'Top Speed', mod = {index = 11, add = 1}, cost = 15000},
	{category = 'elite', state = 'oem_brakes', item = 'elite_brakes', label = 'Frenos Callejeros', handling = {'fBrakeForce','fHandBrakeForce'}, add = 1.4, affects = 'Brake Power', mod = {index = 12, add = 3}, cost = 10000},
	{category = 'elite', state = 'oem_suspension', item = 'elite_suspension', label = 'Suspension Callejera', handling = {'fSuspensionForce','fSuspensionCompDamp','fSuspensionReboundDamp','fSuspensionUpperLimit','fSuspensionLowerLimit','fSuspensionRaise','fSuspensionBiasFront','fAntiRollBarForce','fAntiRollBarBiasFront','fRollCentreHeightFront','fRollCentreHeightRear'}, add = 1.1, affects = 'Suspension', mod = {index = 15, add = 4}, cost = 20000},
	{category = 'elite', state = 'oem_gearbox', item = 'elite_gearbox', label = 'Caja de Cambios Callejera', handling = {'nInitialDriveGears','fDriveInertia','fClutchChangeRateScaleUpShift','fClutchChangeRateScaleDownShift'}, add = 1.05, affects = 'Acceleration', mod = {index = 13, add = 1}, cost = 25000},
}
...
config.degrade = { -- degrade value when specific mileage value is reach
	[1] = { min = 50000, degrade = 0.09},
	[2] = { min = 20000, degrade = 0.08},
	[3] = { min = 10000, degrade = 0.05},
	[4] = { min = 5000, degrade = 0.05},
	[5] = { min = 3000, degrade = 0.05},
	[6] = { min = 2000, degrade = 0.05},
	[7] = { min = 1500, degrade = 0.05},
	[8] = { min = 1000, degrade = 0.05},
	[9] = { min = 500, degrade = 0.05},
	[10] = { min = 100, degrade = 0.01},
	[11] = { min = 1, degrade = 0.00},
}

config.tires = { -- tires handling @item = item name, @degrade = degrade percent for each MS tick. 
	[1] = {label = 'Neumaticos Callejeros', item = 'street_tires', degrade = 0.0, handling = {fLowSpeedTractionLossMult = 1.1,fTractionLossMult = 1.1,fTractionCurveMin = 1.2, fTractionCurveMax = 1.0, fTractionCurveLateral = 1.25}, cost = 30000},
	[2] = {label = 'Neumaticos Deportivos', item = 'sports_tires', degrade = 0.005, handling = {fLowSpeedTractionLossMult = 0.9,fTractionLossMult = 0.9,fTractionCurveMin = 1.1, fTractionCurveMax = 1.1, fTractionCurveLateral = 1.0}, cost = 40000},
	[3] = {label = 'Neumaticos de Carrera', item = 'racing_tires', degrade = 0.005, handling = {fLowSpeedTractionLossMult = 0.65,fTractionLossMult = 0.7,fTractionCurveMin = 1.25, fTractionCurveMax = 1.35, fTractionCurveLateral = 0.7}, cost = 50000},
	[4] = {label = 'Neumaticos de Picadas', item = 'drag_tires', degrade = 0.05, handling = {fLowSpeedTractionLossMult = 0.7,fTractionLossMult = 2.1,fTractionCurveMin = 1.91, fTractionCurveMax = 0.4, fTractionCurveLateral = 1.4}, cost = 40000},
	[5] = {label = 'Neumaticos de Drift', item = 'drift_tires', degrade = 0.1, handling = {fLowSpeedTractionLossMult = 1.0,fTractionLossMult = 1.0,fTractionCurveMin = 1.0, fTractionCurveMax = 1.0, fTractionCurveLateral = 1.0}, cost = 35000},
	[6] = {label = 'Neumaticos Stock', item = 'stock_tires', degrade = 0.0, handling = {fLowSpeedTractionLossMult = 1.1,fTractionLossMult = 1.1,fTractionCurveMin = 1.2, fTractionCurveMax = 1.0, fTractionCurveLateral = 1.25}, cost = 5000},

}

config.drivetrain = {
	[1] = { label = 'FWD', item = 'frontwheeldrive', value = 1.0, cost = 100000 },
	[2] = { label = 'AWD', item = 'allwheeldrive', value = 0.5, cost = 200000 },
	[3] = { label = 'RWD', item = 'rearwheeldrive', value = 0.0, cost = 150000 }
}

config.extras = { -- do not change unless you know how vehicle flags works for this resource
	[1] = { label = 'Diferencial de deslizamiento limitado (delantero)', item = 'lsdf' ,handling = {type = 'CCarHandlingData', name = 'strAdvancedFlags', value = {0,3}}, cost = 25000},
	[2] = { label = 'Diferencial de deslizamiento limitado (trasero)', item = 'lsdr', handling = {type = 'CCarHandlingData', name = 'strAdvancedFlags', value = {1,4}}, cost = 25000},
	[3] = { label = 'Control de traccion', item = 'tcs', handling = {type = 'CCarHandlingData', name = 'strAdvancedFlags', value = {13}}, cost = 25000},
	[4] = { label = 'Control de estabilidad', item = 'esc', handling = {type = 'CCarHandlingData', name = 'strAdvancedFlags', value = {14}}, cost = 25000},
	[5] = { label = 'Engranages de relacion cerrada', item = 'closerationgears', handling = {type = 'CCarHandlingData', name = 'strAdvancedFlags', value = {21}}, cost = 25000},
	[6] = { label = 'CVT Transmision', item = 'cvttranny', handling = {type = 'CHandlingData', name = 'strHandlingFlags', value = {12}}, cost = 25000},
	[7] = { label = 'Frenos Antibloqueo', item = 'abs', handling = {type = 'CHandlingData', name = 'strModelFlags', value = {4}}, cost = 25000},
	[8] = { label = 'Torsion del eje (delantera)', item = 'axletorsionfront', handling = {type = 'CHandlingData', name = 'strModelFlags', value = {16}}, cost = 25000},
	[9] = { label = 'Torsion del eje (trasera)', item = 'axletorsionrear', handling = {type = 'CHandlingData', name = 'strModelFlags', value = {20}}, cost = 25000},
	[10] = { label = 'Eje Solido (Delantero)', item = 'axlesolidfront', handling = {type = 'CHandlingData', name = 'strModelFlags', value = {17}}, cost = 25000},
	[11] = { label = 'Eje Solido (Trasero)', item = 'axlesolidrear', handling = {type = 'CHandlingData', name = 'strModelFlags', value = {21}}, cost = 25000},
	[12] = { label = 'Sistema de recuperacion de energia cinetica', item = 'kers', handling = {type = 'CHandlingData', name = 'strHandlingFlags', value = {2}}, cost = 25000},
...
config.customItems = {
	[1] = {item = 'turbostreet', cost = 200000},
	[2] = {item = 'turbosports', cost = 250000},
	[3] = {item = 'turboracing', cost = 300000},
	[7] = {item = 'turboultimate', cost = 400000},
	[4] = {item = 'nitro50shot', cost = 25000},
	[5] = {item = 'nitro100shot', cost = 50000},
	[6] = {item = 'nitro200shot', cost = 100000},
}
