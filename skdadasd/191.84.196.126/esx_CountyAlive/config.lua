...
-- Hospital
Config.EnableHospitalBlip = false -- Enable the blip on the map
Config.EnablePlayerHealing = false -- Allow players to go and heal themselves
Config.DrawHealingGroundMarker = false -- Draw the ground marker at the healing location (if set to false, only the 3D text will appear)
...
Config.FoodVendors = {
    {
        name = 'UGI`S', -- Name of the blip if enabled
        ...
        {
            {
                label = 'Pizza', -- This will appear in the menu
                item = 'pizza_pep', -- This is the item that is added to the inventory of the player
                price = 200 -- This is obviously the price
            },
            {
                label = 'Manaos',
                item = 'cocacola',
...
Config.UseCommands = true -- If set to false, the menu will be used with all functions inside of it
...
-- Fishing
Config.EnableFishing = false -- If set to false, fishing will not be enabled

Config.EnableFishingCommand = false -- Allows you to fish from anywhere (still will use the preset fishing locations)
...
Config.RentalVehicles = {
    {
        label = 'Cuatri', -- This is what will appear on the menu
        spawnCode = 'blazer', -- This is the spawn name of the vehicle
        price = 5000 -- This is the price
    },
    {
        label = 'Motocross',
        spawnCode = 'sanchez',
...
Config.HikingRewardAmount = 5000 -- Amount of money (if enabled)
Config.HikingRewardItem = 'quini' -- Item (if enabled)

Config.HikingAlertText = 'Alguien tiene los huevos y esta al pedo para subir el monte chilliat!'