...
function OpenMechanicActions2Menu()
	local elements = {
	...
	ESX.OpenContext("right", elements, function(menu,element)
		if element.value == 'vehicle_list' then
			if Config.EnableSocietyOwnedVehicles then
				...
				local elements2 = {
					{unselectable = true, icon = "fas fa-car", title = TranslateCap('service_vehicle')},
					{icon = "fas fa-truck", title = 'Ford F450',  value = 'f450rl'},
					{icon = "fas fa-truck", title = 'Ford F550 Plataforma',  value = 'f550b'},
...
function OpenMobileMechanicActions2Menu()
	local elements = {
		{unselectable = true, icon = "fas fa-gear", title = TranslateCap('mechanic')},
...
-- Create Blips
CreateThread(function()
	local blip = AddBlipForCoord(Config.Zones.MechanicActions2.Pos.x, Config.Zones.MechanicActions2.Pos.y, Config.Zones.MechanicActions2.Pos.z)
...
RegisterCommand('mechanicMenu2', function()
		if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic2' then
			OpenMobileMechanicActions2Menu()
		end
end, false)
...
RegisterKeyMapping('mechanicMenu2', 'Open Mechanic Menu', 'keyboard', 'F6')
