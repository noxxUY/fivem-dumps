...
Config.AuthorizedVehicles = {
	car = {
		...
		officer = {
			{model = 'police2', price = 500},
			{model = 'rangerPBA', price = 1000},
			{model = 'hiluxpfa', price = 1000},
			{model = 'mpoli', price = 1500}
		},
		...
		lieutenant = {
			...
			{model = 'hiluxpfa', price = 1000},
			{model = 'metm', price = 2000},
			{model = 'policeold1', price = 2000},
			{model = 'mpoli', price = 1500}
		},

		boss = {
			{model = 'wmfenyrcop', price = 5000},
			{model = 'metm', price = 2000},
			{model = 'police2', price = 1000},
			{model = 'hiluxpfa', price = 1000},
			{model = 'policeold1', price = 2000},
