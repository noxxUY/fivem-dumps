...
Config['ShopRobbery'] = {
    ...
    ['rewardMoneys'] = {
        ['safecrack'] = function()
            return math.random(10000, 15000) -- For safecrack money reward
        end,
    ...
    ['clerkWeaponChance'] = 99, -- Chance that the clerk will get scared or pull a gun
    ['clerkWeapon'] = GetHashKey('WEAPON_COMBATPISTOL'), -- Clerk weapon
...
Config['LixeiroCharmosoMarketsSettings'] = {
	...
	require_owner_be_online = false -- true: the store can only be robbed if the owner is online | false: the store can be robbed at any time
}