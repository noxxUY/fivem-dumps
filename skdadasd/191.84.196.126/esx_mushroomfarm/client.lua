...
Citizen.CreateThread(function()
	while true do
        ...
        if ciuperci == 6 then
            perform = true
            DrawText3D(pos.x,pos.y,pos.z, "~y~Anda y vende los hongos", 1.2)
        end
        if hasjob == true then
            for i,v in pairs(coordonate) do
                ...
                if ciuperci == 1 or ciuperci == 2 or ciuperci == 3 or ciuperci == 4 or ciuperci == 5 then
                    perform = true
                    DrawText3D(pos.x,pos.y,pos.z, "Hongos ~r~"..ciuperci.."~w~/~g~6", 1.2)
                end
                if coordonate[i] ~= nil then
                    if metrii2 <=3 then
                        perform = true
                        DrawText3D(v[1],v[2],v[3]+0.7, "Agarrar hongos ~y~[E]~w~", 1.2)
                        if IsControlJustPressed(1,51) then
                            ...
                            exports['mythic_notify']:SendAlert('inform', 'Has recolectado 1 hongo.', 2500)
                    ...
                    perform = true
                    DrawText3D(coordonate[i]+0.7, "El hongo ya ha sido recolectado.", 1.2)
                end
            end
        end
        if metrii <= 3 then
            perform = true
            DrawText3D(pos.x,pos.y,pos.z+0.6, "Convertirse en un cultivador de hongos ~y~[E]~w~ para agarrar hongos ~y~[Y]~w~ para venderlos", 1.2)
            if IsControlJustPressed(1,51) then
                ...
                exports['mythic_notify']:SendAlert('inform', 'Estas contratado!', 2500)
                ...
                elseif hasjob == true then
                    exports['mythic_notify']:SendAlert('inform', 'Ya ha sido contratado como agricultor de hongos.', 2500)
                end
            elseif IsControlJustPressed(1,246) then
                ...
                DeleteEntity(cosdeoua)
                    ...
                    exports['mythic_notify']:SendAlert('inform', 'No seas tonto.', 2500)
