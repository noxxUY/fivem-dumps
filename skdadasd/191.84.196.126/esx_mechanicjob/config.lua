...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = vector3(-196.6529, -1338.7773, 34.3994 ),
	...
	Garage = {
		Pos   = vector3(-197.1579, -1318.7202, 30.5893 ),
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 50, g = 200, b = 50 },
		Type  = 21
	},
	...
	Craft = {
		Pos   = vector3( -199.3587, -1315.6542, 31.0893 ),
		Size  = { x = 1.0, y = 1.0, z = 1.0 },
		Color = { r = 50, g = 200, b = 50 },
		Type  = 21
	},
	...
	VehicleSpawnPoint = {
		Pos   = vector3(-188.4038, -1271.4863, 32.5886 ),
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = vector3(-182.1781, -1314.6873, 30.2961 ),
