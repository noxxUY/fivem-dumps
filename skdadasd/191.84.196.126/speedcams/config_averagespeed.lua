main = {
    addPercentage = 20.0, -- This allows a 10% lee-way before classing the driver as speeding, set to 0 to disable
    addLimit = 1.0, -- This allows an addition of 2MPH to the speed limit before classing the driver as speeding, set to 0 to disable
    webhook = "https://discord.com/api/webhooks/1090443006114545757/3F2xV27PYaKznzfDbl2UCIvAUBin32fKGUhUyGNqA2ubvyOTgayOD9sxuhCbdPQM9cin",
    webhookImage = "https://expertreviews.b-cdn.net/sites/expertreviews/files/styles/er_main_wide/public/2023/01/best_speed_camera_detectors_-_lead_img.jpg",
    webhookName = "Speedcam",
    detectionRadius = 30.0, -- The distance from a camera you must be to start the detection process
...
translations = {
    ...
    speedDetected = "Velocidad detectada:",
    roadName = "Ubicación:",
    name = "Nombre:",
    cameraActivation = "Activacion de camara",
    timestamp = "Tiempo:",
    numberPlate = "Matricula de vehiculo:",
}
...
config = {
    ...
    },
	{
        limit = 175.0,
        cameraOne = {
            coords = vector3(658.33563232422,-1755.543762207,36.40079498291),
            heading = 95.75,
        },
        cameraTwo = {
