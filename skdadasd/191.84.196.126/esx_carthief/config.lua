...
Config.CooldownMinutes = 20
Config.Locale = 'es'

Config.Zones = {
	VehicleSpawner = {
		Pos   = {x = -9.53, y = -1090.53, z = 25.90},
...
Config.VehicleSpawnPoint = {
      Pos   = {x = -12.47, y = -1084.75, z = 26.00, alpha = 0.00}, --alpha is the orientation of the car
      Size  = {x = 3.0, y = 3.0, z = 1.0},
      Type  = -1,
}
...
Config.Delivery = {
	...
	Delivery1 = {
		...
		Type  = 1,
		Payment  = 12000,
		Cars = {'ek9','scirocco','amarok','golfgti7','veln'},
	},
	--Lighthouse 9.61KM
	Delivery4 = {
