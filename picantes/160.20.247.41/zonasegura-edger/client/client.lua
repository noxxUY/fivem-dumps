	...
	while false do
        ...
        if notifIn then
			if notifIn and not isInZona then 
				...
				-- 	print("esta entrnaod a una zona segura con un auto")
				-- 	local passengers = {}
				...
				-- 	end
				-- end
				--exports['mythic_notify']:DoCustomHudText('success', 'Estás en una Zona Segura!', 3500)
				--exports['mythic_notify']:DoCustomHudText('info', 'INFO: No podrás colisionar con otros jugadores.', 5000)
				--TriggerServerEvent("mindiw_tools:sendPlayerToBucket", 16000, isPedInAnyVeh, passengers)
			...
			if not notifIn and isInZona then
				...
				exports['mythic_notify']:DoCustomHudText('info', 'Picante: Podrás colisionar con otros jugadores.', 5000)
