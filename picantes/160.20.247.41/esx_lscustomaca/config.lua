...
Config.Locale = 'en'
Config.IsacaJobOnly = true

Config.Zones = {

	ls1 = {
		Pos   = { x = -209.6125, y = -1377.3849, z = 31.3115},   --209.6125, -1377.3849, 31.3115, 29.8849
	...
	ls2 = {
		Pos   = { x = -205.1689, y = -1367.8182, z = 31.3559},    --205.1689, -1367.8182, 31.3559, 27.6420
		Size  = {x = 2.0, y = 2.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = { x = -195.8250, y = -1369.0922, z = 31.4040},    --195.8250, -1369.0922, 31.4040, 211.9564
