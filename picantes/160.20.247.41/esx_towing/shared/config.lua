...
Locale.press_to_attach = 'Presione para agregar'
Locale.press_to_detach = 'Desenganchar'
Locale.vehicles_locked = 'Este vehículo está bloqueado y por lo tanto no puede ser remolcado'
