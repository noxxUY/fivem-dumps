Config = {
    ...
    Text = {
        ...
        SPRAY_ERRORS = {
            NOT_FLAT = 'Tento teren neni dostatece plochy',
            TOO_FAR = 'Jsi moc daleko od zdi',
            INVALID_SURFACE = 'Tady to nemuze byt nasprejovany',
            AIM = 'Namir se sprejem na zed',
        },
        NO_SPRAY_NEARBY = 'Neni zadny graffit k odstraneni',
        NEED_SPRAY = 'Nemas zadny sprej',
        WORD_LONG = 'Nemuzes nasprejovat vice nez 9 slov',
        USAGE = 'Pouziti: /spray <slovo>',
        BLACKLISTED = 'Toto slovo je na blackliste.'
    }
}
