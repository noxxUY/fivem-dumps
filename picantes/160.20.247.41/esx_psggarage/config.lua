...
Config.CarZones = {
	psgCarGarage = {
		Pos = {
			{x = 1854.4623,  y = 3675.4421, z = 33.7249},  
			{x = -446.63,  y = 6050.51, z = 31.34}
		}
	}
}
...
Config.psgCarMarker = 27 												-- marker type
Config.psgCarMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 			-- rgba color of the marker
...
-- psg Cars:
Config.psgVehicles = {
	{ model = '', label = '-----Prosegur-----'},
	{ model = 'sheriff2', label = 'Traffic'},
	{ model = 'pranger', label = 'Amarok'},
	{ model = 'stockade', label = 'Camion'},
	{ model = 'raptortow', label = 'Raptor'}  
}

-- psg Helicopters:
Config.psgHelicopters = {
	{ model = 'polmav', label = 'Helicoptero', livery = 0, price = 0 },
	{ model = 'helipdlc', label = 'helipdlc', livery = 0, price = 0 }
}

-- psg Boats:
Config.psgBoats = {
	{ model = 'seashark2', label = 'Moto de Agua', livery = 0, price = 0 },
	{ model = 'tug', label = 'Lancha', livery = 0, price = 0 }
}

-- Commands:
Config.RepairCommand = 'polrepareer'
Config.CleanCommand = 'polwassen'

-- Menu Labels & Titles:
Config.LabelStoreVeh = "Guardar vehículo en el garaje"
Config.LabelGetVeh = "Sacar un vehículo"
Config.LabelPrimaryCol = "Primario"
Config.LabelSecondaryCol = "Secondario"
Config.LabelExtra = "Extra"
Config.LabelLivery = "Livery"
Config.TitlepsgGarage = "Garage Policial"
...
Config.HeliOutFromPolGar = "¡Helicóptero recuperado del garaje!"
Config.BoatOutFromPolGar = "You took out a ~b~Boat~s~ from ~y~psg Boat Garage~s~!"
Config.VehRepNotify = "Tu ~b~vehiculo~s~ esta siendo ~y~reparado~s~, por favor espera!"
Config.VehRepDoneNotify = "Tu ~b~vehiculo~s~ fue ~y~reparado~s~!"
Config.VehCleanNotify = "Tu ~b~vehiculo~s~ se esta ~y~limpiando~s~, por favor espera!"
Config.VehCleanDoneNotify = "Tu ~b~vehiculo~s~ fue ~y~lavado~s~!"
...
Config.VehicleLoadText = "Espera mientras sacamos tu auto"			-- text on screen when vehicle model is being loaded
