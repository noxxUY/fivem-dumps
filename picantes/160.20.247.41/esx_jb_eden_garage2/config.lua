...
Config.Price		= 0 -- pound price to get vehicle back
...
Config.Garages = {
	...
	Garage_hospital = {
		Pos = {x = -844.3015,y = -1233.1825,z = 6.9339},  
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = _U('garage_name'),
		HelpPrompt = _U('open_car_garage'),
		SpawnPoint = {
			Pos = {x = -849.7919,y = -1227.9448,z = 6.7625},  
			Heading = 160.0,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = _U('spawn_car')
		},
		DeletePoint = {
			Pos = {x =  -852.9800,y = -1225.6406,z = 6.7031}, 
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = _U('store_car')
		}, 	
	},
