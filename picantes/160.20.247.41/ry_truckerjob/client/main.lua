...
Citizen.CreateThread(function()
    ...
    while true do 
        ...
        for k,v in pairs(markers) do 
            ...
            if dist < 3 and job == 'trucker2' then
                if working then
                    ...
                    if IsControlJustReleased(0, 183) then
                        ...
                        for k,v in pairs(Config.Routes['route1']['locations']) do 
                            ...
                            TriggerEvent('ry_trucker2job:updatworking2', false)
                        end
                    ...
                    if IsControlJustReleased(0, 38) then
                        for k2,v in pairs(Config.Routes['route1']['locations']) do 
                            if Route1_active then
                                Route1 = {}                          
                                TriggerEvent('ry_trucker2job:state', false, k2)
                            end
                        end
                ...
                if Route1_active then
                    ...
                    if dist < 5 then
                        if not Route1[k].delivered and Route1[k].active and isATruck then
                            ...
                            TriggerEvent('ry_trucker2job:hasEnteredMarker', k, v.event, 'route1')
                        else
                ...
                if Route2_active then
                    ...
                    if dist < 5 then
                        if not Route2[k2].delivered and Route2[k2].active and isATruck then
                            ...
                            TriggerEvent('ry_trucker2job:hasEnteredMarker', k2, v.event, 'route2')
                        else
                ...
                if Route3_active then
                    ...
                    if dist < 5 then
                        if not Route3[k3].delivered and Route3[k3].active and isATruck then
                            ...
                            TriggerEvent('ry_trucker2job:hasEnteredMarker', k3, v.event, 'route3')
                        else
                ...
                if Route4_active then
                    ...
                    if dist < 5 then
                        if not Route4[k4].delivered and Route4[k4].active and isATruck then
                            ...
                            TriggerEvent('ry_trucker2job:hasEnteredMarker', k4, v.event, 'route4')
                        else
...
RegisterNetEvent('ry_trucker2job:hasEnteredMarker')
AddEventHandler('ry_trucker2job:hasEnteredMarker', function(zone,event,v)
...
RegisterNetEvent('ry_trucker2job:start_route')
AddEventHandler('ry_trucker2job:start_route', function(route)
...
RegisterNetEvent('ry_trucker2job:state')
AddEventHandler('ry_trucker2job:state', function(option, k)
        working = option
...
RegisterNetEvent('ry_trucker2job:statelast')
AddEventHandler('ry_trucker2job:statelast', function(option)
    for k,v in pairs(Config.Routes['route1']['locations']) do 
        Route1_active = option
        Route1 = {}
    end
...
RegisterNetEvent('ry_trucker2job:updatworking')
AddEventHandler('ry_trucker2job:updatworking', function(option)
    working = option
end)
...
Citizen.CreateThread(function()
    Wait(1000)
    while PlayerData == nil do Wait(10) end
    if PlayerData.job.name == 'trucker2' then
