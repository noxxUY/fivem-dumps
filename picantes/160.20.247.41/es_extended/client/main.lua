...
AddEventHandler("esx:tpm", function()
    ...
    if DoesBlipExist(WaypointHandle) then
        ...
        TriggerEvent('chatMessage', "Te telestransportaste nuevamente")
    else
        TriggerEvent('chatMessage', "No tienes un punto marcado")
    end
end)
...
AddEventHandler("esx:noclip", function(input)
	...
	TriggerEvent("chatMessage", "Activaste Noclip^2^*" .. msg)
	end)
