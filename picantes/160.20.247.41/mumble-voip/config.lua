...
mumbleConfig = {
	...
	voiceModes = {
		{2.5, "[Voz] Susurrar"}, -- Whisper speech distance in gta distance units
		{8.0, "[Voz] Normal"}, -- Normal speech distance in gta distance units
		{20.0, "[Voz] Gritar"}, -- Shout speech distance in gta distance units
	},
	...
	radioClickMaxChannel = 200, -- Set the max amount of radio channels that will have local radio clicks enabled
...
if IsDuplicityVersion() then
	...
	function SetMumbleProperty(key, value)
		if mumbleConfig[key] ~= nil and mumbleConfig[key] ~= "controles" and mumbleConfig[key] ~= "NombreCanales" then
