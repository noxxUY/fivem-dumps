...
Config.losnegros1Stations = {
	...
	MAFIA = {
		...
		Helicopters = {
			{
				Spawner = vector3(1453.7516, 1105.3793, 116.0711),  
				InsideShop = vector3(1459.5060, 1111.6108, 116.0711),
				SpawnPoints = {
					{coords = vector3(1459.5060, 1111.6108, 116.0711), heading = 213.72, radius = 10.0}
				}
			}
		},
...
Config.AuthorizedVehicles = {
	...
	helicopter = {
		recruit = {
			{ model = 'volatus', label = 'Helicoptero MAFIA', livery = 0, price = 1 },
		},
