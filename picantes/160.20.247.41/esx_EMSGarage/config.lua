...
Config.PoliceDatabaseName = 'ambulance'	-- set the exact name from your jobs database for police

--Police Car Garage:
Config.CarZones = {
	PoliceCarGarage = {
		Pos = {
			{x = -815.4002,  y = -1204.2063, z = 6.9341}, 
		}
	}
}
...
Config.CarGarageName = "Garage de Vittal"
...
Config.HeliGarageName = "Garage helicoptero Vittal"
...
Config.PoliceCarMarker = 36 												-- marker type
Config.PoliceCarMarkerColor = { r = 0, g = 155, b = 255, a = 100 } 			-- rgba color of the marker
...
Config.PoliceVehicles = {
		...
		{ model = 'police', label = 'SMART'},
		{ model = 'ghispo2', label = 'MASERATTI'},
		{ model = 'motobm', label = 'MOTO BMW'},
		{ model = 'rangerems', label = 'ranger'},
		{ model = 'rmodpolice', label = 'gtr'},
...
Config.PoliceHelicopters = {
	{ model = 'polmav', label = 'Vittal helicoptero', livery = 0, price = 0 }
}
...
Config.TitlePoliceGarage = "Garaje de vittal"
...
Config.CarOutFromPolGar ="¡Sacaste un Vehículo de Garage de vittal!"
Config.HeliOutFromPolGar = "¡Sacaste un helicóptero de Vittal Helicoptero Garage!"
Config.BoatOutFromPolGar = "¡Sacaste un Barco de Garage de barcos de vittal!"
