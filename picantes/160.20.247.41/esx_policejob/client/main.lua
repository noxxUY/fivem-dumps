...
function OpenCloakroomMenu()
	...
	--	{label = _U('moto_wear'), uniform = 'moto_wear'},
		{label = _U('police_wear2'), uniform = 'police_wear2'},
		{label = _U('police_wear5'), uniform = 'police_wear5'},
		{label = _U('police_wear'), uniform = 'police_wear'},
	--	{label = _U('helmet_wear'), uniform = 'helmet_wear'},
		{label = _U('police_wear3'), uniform = 'police_wear3'},
		{label = _U('police_wear4'), uniform = 'police_wear4'},
