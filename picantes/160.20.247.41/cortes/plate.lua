--- IMAGE CONFIG HERE ---
imageUrl = "https://cdn.discordapp.com/attachments/940760486327234584/947773955278790666/patente3.jpg" -- Paste your image URL here (doesn't have to be from imgur)
...
local object = CreateDui('https://cdn.discordapp.com/attachments/940760486327234584/947773955278790666/patente3.jpg', 540, 300) -- this URL doesn't need to be edited, its just the 2d model for the plate -- Load image into object
local handle = GetDuiHandle(object) -- Gets DUI handle from object
