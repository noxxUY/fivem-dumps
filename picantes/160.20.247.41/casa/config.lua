...
Config.nameJobLabel               = "Municipalidad"
...
Config.Zones        = {
	...
	Cloakroom         = {
		Pos        = { x = 678.8228, y = 72.48474, z = 82.2 },
		Size       = { x = 1.5, y = 1.5, z = 0.3 },
		Color      = { r = 14, g = 190, b = 12 },
		Type       = 23,
		BlipSprite = 354,
		BlipColor  = 46,
		BlipName   = Config.nameJobLabel .. ": Comienza la jornada",
		hint       = '¡Presiona ~INPUT_CONTEXT~ para acceder a la taquilla!',
	},
	
	VehicleSpawner    = {
		Pos      = { x = 679.2162, y = 75.09472, z = 82.2 },
		Size     = { x = 1.5, y = 1.5, z = 0.3 },
		Color    = { r = 14, g = 190, b = 12 },
		Type     = 23,
	...
	VehicleSpawnPoint = {
		Pos     = { x = 610.5262, y = 85.24476, z = 91.96 },
	...
	VehicleDeleter    = {
		Pos     = { x = 701.7629, y =  39.16125, z = 83.17 },
		Size    = { x = 3.0, y = 3.0, z = 1.0 },
		Color    = { r = 255, g = 0, b = 0 },
		Type     = 23,
		BlipName = Config.nameJobLabel .. ": Devolver vehículo",
		hint     = '¡Presiona ~INPUT_CONTEXT~ para regresar el vehículo!',
	},
	
	Vente             = {
		Pos               = { x = 689.8547, y = 73.24335, z = 82.81522 },
		Size              = { x = 1.2, y = 1.2, z = 0.3 },
		Color             = { r = 14, g = 190, b = 12 },
		Type              = 23,
		BlipName          = Config.nameJobLabel .. ": Cobrá tus facturas",
		BlipSprite        = 500,
		BlipColor         = 25,
		...
		ItemDrop          = 100,
		ItemPrice         = 9500,
		hint              = 'Presiona ~INPUT_CONTEXT~ para cobrar tus facturas.',
	},
