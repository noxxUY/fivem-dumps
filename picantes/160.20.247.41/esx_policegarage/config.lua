...
Config.PoliceVehicles = {
	{ model = '', label = '-----PFA-----'},
	{ model = 'policegol', label = 'Volkswagen Gol'},
	{ model = 'tiguanpba', label = 'Volkswagen Tiguan'},
	{ model = 'lguard', label = 'Toyota Hilux'}, 
	{ model = 'fbi2', label = 'Ford Raptor'},			
	{ model = 'policeb', label = 'Patrulla Moto'},
	{ model = 'gurkharb', label = 'Camion De S.W.A.T'},
	{ model = 'pdlc', label = 'Lexus'},
	{ model = 'pdlc1', label = 'Toyota prius'},
	{ model = 'pdlc2', label = 'Amarok'},
	{ model = 'pdlc3', label = 'alamo'},
	{ model = 'pdlc4', label = 'Impala'},
	{ model = 'sprinterpdlc', label = 'sprinter'}
...
Config.TitlePoliceGarage = "Garage Policial"
