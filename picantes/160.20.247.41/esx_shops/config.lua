...
--
 ...
 --       },
   ...
   --     },
        ...
        [14] = {
            ["shelfs"] = {
                {["x"] = 307.55, ["y"] = 355.85, ["z"] = 105.39, ["value"] = "repuestos"},
                {["x"] = 306.56, ["y"] = 352.75, ["z"] = 105.39, ["value"] = "checkout"},
            },
            ["blip"] = {
                ["x"] = 307.55, ["y"] = 355.85, ["z"] = 105.39,
            },
            ["cashier"] = {
                ["x"] = 307.66, ["y"] = 355.9, ["z"] = 104.39, ["h"] = 72.62
            },
            ["cashier"] = {
                ["x"] = 306.73, ["y"] = 354.12, ["z"] = 104.39, ["h"] = 170.34
            },
        },
    },
    ...
    Items = {
        ["drinks"] = {
            --{label = "Agua", item = "water", price = 150},
            {label = "cocacola", item = "cocacola", price = 115},
            {label = "Sprite", item = "sprite", price = 150},
            
        },
        ["snacks"] = {
            {label = "Sanguche", item = "sandwich", price = 175},
            {label = "doritos", item = "doritos", price = 155},
            {label = "taco", item = "taco", price = 130},
        },
        ["readymeal"] = {
            {label = "Hamburguesa", item = "hamburger", price = 200},
            --{label = "Lays", item = "chips", price = 220},
        },
        ["repuestos"] = {
            {label = "Turbo Gol", item = "turbo_lvl_1", price = 40000},
            {label = "Turbo Bora", item = "turbo_lvl_2", price = 50000},
            {label = "Turbo Vento", item = "turbo_lvl_3", price = 56000},
            {label = "Turbo S50", item = "turbo_lvl_4", price = 64000},
            {label = "Turbo S60", item = "turbo_lvl_5", price = 70000},
            {label = "Turbo S70", item = "turbo_lvl_6", price = 100000},
            {label = "Turbo TopFuell", item = "turbo_lvl_7", price = 120000},
            {label = "Suspenciones", item = "race_suspension", price = 20000},
            {label = "Cubiertas Michelin", item = "michelin_tires", price = 25000},
            {label = "Cubiertas Blck", item = "michelin_tires2", price = 50000},
            {label = "Aceite Oil", item = "stock_oil", price = 2500},
            {label = "Aceite Shell", item = "shell_oil", price = 5000},
            {label = "Motor V8", item = "v8engine", price = 150000},
            {label = "Motor 2JZ", item = "2jzengine", price = 190000},
            {label = "Frenos Deportivos", item = "race_brakes", price = 40000},
            {label = "Frenos Competicion", item = "race_brakes2", price = 60000},
            {label = "Bujias NGK", item = "ngk_sparkplugs", price = 5000},
            {label = "Tapa 50HP", item = "stock_tapa2", price = 20000},
            {label = "Tapa 100HP", item = "stock_tapa3", price = 50000},
            {label = "Tapa 125HP", item = "stock_tapa4", price = 60000},
            {label = "Leva 15HP", item = "stock_leva2", price = 20000},
            {label = "Leva 50HP", item = "stock_leva3", price = 30000},
            {label = "Leva 100HP", item = "stock_leva4", price = 50000},
            {label = "Bobina Red", item = "stock_bobina2", price = 20000},
            {label = "Bobina FuellTech", item = "stock_bobina3", price = 40000},
            {label = "Bobina AEM", item = "stock_bobina4", price = 50000},
            {label = "Embreague 250HP", item = "stock_embreague2", price = 50000},
            {label = "Embreague 450HP", item = "stock_embreague3", price = 65000},
            {label = "FuellTech 400", item = "stock_fulltech2", price = 60000},
            {label = "FuellTech 550", item = "stock_fulltech3", price = 90000},
            {label = "FuellTech 600", item = "stock_fulltech4", price = 110000},
            {label = "Piston Lapel 15HP", item = "stock_piston2", price = 15000},
            {label = "Piston Lapel 30HP", item = "stock_piston3", price = 20000},
            {label = "Piston Lapel 50HP", item = "stock_piston4", price = 25000},
            {label = "Piston Forjado", item = "stock_piston5", price = 40000},
            {label = "Inyectores Deportivos", item = "stock_inyectores2", price = 20000},
            {label = "Inyectores Competicion", item = "stock_inyectores3", price = 40000},
        },
        ["diverse"] = {
            {label = "Celular", item = "phone", price = 250}, 
            {label = "08", item = "contract", price = 1400},
