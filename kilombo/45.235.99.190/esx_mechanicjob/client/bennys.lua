...
local function OpenMechanicActionsMenu()
	...
	ESX.OpenContext("right", elements, function(menu,element)
			...
			if Config.EnableSocietyOwnedVehicles then
				...
				ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(vehicles)
					...
					ESX.OpenContext("right", elements2, function(menu2,element2)
						...
						ESX.Game.SpawnVehicle(vehicleProps.model, Config.Zones_Mechanic.VehicleSpawnPoint.Pos, 270.0, function(vehicle)
				...
				ESX.OpenContext("right", elements2, function(menu2,element2)
					if Config.MaxInService == -1 then
						ESX.CloseContext()
						ESX.Game.SpawnVehicle(element2.value, Config.Zones_Mechanic.VehicleSpawnPoint.Pos, 90.0, function(vehicle)
							local playerPed = PlayerPedId()
							TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
						end)
					else
		...
		elseif element.value == 'boss_actions' then
			ESX.CloseContext()
			TriggerEvent('esx_society:openBossMenu', 'mechanic')
		end
	end, function(menu)
							...
							if vehicle ~= targetVehicle then
								...
								if NPCOnJob then
									if NPCTargetTowable == targetVehicle then
										...
										Config.Zones_Mechanic.VehicleDelivery.Type = 1
										...
										Blips['NPCDelivery'] = AddBlipForCoord(Config.Zones_Mechanic.VehicleDelivery.Pos.x, Config.Zones_Mechanic.VehicleDelivery.Pos.y, Config.Zones_Mechanic.VehicleDelivery.Pos.z)
...
-- Create Blips
CreateThread(function()
	local blip = AddBlipForCoord(Config.Zones_Mechanic.MechanicActions.Pos.x, Config.Zones_Mechanic.MechanicActions.Pos.y, Config.Zones_Mechanic.MechanicActions.Pos.z)
...
CreateThread(function()
	while true do
		...
		if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic' then
			...
			for k,v in pairs(Config.Zones_Mechanic) do
...
RegisterKeyMapping('mechanicMenu', 'Mecánico - Menu General', 'keyboard', 'F6')
