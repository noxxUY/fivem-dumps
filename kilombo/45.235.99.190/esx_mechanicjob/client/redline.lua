...
local function OpenMechanicActionsMenu()
	...
	ESX.OpenContext("right", elements, function(menu,element)
			...
			if Config.EnableSocietyOwnedVehicles then
				...
				ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(vehicles)
					...
					ESX.OpenContext("right", elements2, function(menu2,element2)
						...
						ESX.Game.SpawnVehicle(vehicleProps.model, Config.Zones_Mechanic3.VehicleSpawnPoint.Pos, 74.122299194336, function(vehicle)
				...
				ESX.OpenContext("right", elements2, function(menu2,element2)
					if Config.MaxInService == -1 then
						ESX.CloseContext()
						ESX.Game.SpawnVehicle(element2.value, Config.Zones_Mechanic3.VehicleSpawnPoint.Pos, 90.0, function(vehicle)
							local playerPed = PlayerPedId()
							TaskWarpPedIntoVehicle(playerPed, vehicle, -1)
						end)
					else
		...
		elseif Config.OxInventory and (element.value == 'put_stock' or element.value == 'get_stock') then
			exports.ox_inventory:openInventory('stash', 'society_mechanic3')
		...
		elseif element.value == 'boss_actions' then
			ESX.CloseContext()
			TriggerEvent('esx_society:openBossMenu', 'mechanic3')
		end
	end, function(menu)
	...
	if Config.EnablePlayerManagement and ESX.PlayerData.job and ESX.PlayerData.job.grade_name ~= 'recrue' then
		...
		ESX.OpenContext("right", elements, function(menu,element)
			if element.value == 'gaz_bottle' then
				TriggerServerEvent('esx_mechanicjob3:startHarvest')
			elseif element.value == 'fix_tool' then
				TriggerServerEvent('esx_mechanicjob3:startHarvest2')
			elseif element.value == 'caro_tool' then
				TriggerServerEvent('esx_mechanicjob3:startHarvest3')
			end
		end, function(menu)
	...
	if Config.EnablePlayerManagement and ESX.PlayerData.job and ESX.PlayerData.job.grade_name ~= 'recrue' then
		...
		ESX.OpenContext("right", elements, function(menu,element)
			if element.value == 'blow_pipe' then
				TriggerServerEvent('esx_mechanicjob3:startCraft')
			elseif element.value == 'fix_kit' then
				TriggerServerEvent('esx_mechanicjob3:startCraft2')
			elseif element.value == 'caro_kit' then
				TriggerServerEvent('esx_mechanicjob3:startCraft3')
			end
		end, function(menu)
			...
			ESX.OpenContext("right", elements2, function(menu2,element2)
				...
				if amount == nil or amount < 0 then
					...
					if closestPlayer == -1 or closestDistance > 3.0 then
						...
						ESX.CloseContext()
						TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_mechanic3', _U('mechanic'), amount)
					end
				end
			end)
							...
							if vehicle ~= targetVehicle then
								...
								if NPCOnJob then
									if NPCTargetTowable == targetVehicle then
										...
										Config.Zones_Mechanic3.VehicleDelivery.Type = 1
										...
										Blips['NPCDelivery'] = AddBlipForCoord(Config.Zones_Mechanic3.VehicleDelivery.Pos.x, Config.Zones_Mechanic3.VehicleDelivery.Pos.y, Config.Zones_Mechanic3.VehicleDelivery.Pos.z)
					...
					if NPCOnJob then
						if NPCTargetDeleterZone then
							...
							if CurrentlyTowedVehicle == NPCTargetTowable then
								...
								TriggerServerEvent('esx_mechanicjob3:onNPCJobMissionCompleted')
								StopNPCJob()
...
local function OpenGetStocksMenu()
	ESX.TriggerServerCallback('esx_mechanicjob3:getStockItems', function(items)
		local elements = {
		...
		ESX.OpenContext("right", elements, function(menu,element)
			...
			ESX.OpenContext("right", elements2, function(menu2,element2)
				...
				if count == nil then
					...
					ESX.CloseContext()
					TriggerServerEvent('esx_mechanicjob3:getStockItem', itemName, count)
...
local function OpenPutStocksMenu()
	ESX.TriggerServerCallback('esx_mechanicjob3:getPlayerInventory', function(inventory)
		local elements = {
		...
		ESX.OpenContext("right", elements, function(menu,element)
			...
			ESX.OpenContext("right", elements2, function(menu2,element2)
				...
				if count == nil then
					...
					ESX.CloseContext()
					TriggerServerEvent('esx_mechanicjob3:putStockItems', itemName, count)
...
RegisterNetEvent('esx_mechanicjob3:onHijack')
AddEventHandler('esx_mechanicjob3:onHijack', function()
	local playerPed = PlayerPedId()
	local coords = GetEntityCoords(playerPed)
...
RegisterNetEvent('esx_mechanicjob3:onCarokit')
AddEventHandler('esx_mechanicjob3:onCarokit', function()
	local playerPed = PlayerPedId()
	local coords = GetEntityCoords(playerPed)
...
RegisterNetEvent('esx_mechanicjob3:onFixkit')
AddEventHandler('esx_mechanicjob3:onFixkit', function()
	local playerPed = PlayerPedId()
	local coords = GetEntityCoords(playerPed)
...
AddEventHandler('esx_mechanicjob3:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_mechanicjob3:hasExitedMarker', function(zone)
	if zone =='VehicleDelivery' then
		NPCTargetDeleterZone = false
	elseif zone == 'Craft' then
		TriggerServerEvent('esx_mechanicjob3:stopCraft')
		TriggerServerEvent('esx_mechanicjob3:stopCraft2')
		TriggerServerEvent('esx_mechanicjob3:stopCraft3')
	elseif zone == 'Garage' then
		TriggerServerEvent('esx_mechanicjob3:stopHarvest')
		TriggerServerEvent('esx_mechanicjob3:stopHarvest2')
		TriggerServerEvent('esx_mechanicjob3:stopHarvest3')
	end
...
AddEventHandler('esx_mechanicjob3:hasEnteredEntityZone', function(entity)
	local playerPed = PlayerPedId()

	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic3' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('esx_mechanicjob3:hasExitedEntityZone', function(entity)
...
-- Create Blips
CreateThread(function()
	local blip = AddBlipForCoord(Config.Zones_Mechanic3.MechanicActions.Pos.x, Config.Zones_Mechanic3.MechanicActions.Pos.y, Config.Zones_Mechanic3.MechanicActions.Pos.z)
...
CreateThread(function()
	while true do
		...
		if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic3' then
			...
			for k,v in pairs(Config.Zones_Mechanic3) do
	...
	while true do
		...
		if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic3' then
			...
			if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
				...
				TriggerEvent('esx_mechanicjob3:hasEnteredMarker', currentZone)
			end

			if not isInMarker and HasAlreadyEnteredMarker then
				HasAlreadyEnteredMarker = false
				TriggerEvent('esx_mechanicjob3:hasExitedMarker', LastZone)
			end
		end
	Wait(Sleep)
	end
	...
	while true do
		...
		if closestDistance ~= -1 and closestDistance <= 3.0 then
			if LastEntity ~= closestEntity then
				TriggerEvent('esx_mechanicjob3:hasEnteredEntityZone', closestEntity)
				LastEntity = closestEntity
			end
		else
			if LastEntity then
				TriggerEvent('esx_mechanicjob3:hasExitedEntityZone', LastEntity)
				LastEntity = nil
			end
		end
	end
...
CreateThread(function()
	...
	local sleep = 500
		if CurrentAction then
			sleep = 0
			if IsControlJustReleased(0, 38) and ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic3' then
			...
			if Config.EnableSocietyOwnedVehicles then
				...
				TriggerServerEvent('esx_society:putVehicleInGarage', 'mechanic3', vehicleProps)
			else
...
RegisterCommand('mechanicMenuRL', function()
		if ESX.PlayerData.job and ESX.PlayerData.job.name == 'mechanic3' then
...
RegisterKeyMapping('mechanicMenuRL', 'Mecánico - Menu General', 'keyboard', 'F6')
