Locales['es'] = {
  ...
  ['installed'] = 'Instalado',
  ['already_own'] = 'Ya tenés: %s~',
  ['not_enough_money'] = '¡No tenés suficiente dinero!',
  ['purchased'] = 'Le instalaste <span style="color:red;">%s</span> al vehículo',
  ['press_custom'] = 'Pulsa ~b~[E]~s~ para personalizar el vehiculo.',
  ['level'] = 'Nivel %s',
  ['neon'] = 'Neón',
...
-- Upgrades
  ['upgrades'] = '<i class="fa-solid fa-gauge fa-bounce"></i> Mejoras',
  ['engine'] = 'motor',
  ['brakes'] = 'frenos',
  ...
  ['no_turbo'] = 'no turbo',
-- Cosmetics
  ['cosmetics'] = '<i class="fa-solid fa-gear fa-spin"></i> Cosméticos',
  -- Body Parts
