...
Radio.Labels = {        
    { "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " para esconder.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ para ~g~encender~s~.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ o ~" .. radioConfig.Controls.Increase.Name .. "~ para cambiar de frecuencia~n~~" .. radioConfig.Controls.Input.Name .. "~ para elegir frecuencia~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ para ~a~ sonidos de radio~n~Frecuencia: ~1~ MHz" },
    { "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " para esconder.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ para ~r~apagar~s~.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ para ~y~hablar~w~.~n~Frecuencia: ~1~ MHz" },
    { "FRZL_RADIO_INPUT", "¿A cual frecuencia te queres conectar?" },
}
...
Radio.Commands = {
	{
		...
		Help = "Abrir menu de radio", -- Command help shown in chatbox when typing the command
		Params = {},
...
Citizen.CreateThread(function()
	...
	while true do
		...
		local disparando = IsPedShooting(playerPed)


        if disparando and isBroadcasting then
        ...
        if not disparando and not isBroadcasting then
            dispara = false
        end
		...
		if Radio.Open then
			...
			if radioConfig.AllowRadioWhenClosed then
				if Radio.Has and Radio.On and isBroadcasting and not isPlayingBroadcastAnim and dispara == false then
