-- copy coords command
RegisterCommand('coordenadas', function(source, args, rawCommand)
...
RegisterCommand('coordenadas2', function(source, args, rawCommand)
	local coords = GetEntityCoords(PlayerPedId())
	local heading = GetEntityHeading(PlayerPedId())
...
RegisterCommand('coordenadas3', function(source, args, rawCommand)
	local coords = GetEntityCoords(PlayerPedId())
	local heading = GetEntityHeading(PlayerPedId())
	local x = roundDecimals(coords.x, 2)
	local y = roundDecimals(coords.y, 2)
