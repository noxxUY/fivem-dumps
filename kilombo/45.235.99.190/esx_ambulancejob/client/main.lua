    ...
    if Config.SaveDeathStatus then
      ...
      ESX.TriggerServerCallback('esx_ambulancejob:getDeathStatus', function(isDead)
        if isDead and Config.AntiCombatLog then
          ...
          exports['okokNotify']:Alert("SERVIDOR", _U("combatlog_message"), 3500, 'info')
...
AddEventHandler('esx_ambulancejob:clsearch', function(medicId)
  ...
  if isDead then
    ...
    local playersInArea = ESX.Game.GetPlayersInArea(coords, 25.0)
...
function SendDistressSignal()
  ...
  TriggerServerEvent('gcPhone:sendMessage', 'ambulance', _U('distress_message', coords.x, coords.y))
end
