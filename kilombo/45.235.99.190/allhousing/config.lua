Config = {
  ...
  WaitToRenderTime  = 4000, -- time to sleep between distance checks (if WaitToRender is true)
...
PesoMaximo = 700000, -- PESO EN GRAMOS
SlotsMaximo = 150, -- Slots que tiene el inventario

  -- LOGS

CrearCasas = "https://discord.com/api/webhooks/1078770706692714527/-Z_SXxxcbqvsI2FeYREEXmH5zAfeQrR4jGhG8KbkOB168hyAmVQY_WEdVamFAyihyzaA",
