...
OpenInventory = function()
  if Config.UsingESX then
    if not Config.UsingDiscInventory then
      exports.ox_inventory:openInventory('stash', 'casa-'..InsideHouse.Id..'-stash')
...
KnockOnDoor = function(d)  
  ...
  while IsEntityPlayingAnim(plyPed, "timetable@jimmy@doorknock@", "knockdoor_idle", 3) do Citizen.Wait(100); end 
