...
Config.MaxStops	= 20 -- Total number of stops a person is allowed to do before having to return to depot.
...
Config.BagPay = 350 -- The amount paid to each person per bag
Config.StopPay = 6000 -- Total pay for the stop before bagpay.
