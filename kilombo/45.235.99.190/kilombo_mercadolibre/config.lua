...
Config.Base = {
	...
	-- Van mark
	van     = {x = -323.17, y = -1030.63, z = 29.53},
	-- Return vehicle mark
...
-- Locales
Config.Locales = {
	["delivery_not_available"]    = "Este modelo no está disponible, por favor usá otro.",
	["start_delivery"]            = "Pulsá ~INPUT_CONTEXT~ para trabajar, necesitas dejar un depósito de $",
	["safe_deposit_received"]     = "El depósito seguro fué retirado de tu cuenta bancaria, cuando termines el trabajo se te devuelve.",
	["safe_deposit_returned"]     = "El depósito seguro fué acreditado en tu cuenta nuevamente.",
	["safe_deposit_withheld"]     = "La entrega ha fracasado, tu depósito de seguridad fué confiscado.",
	["delivery_point_reward"]     = "Entrega completada, recibiste $",
	["get_back_in_vehicle"]       = "Subí al vehículo",
	["remove_goods"]              = "Pulsá ~INPUT_CONTEXT~ para agarrar los paquetes",
	["remove_goods_subtext"]      = "Bajá del coche y agarrá los paquetes del maletero.",
	["drive_next_point"]          = "Manejá hasta la siguiente entrega",
	["deliver_inside_shop"]       = "Llevá los paquetes al punto de entrega",
	["get_back_to_deliveryhub"]   = "Volvé al centro de entrega y devolvé el coche para cobrar tu seguro.",
	["delivery_vehicle_returned"] = "Devolviste el vehículo que te prestamos, te reembolsaremos el seguro.",
	["finish_job"]                = "Entregas actuales: ",
	["end_delivery"]              = "Pulsá ~INPUT_CONTEXT~ para finalizar.",
	["blip_name"]                 = "Mercado Libre",
	["dst_blip"]                  = "Mercado Libre",
	["delivery_end"]              = "Finalizar entregas",
	["delivery_failed"]           = "Tu depósito seguro fué confiscado porque se te rompió o se te pierde el coche prestado.",
	["delivery_finish"]           = "Terminaste todas las entregas, felicidades.",
	["delivery_start"]            = "Mercado Libre",
	["delivery_tips"]             = "Manejá hasta el destino y entregá los paquetes",
	["not_enough_money"]          = "No tenés suficiente dinero en el banco para pagar el depósito seguro",
}
