...
function OpenArmoryMenu(station)
	...
	if Config.OxInventory then
		exports.ox_inventory:openInventory('stash', {id = 'society_gna', owner = station})
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'boton_panico', {
				...
				if action then
					if action == 'boton_leve' then
						TriggerServerEvent('gna_panico:server:PanicLeve', player, street1)
						TriggerServerEvent('gna_panico:server:BlipLeve', plyPos.x, plyPos.y, plyPos.z)
                    elseif action == 'boton_importante' then
                        TriggerServerEvent('gna_panico:server:PanicImportante', player, street1)
						TriggerServerEvent('gna_panico:server:BlipImportante', plyPos.x, plyPos.y, plyPos.z)
	...
	ESX.TriggerServerCallback('esx_gnajob:getFineList', function(fines)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine_category', {
			...
			if Config.EnablePlayerManagement then
				TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_gna', _U('fine_total', data.current.fineLabel), data.current.amount)
			else
...
function OpenGetStocksMenu()
	ESX.TriggerServerCallback('esx_gnajob:getStockItems', function(items)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count', {
				...
				if not count then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_gnajob:getStockItem', itemName, count)
...
function OpenPutStocksMenu()
	ESX.TriggerServerCallback('esx_gnajob:getPlayerInventory', function(inventory)
		local elements = {}
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'stocks_menu', {
			...
			ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count', {
				...
				if not count then
					...
					menu2.close()
					menu.close()
					TriggerServerEvent('esx_gnajob:putStockItems', itemName, count)
...
ESX.RegisterInput("gna:interact", "GNA - Interactuar", "keyboard", "E", function()
	if not CurrentAction then 
		return 
	end

	if not ESX.PlayerData.job or (ESX.PlayerData.job and not ESX.PlayerData.job.name == 'gna') then
		return
	end
	...
	elseif CurrentAction == 'menu_boss_actions' then
		ESX.UI.Menu.CloseAll()
		TriggerEvent('esx_society:openBossMenu', 'gna', function(data, menu)
			menu.close()
...
ESX.RegisterInput("gna:quickactions", "GNA - Menu General", "keyboard", "F6", function()
	if not ESX.PlayerData.job or (ESX.PlayerData.job.name ~= 'gna') or isDead then
		return
	end
...
if ESX.PlayerLoaded and ESX.PlayerData.job == 'gna' then
