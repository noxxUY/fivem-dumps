...
RegisterCommand('skinarmas',function()
	local vip = exports['hr-redeem']:isVIP() -- isVIP() returns TRUE or FALSE
	if vip then
		...
		exports['okokNotify']:Alert("SERVIDOR", "Tenés que ser VIP para usar este comando. Podes adquirirlo en nuestro discord: discord.gg/kilombo", 5000, 'error')
	end
end)
