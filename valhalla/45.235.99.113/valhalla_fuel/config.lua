...
Config.RefillCost                = 20000 -- If it is missing half of it capacity, this amount will be divided in half, and so on.
...
Config.Strings                   = {
	JerryCanEmpty         = "¡Bidón de Nafta vacio!",
	PurchaseJerryCan      = "Presiona ~b~E ~w~para comprar un bidón de Nafta por ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump     = "¡Presiona ~b~E ~w~para cancelar la carga de Nafta!",
	CancelFuelingJerryCan = "¡Presiona ~b~E ~w~para cancelar la carga de Nafta en el bidón!",
	NotEnoughCash         = "¡No tienes suficiente dinero!",
	RefillJerryCan        = "Presiona ~b~E ~w~ para recargar el bidón de Nafta | Precio: ~g~$",
	NotEnoughCashJerryCan = "¡No tienes suficiente dinero!",
	JerryCanFull          = "¡El bidón llego a su limite!",
	TotalCost             = "Precio",
}
