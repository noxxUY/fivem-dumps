Config = {}
Config.Webhook = 'https://discord.com/api/webhooks/1100259864086859916/XkAi-2Au8QXgTfc3vJEuRy2szwLg-3EteUmogJNRd5_vVUWy2Kqn8PA3rUDPRjlGW5xT'
Config.Locale = 'en'
...
Config.Blips = {
    ...
    ['air'] = {
        Garage = {
            Name = 'Garaje de Aviones',
            Type = 357,
            Size = 0.5,
            Color = 17
        },
        Impound = {
            Name = 'Incautado Aviones',
            Type = 357,
            Size = 0.5,
            Color = 3
        },
    ...
    ['boat'] = {
        Garage = {
            Name = 'Garaje de Barcos',
            Type = 357,
            Size = 0.5,
            Color = 17
        },
        Impound = {
            Name = 'Barcos Incautado',
            Type = 357,
            Size = 0.5,
            Color = 3
        },
...
Config.Impounds = {
    ...
    },
    {
        Visible = true, --Blip visible on map.
        Type = 'car',
        Position = vector3(1725.6, 3712.8, 34.2),
        SpawnPosition = vector4(1725.6, 3712.8, 34.2, 228.1345) --vector4(x, y, z, heading)
    },
    {
        Visible = true, --Blip visible on map.
        Type = 'air',
