...
Config.MiddleClickToUse = false -- uses item when middle click is pressed over an item
...
Config.WebhookURL = "https://discord.com/api/webhooks/1105576155760824390/3bC4q9qe9yAwZ77TJxnsyqGaTbSbakzl5I1NoPcn8nrxU2UNbNJ8idgH6m0UtNwt6Q33" -- discord webhook url
...
Config.HotbarSave = false -- saves to database
...
Config.BlacklistedItems = {"bread", "water", ""} -- will not allow the robber to remove items that are put in this array
...
-- Trunk
Config.TrunkKey = "F7" -- default trunk open key (users can change in their settings) | FiveM Keys
