...
Config.Base                     = {
	-- Blip coords
	coords  = { x = -19.81, y = -2545.84, z = 7.39 },
	-- Scooter mark
	scooter = { x = -319.17, y = -1032.14, z = 30.53 },
	-- Van mark
	van     = { x = -323.17, y = -1030.63, z = 30.53 },
	-- Truck mark
	truck   = { x = -19.81, y = -2545.84, z = 7.39 },
	-- Return vehicle mark
	retveh  = { x = -41.76, y = -2528.51, z = 6.01 },
	-- Delete vehicle mark
	deleter = { x = -38.08, y = -2523.07, z = 6.01 },
	-- Heading
	heading = 245.0,
}
...
Config.ParkingSpawns            = {
	{ x = -29.47, y = -2548.01, z = 6.01, h = 235.00 },
	{ x = -18.7, y = -2532.72, z = 6.01, h = 335.00 },
}
