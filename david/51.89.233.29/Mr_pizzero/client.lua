...
local blips = {
  {title="Pizzeria Pochito", colour=51, id=103, x = -1285.73, y = -1387.15, z = 3.44}, --Configuration du point sur la carte
}
  ...
  while true do
    ...
    if isInJobPizz == false then
      ...
      if GetDistanceBetweenCoords(pizzeria.x, pizzeria.y, pizzeria.z, GetEntityCoords(GetPlayerPed(-1),true)) < 1.5 then
        HelpText("Pulsa ~INPUT_CONTEXT~ para iniciar la entrega de ~r~pizzas",0,1,0.5,0.8,0.6,255,255,255,255)
    ...
    if isToHouse == true then
      ...
      while notif == true do
        ...
        TriggerEvent("pk_notifications:PkSendNotification", {
          text = "Local : " ..destinol.. " para entregar la pizza",
          type = "info",
          queue = "global",
          timeout = 4000,
          layout = "bottomRight"
    ...
    if isToPizzaria == true then
      ...
      while notif2 == true do
        ...
        TriggerEvent("pk_notifications:PkSendNotification", {
          text = "¡Vuelve a la pizzería! para conseguir más pizzas",
          type = "info",
          queue = "global",
          timeout = 4000,
          layout = "bottomRight"
      ...
      if GetDistanceBetweenCoords(pizzeria.x,pizzeria.y,pizzeria.z, GetEntityCoords(GetPlayerPed(-1),true)) < 3 and afaitunepizzamin == true then
        HelpText("Pulsa ~INPUT_CONTEXT~ para conseguir las pizzas",0,1,0.5,0.8,0.6,255,255,255,255)
  ...
  while true do
    ...
    if isInJobPizz == true then
      ...
      if GetDistanceBetweenCoords(pizzeriafin.x, pizzeriafin.y, pizzeriafin.z, GetEntityCoords(GetPlayerPed(-1),true)) < 1.5 then
        HelpText("Pulsa ~INPUT_CONTEXT~ para parar de entregar ~r~pizzas",0,1,0.5,0.8,0.6,255,255,255,255)
