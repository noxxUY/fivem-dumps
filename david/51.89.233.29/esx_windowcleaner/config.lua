...
Config.Zones = {
  ...
  Cloakroom = {
	...
	BlipSprite = 384,
	BlipColor = 1,
	BlipName = Config.nameJobLabel.." : Vestidor",
	hint = 'Pulsa ~INPUT_CONTEXT~ para acceder al vestidor',
  },
  ...
  VehicleSpawner = {
	...
	hint = 'Pulsa ~INPUT_CONTEXT~ para acceder al garaje',
  },
  ...
  VehicleDeleter = {
	Pos   = {x = -236.99, y = -1386.63, z = 30.26},
	Size  = {x = 3.0, y = 3.0, z = 0.9},
	Color = {r = 255, g = 5, b = 5},
	Type  = 27,
	BlipSprite = 384,
	...
	hint = 'Pulsa ~INPUT_CONTEXT~ para guardar el vehículo de trabajo',
  },
  ...
  Vente = {
	...
	ItemDrop = 100,
	ItemPrice  = 100,
	hint = 'Pulsa ~INPUT_CONTEXT~ para entregar los tickets y cobrar',
  },
