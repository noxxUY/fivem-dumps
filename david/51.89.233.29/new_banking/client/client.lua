...
local atms = {
	...
	{name="ATM", id=277, x= 15.24, y=-1115.31, z=29.45},
	{name="ATM", id=277, x= -42.84, y=-1108.28, z=26.45},
	{name="ATM", id=277, x= 212.74, y=-1404.89, z=29.45},
	{name="ATM", id=277, x= 297.7, y=-587.1, z=43.45},
	{name="ATM", id=277, x= 315.18, y=-593.69, z=43.45},
}
--================================================================================================
...
if bankMenu then
	...
	if nearBank() or nearATM() then
		...
		ESX.ShowFloatingHelpNotification("Presiona [~r~E~w~] para acceder a BBVA ~b~", vector3(plyc.x, plyc.y, plyc.z))
