Locales['fr'] = {
    ...
    ['cyberman_outfit']            = 'Tenue de barman',
    ['security_outfit']          = 'Tenue agent de securiter',
    ['boss_outfit']              = 'Tenue de patron',
    ...
    ['cyber_fridge_stock']         = 'Frigo du bar cyber',
    ['fridge_inventory']         = 'Contenu du frigo',

    -- Shops  
    ['shop']                     = 'Boutique du bar cyber',
    ...
    ['cyber_stock']                = 'Stock du bar cyber',
    ...
    -- Crafting Menu  
    ['patochebeer']                     = 'Patoche Beer',
    ['dvrcocktail']                     = 'DVR cocktail',
    ['milkdragon']                      = 'Milk dragon',
    ['duffbeer']                        = 'Duff beer',
    ['jamesbondcocktail']               = 'Jamesbond Cocktail',
    ['scarfacecolada']                  = 'Scarface Colada',
    ['onepunchman']                     = 'One Punch Man Cocktail',
    ['dragonballcocktail']              = 'Dragon ball Cocktail',
    ['hulkcockail']                     = 'Hulk Cockail',
    ['vitodaiquiri']                    = 'Vito Daiquiri',
    ['marvelcocktail']                  = 'Marvel Cocktail',
    ['yoshishooter']                    = 'Yoshi shooter',
    ...
    -- Phone  
    ['cyber_phone']                = 'Cyber bar',
    ['cyber_customer']             = 'Citoyen',

    -- Teleporters
    ['e_to_enter_1']             = 'Appuyez sur ~INPUT_PICKUP~ pour passer derrière le cyber',
    ['e_to_exit_1']              = 'Appuyez sur ~INPUT_PICKUP~ pour passer devant le cyber.',
