...
function IsJobTrue()
    if PlayerData ~= nil then
        ...
        if PlayerData.job ~= nil and PlayerData.job.name == 'cyber' then
            IsJobTrue = true
        end
        return IsJobTrue
    end
...
function setUniform(job, playerPed)
  TriggerEvent('skinchanger:getSkin', function(skin)
    ...
    if skin.sex == 0 then
      ...
      if job ~= 'citizen_wear' and job ~= 'cyberman_outfit' and job ~= 'security_outfit' and job ~= 'boss_outfit' then
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    { label = _U('cyberman_outfit'),    value = 'cyberman_outfit'},
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'cyberman_outfit' then
      ...
      if data.current.value == 'boss_outfit' then
        setUniform(data.current.value, playerPed)
        iscyberman = true
      end
    ...
    ESX.TriggerServerCallback('esx_society:getVehiclesInGarage', function(garageVehicles)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data, menu)
          ...
          TriggerServerEvent('esx_society:removeVehicleFromGarage', 'cyber', vehicleProps)
...
function OpenSocietyActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'cyber_actions',
    {
      title    = _U('cyber'),
      align    = 'top-left',
      elements = elements
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_cyber', _U('billing'), amount)
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_cyberjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_cyberjob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_cyberjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_cyberjob:putStockItems', itemName, count)
            end
...
function OpenGetFridgeStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_cyberjob:getFridgeStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_cyberjob:getFridgeStockItem', itemName, count)
            end
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_cyberjob:putFridgeStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_cyberjob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_cyberjob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_cyberjob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
function OpenShopMenu(zone)
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'cyber_shop',
        {
            title    = _U('shop'),
            elements = elements
        },
        function(data, menu)
            TriggerServerEvent('esx_cyberjob:buyItem', data.current.value, data.current.price, data.current.realLabel)
        end,
        function(data, menu)
            menu.close()
        end
...
AddEventHandler('esx_cyberjob:hasEnteredMarker', function(zone)
...
AddEventHandler('esx_cyberjob:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_cyberjob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_cyberjob:hasExitedMarker', LastZone)
            end
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'cyber', vehicleProps)
            ...
            then
              TriggerServerEvent('esx_service:disableService', 'cyber')
            end
        ...
        if CurrentAction == 'menu_boss_actions' and IsGradeBoss() then
          ...
          TriggerEvent('esx_society:openBossMenu', 'cyber', function(data, menu)
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'cyber_actions') then
...
RegisterNetEvent('esx_basicneeds:onDrinkpatochebeer')
AddEventHandler('esx_basicneeds:onDrinkpatochebeer', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'boisson_patoche'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkdvrcocktail')
AddEventHandler('esx_basicneeds:onDrinkdvrcocktail', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'boisson_dvr'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkmilkdragon')
AddEventHandler('esx_basicneeds:onDrinkmilkdragon', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'boisson_milk'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkduffbeer')
AddEventHandler('esx_basicneeds:onDrinkduffbeer', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'boisson_duff'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkjamesbondcocktail')
AddEventHandler('esx_basicneeds:onDrinkjamesbondcocktail', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_pinacolada'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkscarfacecolada')
AddEventHandler('esx_basicneeds:onDrinkscarfacecolada', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_pinacolada'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkonepunchman')
AddEventHandler('esx_basicneeds:onDrinkonepunchman', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'boisson_onepunch'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkdragonballcocktail')
AddEventHandler('esx_basicneeds:onDrinkdragonballcocktail', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'boisson_dbz'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkhulkcockail')
AddEventHandler('esx_basicneeds:onDrinkhulkcockail', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'boisson_hulk'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkvitodaiquiri')
AddEventHandler('esx_basicneeds:onDrinkvitodaiquiri', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'prop_pinacolada'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkmarvelcocktail')
AddEventHandler('esx_basicneeds:onDrinkmarvelcocktail', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'boisson_marvel'
		IsAnimated = true
...
RegisterNetEvent('esx_basicneeds:onDrinkyoshishooter')
AddEventHandler('esx_basicneeds:onDrinkyoshishooter', function(prop_name)
	if not IsAnimated then
		prop_name = prop_name or 'boisson_yoshi'
		IsAnimated = true
