...
------------------------------------------- Blaine County
	...
	-- Joshua road
	Delivery4BC = {
			Pos   = {x = 153.09, y = -1029.25, z = 28.24},
			Color = {r = 204, g = 204, b = 0},
			Size  = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			Type  = 1,
	...
	-- East joshua road
	Delivery5BC = {
			Pos   = {x = 231.98, y = -1389.35, z = 29.48},
			Color = {r = 204, g = 204, b = 0},
			Size  = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			Type  = 1,
