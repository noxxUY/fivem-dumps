...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -206.393, y = -1327.034, z = 29.891 }, -- -206.393, -1327.034, 30.891
	...
	Garage = {
		Pos   = { x = -194.167, y = -1307.97, z = 31.215},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	Craft = {
		Pos   = { x = -196.745, y = -1318.818, z = 30.09 }, -- -196.745, -1318.818, 31.09
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = {x = -166.188, y = -1301.86, z = 31.346},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1
	},

	VehicleDeleter = {
		Pos   = {x = -184.524, y = -1288.05, z = 31.296},
