...
Config.AuthorizedVehicles = {
	Shared = {
		{ model = 'sheriff', label = 'Ford Fiesta', price = 1 },
		{ model = 'sheriff2', label = 'BMW X5', price = 1000 },
		{ model = 'police3', label = 'Ford ', price = 4000 },
		{ model = 'police2', label = 'LexusCNP', price = 5000 },
		{ model = 'ghispo2', label = 'MaseratiCNP', price = 6000 },
		{ model = 'policeb', label = 'MotoCNP', price = 8000 },
		{ model = 'riot', label = 'S.W.A.T', price = 10000 },
		{ model = 'firetruk', label = 'UIP', price = 1200 },
		{ model = 'policet', label = 'Jumpy', price = 15000 },
		{ model = 'pbus', label = 'Autobus Penitenciario', price = 5000 }
	},
	...
	boss = {
	{ model = 'umkscout', label = 'Secreta', price = 150000 }
	}
}
