...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(Config.MarkerZones) do
			DrawMarker(27, -1001.94, -2748.81, 12.76, 0, 0, 0, 0, 0, 0, 2.000, 2.000, 0.500, 0, 255, 255, 100, 0, 0, 0, 0)
			DrawMarker(27, 223.13, -867.83, 29.55, 0, 0, 0, 0, 0, 0, 2.000, 2.000, 0.500, 0, 255, 255, 100, 0, 0, 0, 0)
		end
    end
end)
