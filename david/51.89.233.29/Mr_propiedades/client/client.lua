...
local TeleportFromTo = {
	...
	["GroveStreet1"] = {
		...
		positionTo = { ['x'] = 7.03, ['y'] = -1880.46, ['z'] = -24.65 , nom = "GroveStreet1", precio = 120000},
	...
	["GroveStreet2"] = {
		...
		positionTo = { ['x'] = 22.06, ['y'] = -1894.41, ['z'] = -24.65 , nom = "GroveStreet2", precio = 130000},
	...
	["GroveStreet3"] = {
		...
		positionTo = { ['x'] = 37.97, ['y'] = -1910.53, ['z'] = -24.65 , nom = "GroveStreet3", precio = 140000},
	...
	["GroveStreet4"] = {
		...
		positionTo = { ['x'] = 51.93, ['y'] = -1924.51, ['z'] = -24.65 , nom = "GroveStreet4", precio = 130000},
	...
	["GroveStreet5"] = {
		...
		positionTo = { ['x'] = 63.1, ['y'] = -1936.37, ['z'] = -24.65 , nom = "GroveStreet5", precio = 120000},
	...
	["GroveStreet6"] = {
		...
		positionTo = { ['x'] = 73.02, ['y'] = -1946.48, ['z'] = -24.65 , nom = "GroveStreet6", precio = 120000},
	...
	["GroveStreet7"] = {
		...
		positionTo = { ['x'] = 85.04, ['y'] = -1957.55, ['z'] = -24.65 , nom = "GroveStreet7", precio = 140000},
	...
	["GroveStreet8"] = {
		...
		positionTo = { ['x'] = 118.0, ['y'] = -1963.49, ['z'] = -24.65 , nom = "GroveStreet8", precio = 120000},
	...
	["GroveStreet9"] = {
		...
		positionTo = { ['x'] = 128.05, ['y'] = -1918.51, ['z'] = -24.65 , nom = "GroveStreet9", precio = 130000},
	...
	["GroveStreet10"] = {
		...
		positionTo = { ['x'] = 118.06, ['y'] = -1909.42, ['z'] = -24.65 , nom = "GroveStreet10", precio = 130000},
	...
	["GroveStreet11"] = {
		...
		positionTo = { ['x'] = 106.03, ['y'] = -1899.46, ['z'] = -24.65 , nom = "GroveStreet11", precio = 120000},
	...
	["GroveStreet12"] = {
		...
		positionTo = { ['x'] = 54.92, ['y'] = -1868.49, ['z'] = -24.65 , nom = "GroveStreet12", precio = 120000},
	...
	["GroveStreet13"] = {
		...
		positionTo = { ['x'] = 43.97, ['y'] = -1858.53, ['z'] = -24.65 , nom = "GroveStreet13", precio = 140000},
	...
	["Grove Street 541"] = {
		...
		positionTo = { ['x'] = 33.06, ['y'] = -1848.58, ['z'] = -24.65 , nom = "Grove Street 541", precio = 130000},
	...
	["Covenant Avenue 1"] = {
		...
		positionTo = { ['x'] = 98.07, ['y'] = -1880.42, ['z'] = -24.65 , nom = "Covenant Avenue 1", precio = 120000},
	...
	["Covenant Avenue 2"] = {
		...
		positionTo = { ['x'] = 119.09, ['y'] = -1883.55, ['z'] = -24.65 , nom = "Covenant Avenue 2", precio = 130000},
	...
	["Covenant Avenue 3"] = {
		...
		positionTo = { ['x'] = 129.98, ['y'] = -1893.52, ['z'] = -24.65 , nom = "Covenant Avenue 3", precio = 120000},
	...
	["Strawberry1"] = {
		...
		positionTo = { ['x'] = 310.84, ['y'] = -1283.04, ['z'] = -7.9 , nom = "Strawberry1", precio = 150000},
	...
	["Strawberry2"] = {
		...
		positionTo = { ['x'] = 320.76, ['y'] = -1262.16, ['z'] = -7.9 , nom = "Strawberry2", precio = 150000},
	...
	["Vespucci Boulevard 1"] = {
		...
		positionTo = { ['x'] = -1027.3, ['y'] = -901.06, ['z'] = -37.9 , nom = "Vespucci Boulevard 1", precio = 110000},
	...
	["Vespucci Boulevard 2"] = {
		...
		positionTo = { ['x'] = -1037.2, ['y'] = -919.17, ['z'] = -37.9 , nom = "Vespucci Boulevard 2", precio = 100000},
	...
	["Vespucci Boulevard 3"] = {
		...
		positionTo = { ['x'] = -1055.24, ['y'] = -938.11, ['z'] = -37.9 , nom = "Vespucci Boulevard 3", precio = 110000},
	...
	["Vespucci Boulevard 4"] = {
		...
		positionTo = { ['x'] = -1078.28, ['y'] = -931.17, ['z'] = -37.9 , nom = "Vespucci Boulevard 4", precio = 110000},
	...
	["Vespucci Boulevard 5"] = {
		...
		positionTo = { ['x'] = -1096.1, ['y'] = -900.86, ['z'] = -37.9 , nom = "Vespucci Boulevard 5", precio = 95000},
	...
	["Imagination Court 1"] = {
		...
		positionTo = { ['x'] = -1034.16, ['y'] = -1045.74, ['z'] = -37.9 , nom = "Imagination Court 1", precio = 125000},
	...
	["Imagination Court 2"] = {
		...
		positionTo = { ['x'] = -1023.09, ['y'] = -1026.87, ['z'] = -37.9 , nom = "Imagination Court 2", precio = 115000},
	...
	["Imagination Court 3"] = {
		...
		positionTo = { ['x'] = -1052.03, ['y'] = -1009.7, ['z'] = -37.9 , nom = "Imagination Court 3", precio = 115000},
		...
		------------------ ENTRAR --------------------------
			if(Vdist(pos.x, pos.y, pos.z, j.positionFrom.x, j.positionFrom.y, j.positionFrom.z) < 7.0)then
				...
				if(Vdist(pos.x, pos.y, pos.z, j.positionFrom.x, j.positionFrom.y, j.positionFrom.z) < 5.0)then
					if propietario == 0 then
						Drawing.draw3DText(j.positionFrom.x, j.positionFrom.y, j.positionFrom.z - 1.100,"~b~" ..j.positionFrom.nom.. "~s~ no tiene dueño", 4, 0.2, 0.1, 255, 255, 255, 215)
						Drawing.draw3DText(j.positionFrom.x, j.positionFrom.y, j.positionFrom.z - 1.300,"Precio: ~y~" ..j.positionFrom.precio.." €", 4, 0.2, 0.1, 255, 255, 255, 215)
					elseif propietario == 1 then
						if mventa > 0 then
						Drawing.draw3DText(j.positionFrom.x, j.positionFrom.y, j.positionFrom.z - 0.800, "Propiedad en venta por ~y~" ..mventa.." €", 4, 0.2, 0.1, 255, 255, 255, 215)
						end
						Drawing.draw3DText(j.positionFrom.x, j.positionFrom.y, j.positionFrom.z - 1.100,"~b~" ..j.positionFrom.nom.. "~s~ es de " ..nombrepropietario, 4, 0.2, 0.1, 255, 255, 255, 215)
						Drawing.draw3DText(j.positionFrom.x, j.positionFrom.y, j.positionFrom.z - 1.300, "Puerta: "..puertaesta, 4, 0.2, 0.1, 255, 255, 255, 215)
						if soyelpropietario == 1 then
						Drawing.draw3DText(j.positionFrom.x, j.positionFrom.y, j.positionFrom.z - 1.600, "Presiona ~b~G~w~ para ~g~Abrir~w~/~r~Cerrar ~w~la puerta", 4, 0.05, 0.05, 255, 255, 255, 215)
						end
					end
					...
					if(Vdist(pos.x, pos.y, pos.z, j.positionFrom.x, j.positionFrom.y, j.positionFrom.z) < 1.0)then
						...
						AddTextComponentString("Presiona ~r~E~w~ para interactuar")--
						...
						TriggerServerEvent('pk_casas:checkcasa',j.positionFrom.nom)
							...
							elseif propietario == 1 then
								...
								elseif soyelpropietario == 0 then
									AbrirMenuConPropietario(nombrepropietario,j.positionFrom.nom,j.positionFrom.precio,j.positionFrom.x, j.positionFrom.y, j.positionFrom.z, 'Entrar')
								end
							end		
						end
			...
			if(Vdist(pos.x, pos.y, pos.z, j.positionTo.x, j.positionTo.y, j.positionTo.z) < 7.0)then
				...
				if(Vdist(pos.x, pos.y, pos.z, j.positionTo.x, j.positionTo.y, j.positionTo.z) < 5.0)then
					if propietario == 0 then
						Drawing.draw3DText(j.positionTo.x, j.positionTo.y, j.positionTo.z - 1.100,"~b~" ..j.positionTo.nom.. "~s~ no tiene dueño", 4, 0.2, 0.1, 255, 255, 255, 215)
						Drawing.draw3DText(j.positionTo.x, j.positionTo.y, j.positionTo.z - 1.300,"Precio: ~y~" ..j.positionFrom.precio.." €", 4, 0.2, 0.1, 255, 255, 255, 215)
					elseif propietario == 1 then
						...
						Drawing.draw3DText(j.positionTo.x, j.positionTo.y, j.positionTo.z - 1.300, "Puerta: "..puertaesta, 4, 0.2, 0.1, 255, 255, 255, 215)
						if soyelpropietario == 1 then
						Drawing.draw3DText(j.positionTo.x, j.positionTo.y, j.positionTo.z - 1.600, "Presiona ~b~G~w~ para ~g~Abrir~w~/~r~Cerrar ~w~la puerta", 4, 0.05, 0.05, 255, 255, 255, 215)
						end
					end
					if(Vdist(pos.x, pos.y, pos.z, j.positionTo.x, j.positionTo.y, j.positionTo.z) < 1.0)then
						...
						if IsControlJustPressed(1, 38) then
							...
							Citizen.Wait(10)
							if propietario == 0 then
								AbrirMenuNoPropietario(j.positionTo.nom,j.positionTo.precio,j.positionFrom.x, j.positionFrom.y, j.positionFrom.z, 'Salir')
							elseif propietario == 1 then
								if soyelpropietario == 1 then
									AbrirMenuSoyElPropietario(nombrepropietario,j.positionTo.nom,j.positionTo.precio,j.positionTo.x, j.positionTo.y, j.positionTo.z, 'Salir')
								elseif soyelpropietario == 0 then
									AbrirMenuConPropietario(nombrepropietario,j.positionTo.nom,j.positionTo.precio,j.positionTo.x, j.positionTo.y, j.positionTo.z, 'Salir')
								end
							end	
						end
						if IsControlJustPressed(1, 47) then
		 ...
		 if propietario == 1 then	
			if(Vdist(pos.x, pos.y, pos.z, j.menu.x, j.menu.y, j.menu.z) < 7.0)then
				...
				if(Vdist(pos.x, pos.y, pos.z, j.menu.x, j.menu.y, j.menu.z) < 5.0)then
						Drawing.draw3DText(j.menu.x, j.menu.y, j.menu.z - 1.100,"Administrar propiedad", 4, 0.2, 0.1, 255, 255, 255, 215)
			...
			if(Vdist(pos.x, pos.y, pos.z, j.armario.x, j.armario.y, j.armario.z) < 7.0)then
				...
				if(Vdist(pos.x, pos.y, pos.z, j.armario.x, j.armario.y, j.armario.z) < 5.0)then
						...
						Drawing.draw3DText(j.armario.x, j.armario.y, j.armario.z - 1.100,"Almacen de la propiedad", 4, 0.2, 0.1, 255, 255, 255, 215)
...
function AbrirMenuArmario(propiedad)
 ...
 ESX.TriggerServerCallback('pk_casas:getInventoryV', function(inventory)
    ...
    local elements = {}
    table.insert(elements, {label = 'Depositar', type = 'deposer', value = 'deposer'})
	
	if mdinero == 1 then
		table.insert(elements, {label = 'Dinero Sucio $' .. inventory.blackMoney, type = 'item_account', value = 'black_money'})
	end
...
function AbrirInventarioJugador(owner,propiedad)
  ...
  ESX.TriggerServerCallback('pk_casas:getPlayerInventory', function(inventory)
    ...
    local elements = {}
    table.insert(elements, {label = 'Retirar', type = 'retour', value = 'retour'})
...
function AbrirMenuMejoras(casanombre,preciogarage,precioarmas,preciodinero,precioitems)
	...
	if mgarage > 0 and preciogarage > 0 then
		table.insert(elements, {label = 'Mejora de garage: ADQUIRIDA', value = 'no'})
	elseif mgarage == 0 and  preciogarage > 0 then
		table.insert(elements, {label = 'Construir garage por $'..preciogarage, value = 'mejorasgarage'})
	...
	if marmas == 0 and precioarmas > 0 then
		table.insert(elements, {label = 'Construir almacen para armas $'..precioarmas, value = 'mejorasarmas'})
	elseif marmas > 0 and precioarmas > 0 then 
		table.insert(elements, {label = 'Mejora almacen de armas: ADQUIRIDA', value = 'no'})
	elseif precioarmas == 0 then 
		table.insert(elements, {label = 'Mejora almacen de armas: NO DISPONIBLE', value = 'no'})
	end
	...
	if mitems == 0 and precioitems > 0 then
		table.insert(elements, {label = 'Construir almacen para items $'..precioitems, value = 'mejorasitems'})
	elseif mitems > 0 and precioitems > 0 then 
		table.insert(elements, {label = 'Mejora almacen de items: ADQUIRIDA', value = 'no'})
	elseif precioitems == 0 then
		table.insert(elements, {label = 'Mejora almacen de items: NO DISPONIBLE', value = 'no'})
	end

	if mventa == 0 then 
		table.insert(elements, { label = "Poner en venta" ,value = "ponerenventa" })
		table.insert(elements, { label = "Cancelar" ,value = "no" })
	elseif mventa > 0 then
		table.insert(elements, { label = "Sacar de en venta" ,value = "sacarventa" })
		table.insert(elements, { label = "Cambiar valor" ,value = "cambiarvalor" })
		table.insert(elements, { label = "Cancelar" ,value = "no" })
	end
		...
		ESX.UI.Menu.Open(
			...
			{
			title  = "Mejoras para la propiedad" ,
			align = "top",
			elements = elements
...
function AbrirMenuNoPropietario(casanombre,precio, cordx, cordy, cordz, entrarosalir)
	...
	local pos = GetEntityCoords(GetPlayerPed(-1), true)
	local elements = {
		{label = "Comprar propiedad" ,value = "comprar"},
		...
		ESX.UI.Menu.Open(
			'default', GetCurrentResourceName(), 'menu_empresa',
			{
			title  = "Puerta de la propiedad "..casanombre ,
			elements = elements,
			align = "top"
			},
	function(data, menu)
...
local pos = GetEntityCoords(GetPlayerPed(-1), true)
	local elements = {}
		...
		table.insert(elements, { label = entrarosalir.." a la casa" ,value = "entrar"})
		...
		ESX.UI.Menu.Open(
			'default', GetCurrentResourceName(), 'menu_empresa',
			{
			title  = "Puerta de la propiedad "..casanombre.." de "..nombrepropietario,
			elements = elements,
			align = "top"
			},
	function(data, menu)
		...
		if data.current.value == "abrir" then 
			...
			Citizen.Wait(10)
			if estado == 1 then
				TriggerEvent('chatMessage', 'PROPIEDAD', {255, 0, 0},"La casa ya se encuentra abierta.")
			elseif estado == 0 then
				TriggerServerEvent('pk_casas:puerta',1,casanombre)
				Citizen.Wait(500)
				TriggerServerEvent('pk_casas:checkcasa',casanombre)
...
local pos = GetEntityCoords(GetPlayerPed(-1), true)
	...
	if mventa > 0 then 
		table.insert(elements, {label = entrarosalir.." a la casa" ,value = "entrar"})
		table.insert(elements, { label = "Comprar propiedad" ,value = "comprarcasa" })
		table.insert(elements, { label = "Cancelar" ,value = "no" })
	elseif mventa == 0 then
		table.insert(elements, {label = entrarosalir.." a la casa" ,value = "entrar"})
		table.insert(elements, { label = "Cancelar" ,value = "no" })
	...
	while true do
		...
		if mgarage == 1 then
			if(Vdist(pos.x, pos.y, pos.z, j.GuardarVehiculo.x, j.GuardarVehiculo.y, j.GuardarVehiculo.z) < 6.0)then
				...
				if(Vdist(pos.x, pos.y, pos.z, j.GuardarVehiculo.x, j.GuardarVehiculo.y, j.GuardarVehiculo.z) < 6.0)then
				Drawing.draw3DText(j.GuardarVehiculo.x, j.GuardarVehiculo.y, j.GuardarVehiculo.z - 1.100, "Guardar Vehiculo", 4, 0.2, 0.1, 255, 255, 255, 215)
					if(Vdist(pos.x, pos.y, pos.z, j.GuardarVehiculo.x, j.GuardarVehiculo.y, j.GuardarVehiculo.z) < 2.0)then
						ClearPrints()
						SetTextEntry_2("STRING")
						AddTextComponentString("Presiona ~r~E~w~ para guardar")--
		...
		if mgarage == 2 then
			...
			if IsInVehicle() then
				if(Vdist(pos.x, pos.y, pos.z, j.GuardarVehiculo.x, j.GuardarVehiculo.y, j.GuardarVehiculo.z) < 6.0)then
				Drawing.draw3DText(j.GuardarVehiculo.x, j.GuardarVehiculo.y, j.GuardarVehiculo.z - 1.100, "Sacar Vehiculo", 4, 0.2, 0.1, 255, 255, 255, 215)
					if(Vdist(pos.x, pos.y, pos.z, j.GuardarVehiculo.x, j.GuardarVehiculo.y, j.GuardarVehiculo.z) < 2.0)then
						ClearPrints()
						SetTextEntry_2("STRING")
						AddTextComponentString("Presiona ~r~E~w~ para sacar")--
						DrawSubtitleTimed(2000, 1)
						if IsControlJustPressed(1, 38) then
							TriggerServerEvent('pk_casas:checkcasa',j.GuardarVehiculo.nom)
							if soyelpropietario == 1 then
...
function reparation(vehicle,vehicleProps,propiedad)
	...
	local elements = {
		{label = "Guardar vehiculo", value = 'yes'},
		{label = "No guardar", value = 'no'},
	}
	ESX.UI.Menu.Open(
