...
Config.Zones = {
	...
	ls1 = {		--Bennys
		Pos   = { x = -211.93, y = -1324.08, z = 30.46},
	...
	ls2 = {  --Bennys
		Pos   = { x = -222.176, y = -1329.75, z = 30.890},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Hint  = _U('press_custom')
	...
	ls3 = {  --Bennys
		Pos   = { x = -193.384, y = -1323.41, z = 27.153},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Hint  = _U('press_custom')
	...
	ls4 = {  --Bennys
		Pos   = { x = -198.645, y = -1314.22, z = 27.153},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Hint  = _U('press_custom')
	...
	ls5 = {  --Bennys
	Pos   = { x = -222.501, y = -1324.16, z = 30.712},
	Size  = {x = 3.0, y = 3.0, z = 0.2},
	Color = {r = 204, g = 204, b = 0},
	Marker= 1,
	Hint  = _U('press_custom')
	...
	ls6 = {  --Bennys
	Pos   = {x = -233.584, y = -1315.97, z = 30.725},
	Size  = {x = 3.0, y = 3.0, z = 0.2},
	Color = {r = 204, g = 204, b = 0},
	Marker= 1,
	Hint  = _U('press_custom')
	...
	ls7 = {  --Bennys
	Pos   = {x = -235.852, y = -1311.44, z = 18.037},
	Size  = {x = 3.0, y = 3.0, z = 0.2},
	Color = {r = 204, g = 204, b = 0},
	Marker= 1,
	Hint  = _U('press_custom')
	...
	ls8 = {  --Bennys
	Pos   = {x = -238.022, y = -1328.80, z = 30.478},
	Size  = {x = 3.0, y = 3.0, z = 0.2},
	Color = {r = 204, g = 204, b = 0},
	Marker= 1,
	Hint  = _U('press_custom')
...
Config.Menus = {
	...
	cosmetics = {
		...
		modXenonMenu		= ('Color Luces Xenon'),
	...
	xenonColor = {
		label = 'Color Xenon de los Faros',
		parent = 'modXenon',
		modType = 'xenonColor',
		price = 0.66
	},
