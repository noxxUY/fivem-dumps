...
CreateThread(function() -- https://forum.cfx.re/t/minimap-without-health-armour-bar/937129/3
    local minimap = RequestScaleformMovie('minimap')
    local wasIn = true -- zeby pierwszy raz ukrylo radar
    ...
    while true do
        ...
        local isIn = IsPedInAnyVehicle(GetPlayerPed(-1))
