...
Config.Raiding = {
  ...
  CanAdminsRaid = false, -- Can Admins Raid Houses Default: true
  ItemRequired = { -- Item Required to Raid -- Remove To Disable
    RemoveItem = true, -- Remove Item from Inventory Default: true
    name = "lockpick", -- Item Name Default: "bread"
    label = "Ganzúa", -- Item label Default: "Bread"
    ItemCount = 4,   -- Item Count Default: 1
  },
  Animation = {
    type = "Scenario",
...
if IsDuplicityVersion() then 
  Config.Logs = {
    Webhook = "https://discord.com/api/webhooks/1020887594520809532/BTfJU7S_zD86CjZaUmDNkth5RsycezuMPnLKsiDiUY7cSbhNcXW9dMibruXEWLRHDg2T",
    LogLevel = 3
