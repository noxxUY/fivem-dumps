...
local Shop = {x = 1797.84,  y = 4199.0,  z = 290.16}
local NPC = {
    {seller = true, model = "a_m_y_acult_01", x = 1469.68,  y = 6549.76,  z = 13.92, h = 355},
    {seller = true, model = "cs_beverly", x = -266.44,  y = -968.64,  z = 30.24, h = 291.0},
    {seller = true, model = "ig_vagspeak", x = -819.8,  y = -694.36,  z = 27.08, h = 88.3},
}
...
function DisplayBoughtScaleform(weaponName, price)
	...
	PushScaleformMovieMethodParameterString("Has comprado ".. ESX.GetWeaponLabel(weaponName).." por ".. price .. "$")
...
Citizen.CreateThread(function()
    while true do
        ...
        if dist <= 2.5 then
            isNearShop = true
            ESX.ShowHelpNotification("Presiona ~INPUT_TALK~ para hablar con el ~r~vendedor")
