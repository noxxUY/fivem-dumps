...
Strings = {
    ['press_start'] = 'Presiona ~INPUT_PICKUP~ para agarrar una pelota',
    ['next_last_select'] = '~INPUT_CELLPHONE_RIGHT~ ~INPUT_CELLPHONE_LEFT~ Seleccionar\n~INPUT_FRONTEND_ENDSCREEN_ACCEPT~ Elegir\n~INPUT_FRONTEND_RRIGHT~ Cancelar',
    ['bowling_info'] = '~INPUT_CELLPHONE_LEFT~ ~INPUT_CELLPHONE_RIGHT~ Rotar\n~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ Cambiar fuerza\n~INPUT_MOVE_LEFT_ONLY~ ~INPUT_MOVE_RIGHT_ONLY~ Elegir camaras\n~INPUT_ATTACK~ Tirar\n~INPUT_FRONTEND_RRIGHT~ Dejar juego',
    ['force'] = 'Fuerza: %s',
    ['strike'] = {'Que crack papá', 'Hiciste un STRIKE!!'},
    ['spare'] = {'Bowling', 'Bien ahí, hiciste una chuza'},
    ['x_pinsdown'] = {'Bowling', 'Tenes %s de %s bolos'},
    ['this_occupied'] = 'Esta pista está ocupada.',
    ['every_occupied'] = 'No hay espacio para jugar.',
    ['blip'] = 'Bowling'
}