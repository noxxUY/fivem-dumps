...
Config.ClothingCost = 1500
Config.BarberCost = 900
Config.TattooCost = 2000
...
Config.Stores = {
    ...
    {
        type = "clothing",
        coords = vector4(4433.64, -4447.72, 7.24, 335.41),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(4433.64, -4447.72, 7.24)

        }
    },
    {
        type = "clothing",
        coords = vector4(-1525.28, 118.56, 55.64, 335.41),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-1525.28, 118.56, 55.64)

        }
    },
    {
        type = "clothing",
        coords = vector4(-279.6, -722.36, 125.48, 335.41),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-279.6, -722.36, 125.48)

        }
    },
    {
        type = "clothing",
        coords = vector4(-3219.6, 810.6, 8.96, 335.41),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-3219.6, 810.6, 8.96)

        }
    },
    {
        type = "clothing",
        coords = vector4(1403.8, 1144.72, 114.32, 335.41),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(1403.8, 1144.72, 114.32)
...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(460.9755, -980.2864, 34.2974, 269.1008),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(460.9755, -980.2864, 34.2974)
        }
    },
    {
        job = "ambulance",
        coords = vector4(298.1877, -599.4156, 43.2841, 70.8672),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(298.1877, -599.4156, 43.2841)
        }
    },
    {
        job = "mechanic",
        coords = vector4(-345.4498, -123.0961, 39.0097, 249.2393),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-310.7375, -137.5384, 39.0095)
        }
    }
}
        ...
        ["Male"] = {
            {
                ...
                outfitData = {
                    ...
                    ["vest"] = {item = 0, texture = 0}, -- Body Vest
                    ["torso2"] = {item = 251, texture = 17}, -- Jacket
        ...
        ["Female"] = {
            {
                name = "Mecanico",
                outfitData = {
                    ["pants"] = {item = 100, texture = 23}, -- Pants
                    ["arms"] = {item = 46, texture = 0}, -- Arms
                    ["t-shirt"] = {item = 0, texture = 0}, -- T Shirt
                    ["vest"] = {item = 0, texture = 0}, -- Body Vest
                    ["torso2"] = {item = 259, texture = 23}, -- Jacket
                    ["shoes"] = {item = 24, texture = 0}, -- Shoes
                    ["accessory"] = {item = 0, texture = 0}, -- Neck Accessory
                    ["bag"] = {item = 0, texture = 0}, -- Bag
                    ["hat"] = {item = -1, texture = -1}, -- Hat
