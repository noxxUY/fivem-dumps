	...
	Config.Sell = {
		{
			...
			type = "legal",
			sellText = "Mercado de peces",
			blip = 317,
			colour = 69
		},
	{
			pos = vec3(-312.6 , -2780.04, 4.0), 
			type = "illegal", 
			sellText = "Mercado ilegal de peces",
			blip = 68,
			colour = 49
		}
	}
...
Config.RentalBoats = {
	{model = "seashark", price = 2500},
	{model = "dinghy", price = 5000},
	{model = "marquis", price = 6000},
	{model = "tropic", price = 15000},
	{model = "jetmax", price = 20000},
	{model = "speeder", price = 30000},
	{model = "tug", price = 50000},
