...
function OpenMechanicActionsMenu()
	...
	ESX.OpenContext("right", elements, function(menu,element)
		...
		elseif element.value == 'boss_actions' then
			TriggerEvent('esx_society:openBosssMenu', 'mechanic', function(data, menu)
			      ESX.CloseContext()
			end)
		end
	end, function(menu)
	...
	ESX.OpenContext("right", elements, function(menu,element)
		...
		if element.value == "billing" then
			local elements2 = {
				...
				{title = "Amount", input = true, inputType = "number", inputMin = 1, inputMax = 1000000000, inputPlaceholder = "Amount to bill.."},
