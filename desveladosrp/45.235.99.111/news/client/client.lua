...
Citizen.CreateThread(function ()
	while true do
		...
		for k, v in pairs(Config.NewsLocations) do
			...
			if dist < 3 then
				DrawText3D(Config.NewsLocations[k].NewsLocation.x, Config.NewsLocations[k].NewsLocation.y, Config.NewsLocations[k].NewsLocation.z + 0.5, "Presiona ~b~[E]~w~ ~n~ para ver las noticias")
