...
AddTextEntry('VEH_E_DETATCH', 'Presione ~INPUT_VEH_HORN~ para bajar el vehículo')        -- Text for external detach point
AddTextEntry('VEH_I_AORD', 'Presione ~INPUT_VEH_HORN~ para acoplar/desconectar el vehículo')   -- Text for in boat attach/detach
AddTextEntry('VEH_I_RAMP', 'Presione ~INPUT_VEH_HORN~ para Bajar/Subir la Rampa')   -- Text for in boat attach/detach
