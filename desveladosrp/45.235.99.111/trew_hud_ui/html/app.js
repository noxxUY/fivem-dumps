...
window.onload = function () {
		...
		var eventCallback = {
			ui: function(data) {
				...
				if (config.showWalletMoney == false) { document.querySelector('#wallet').style.display = 'block'; }
				if (config.showBankMoney == false) { document.querySelector('#bank').style.display = 'block'; }
				if (config.showBlackMoney == false) { document.querySelector('#blackMoney').style.display = 'block'; }
				if (config.showSocietyMoney == true) { document.querySelector('#society').style.display = 'block'; }
				if (config.showWalletMoney == false) { document.querySelector('#weight').style.display = 'block'; }
				...
				if (config.showJob == false) { document.querySelector('#job').style.display = 'block'; }
