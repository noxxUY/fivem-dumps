...
Config.Languages = {
      ['en'] = {
        ...
        ['camera'] = "Presiona ~y~Q~w~ para usar el flash de la cámara.",
        ['makeitrain'] = "Presiona ~y~Q~w~ para que llueva.",
        ['pee'] = "Sostén ~y~Q~w~ para orinar.",
        ['spraychamp'] = "Sostén ~y~Q~w~ para batir la champagna",
        ['bound'] = "Ligador ",
        ['to'] = "a",
