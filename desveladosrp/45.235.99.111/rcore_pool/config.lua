Config = {
    ...
    Text = {
        BACK = "Atras",
        HIT = "Pegar",
        BALL_IN_HAND = "Toma la pelota",
        BALL_IN_HAND_BACK = "Atrás",
        AIM_LEFT = "Girar a la izquierda",
        AIM_RIGHT = "Girar a la derecha",
        ...
        TYPE_8_BALL = '8-Ball',
        TYPE_STRAIGHT = 'Pool normal',

        HINT_SETUP = 'Instalar juego',
        HINT_TAKE_CUE = 'Agarrar taco',
        HINT_RETURN_CUE = 'Dejar taco.',
        HINT_HINT_TAKE_CUE = 'No puedes jugar sin taco',
        HINT_PLAY = 'Jugar',
        ...
        BALL_POCKETED = '%s adentro',
        BALL_IN_HAND_NOTIFY = 'Tienes la bola de billar',
        BALL_LABELS = {
            [-1] = 'Blanca',
            [1] = '~y~Lisa 1~s~',
            [2] = '~b~Lisa 2~s~',
