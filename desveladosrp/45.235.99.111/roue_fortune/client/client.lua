...
local _wheelPos = vector3(1109.76, 227.89, -49.20)
local _baseWheelPos = vector3(1111.05, 229.81, -50.63)
local Keys = {
...
Citizen.CreateThread(function()
    ...
    if ESX.IsPlayerLoaded() then
        ...
        local carmodel = GetHashKey('tecnica')
...
function doRoll()
    if not _isRolling then
        ...
        ESX.Streaming.RequestAnimDict(lib, function()
            local _movePos = vector3(1109.55, 228.88, -50.38)
