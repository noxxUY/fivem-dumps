        ...
        if vehInTable(els_Vehicles, checkCarHash(GetVehiclePedIsUsing(PlayerPedId()))) then
            if (GetPedInVehicleSeat(GetVehiclePedIsUsing(PlayerPedId()), -1) == PlayerPedId()) or
                ...
                if(GetLastInputMethod(0)) then
                    ...
                    if (doesVehicleHaveTrafficAdvisor(GetVehiclePedIsUsing(PlayerPedId()))) then
                        if IsDisabledControlPressed(0, keyboard.modifyKey) then
                        ...
                        if (elsVehs[GetVehiclePedIsUsing(PlayerPedId())] ~= nil) then
                            if elsVehs[GetVehiclePedIsUsing(PlayerPedId())].stage == 3 then
                                if IsDisabledControlJustReleased(0, keyboard.siren.tone_one) then
                                    ...
                                    if m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 2 or
                                       m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 3 or
                                       m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 0 then
                                        TriggerServerEvent("els:setSirenState_s", 1)
                                    elseif m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 1 then
                                ...
                                if IsDisabledControlJustReleased(0, keyboard.siren.tone_two) then
                                    ...
                                    if m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 1 or
                                       m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 3 or
                                       m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 0 then
                                        TriggerServerEvent("els:setSirenState_s", 2)
                                    elseif m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 2 then
                                        TriggerServerEvent("els:setSirenState_s", 0)
                                    end
                                end
                                if IsDisabledControlJustReleased(0, keyboard.siren.tone_three) then
                                    ...
                                    if m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 1 or
                                       m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 2 or
                                       m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 0 then
                                        TriggerServerEvent("els:setSirenState_s", 3)
                                    elseif m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 3 then
                                        TriggerServerEvent("els:setSirenState_s", 0)
                                    end
                                end
                                ...
                                if IsDisabledControlJustReleased(0, keyboard.siren.dual_toggle) then
                                    ...
                                    if dualEnable[GetVehiclePedIsUsing(PlayerPedId())] then
                    ...
                    if els_Vehicles[checkCarHash(GetVehiclePedIsUsing(PlayerPedId()))].activateUp then
                        ...
                        if IsDisabledControlPressed(0, keyboard.modifyKey) and IsDisabledControlJustReleased(0, keyboard.stageChange) then
                            ...
                            if newStage == 1 then
                                if not doesVehicleHaveTrafficAdvisor(GetVehiclePedIsUsing(PlayerPedId())) then
                                    newStage = 0
                                end
                            end
...
Citizen.CreateThread(function()
    while true do
        ...
        if guiEnabled and vehInTable(els_Vehicles, checkCarHash(GetVehiclePedIsUsing(PlayerPedId()))) then
            if (GetPedInVehicleSeat(GetVehiclePedIsUsing(PlayerPedId()), -1) == PlayerPedId()) or
                (GetPedInVehicleSeat(GetVehiclePedIsUsing(PlayerPedId()), 0) == PlayerPedId()) then
                local vehN = checkCarHash(GetVehiclePedIsUsing(PlayerPedId()))
                ...
                if (h_horn_state[GetVehiclePedIsUsing(PlayerPedId())] == 1) then
                ...
                if (m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 1) then
                    if (d_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 1) then
                ...
                if (m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 2) then
                    if (d_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 2) then
                ...
                if (m_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 3) then
                    if (d_siren_state[GetVehiclePedIsUsing(PlayerPedId())] == 3) then
