...
Config.Zones = {
	...
	ls8 = {
		Pos   = { x = -221.56,  y = -1329.68,  z = 30.88},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modArmor = {
		...
		parent = 'upgrades',
		modType = 16,
		price = {1112190.00, 1112190.00, 1112190.00, 1112190.00, 1112190.00, 1112190.00}
	},
	modTurbo = {
