  ...
  window.addEventListener("message", function (event) {
    ...
    if (action == "setHealth") {
      ...
      Circle.HealthIndicator.path.setAttribute(
        "stroke",
        health ? "rgb(0, 191, 255)" : "rgb(255, 0, 0)"
      );
    ...
    if (action == "setStamina") {
      if (data) {
        ...
        Circle.StaminaIndicator.path.setAttribute(
          "stroke",
          stamina < 0.1 ? "rgb(0, 191, 255)" : "rgb(0, 191, 255)"
        );
    ...
    if (action == "setOxygen") {
      if (data) {
        ...
        Circle.OxygenIndicator.path.setAttribute(
          "stroke",
          oxygen < 0.1 ? "rgb(0, 191, 255)" : "rgb(0, 191, 255)"
        );
    ...
    if (action == "setVehicle") {
      if (data) {
        ...
        Circle.FuelIndicator.path.setAttribute(
          "stroke",
          fuel > 0.15 ? "rgb(0, 191, 255)" : "rgb(255, 0, 0)"
        );
    ...
    if (action == "setVoice") {
      ...
      if (data == "disconnected") {
        ...
        Circle.VoiceIndicator.path.setAttribute(
          "stroke",
          data ? "rgb(0, 191, 255)" : "rgb(169, 169, 169)"
        );
