...
Config.Noclip = { 'admin', 'mod' , 'sup' }
Config.Goto = { 'admin', 'mod' , 'sup' }
Config.Bring = { 'admin', 'mod' , 'sup' }
Config.Kill = { 'admin', 'mod' , 'sup' }
Config.Tpm = { 'admin', 'mod' , 'sup'  }
Config.Car = { 'admin', 'mod' }
Config.Dv = { 'admin', 'mod' , 'sup' }
Config.Giveitem  = { 'admin', 'mod' }
Config.GiveWeapon = { 'admin', 'mod' }
Config.Setjob = { 'admin', 'mod' }
Config.Giveaccountmoney = { 'admin' }
Config.Freeze = { 'admin' }
Config.Unfreeze = { 'admin' }
Config.ClearLoadout = { 'admin', 'mod' }
Config.ClearInventory = { 'admin', 'mod' }