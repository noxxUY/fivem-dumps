			...
			function(data2, menu2)
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					if action == 'identity_card' then
						ExecuteCommand ("me Lo revisa en busca de sus identificaciones")
						OpenIdentityCardMenu(closestPlayer)
					elseif action == 'search' then
						ExecuteCommand ("me Lo cachea")
						OpenBodySearchMenu(closestPlayer)
					elseif action == 'handcuff' then
						ExecuteCommand ("me Le pone/saca las esposas")
						TriggerServerEvent('esx_policejob:hasndcuff', GetPlayerServerId(closestPlayer))
					elseif action == 'drag' then
						ExecuteCommand ("me Lo agarra del brazo y lo escolta")
						TriggerServerEvent('esx_policejob:drag', GetPlayerServerId(closestPlayer))
					elseif action == 'put_in_vehicle' then
						ExecuteCommand ("me Lo mete con cuidado dentro del vehículo y le pone el cinturón")
						TriggerServerEvent('esx_policejob:putInVehicle', GetPlayerServerId(closestPlayer))
					elseif action == 'out_the_vehicle' then
						ExecuteCommand ("me Le saca el cinturón y lo ayuda a bajar del vehículo")
						TriggerServerEvent('esx_policejob:OutVehicle', GetPlayerServerId(closestPlayer))
					elseif action == 'fine' then
						ExecuteCommand ("me Le escribe una multa y se la entrega")
						OpenFineMenu(closestPlayer)
					elseif action == 'license' then
						ExecuteCommand ("me Le revisa las licencias correspondientes")
		...
		elseif data.current.value == 'vehicle_interaction' then
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_interaction', {
				...
				if action == 'search_database' then
					ExecuteCommand ("me Se acerca al auto para conseguir información")
					LookupVehicle()
				elseif DoesEntityExist(vehicle) then
					if action == 'vehicle_infos' then
						ExecuteCommand ("me Revisa en busca del dueño, papeles reglamentarios y la patente")
						local vehicleData = ESX.Game.GetVehicleProperties(vehicle)
						OpenVehicleInfosMenu(vehicleData)
					elseif action == 'hijack_vehicle' then
						ExecuteCommand ("me Fuerza la cerradura del vehículo")
					...
					elseif action == 'impound' then
						ExecuteCommand ("do Se vería como una grúa se lleva el vehículo")
						-- is the script busy?
...
RegisterNetEvent('esx_policejob:hasndcuff')
AddEventHandler('esx_policejob:hasndcuff', function()
		...
		if CurrentAction then
			...
			if IsControlJustReleased(0, 38) and ESX.PlayerData.job and ESX.PlayerData.job.name == 'police' then
				...
				elseif CurrentAction == 'menu_boss_actions' then
					ESX.UI.Menu.CloseAll()
					TriggerEvent('esx_society:openBosssMenu', 'police', function(data, menu)
						menu.close()
