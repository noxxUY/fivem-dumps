Locales['es'] = {
  ...
  ['garage_has_notstored'] = 'No se han encontrado vehículos, debe bajarte',
  ...
  ['garage_released'] = 'Tu vehículo ha salido del garage.',
  ...
  ['fine'] = 'Multa',
  ['unpaid_bills'] = 'Ver multas impagas',
  ...
  ['licence_you_revoked'] = 'Revocaste la licencia ~b~%s~s~ que le pertenecía a ~y~%s~s~',
  ...
  ['you_confiscated'] = 'Has confiscado ~y~%sx~s~ ~b~%s~s~ ded ~b~%s~s~',
