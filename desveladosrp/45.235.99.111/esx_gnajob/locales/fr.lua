Locales['fr'] = {
  ...
  ['carabineros_wear'] = 'tenue Policier',
  ...
  ['being_searched'] = 'vous êtes ~y~recherché(e)~s~ par la ~b~carabineros~s~',
  -- Vehicle interaction
  ...
  ['carabineros_stock'] = 'coffre de la carabineros',
  -- Misc
  ...
  -- Notifications
  ['alert_carabineros'] = 'alerte carabineros',
