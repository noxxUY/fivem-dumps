Locales['cs'] = {
  ...
  ['carabineros_wear'] = 'carabinerosjní oblek',
  ...
  ['quantity'] = 'množství',
  ['inventory'] = 'inventář',
  ['carabineros_stock'] = 'carabinerosjní sklad',
  -- Misc
  ['remove_prop'] = 'stiskni ~INPUT_CONTEXT~ pro odstranění předmětu',
  ['map_blip'] = 'carabinerosjní stanice',
  ['unrestrained_timer'] = 'cítíš, že tvé pouta pomalu ztrácejí přilnavost a padají.',
  -- Notifications
  ['alert_carabineros'] = 'carabinerosjní poplach',
  ['phone_carabineros'] = 'policie',
}
