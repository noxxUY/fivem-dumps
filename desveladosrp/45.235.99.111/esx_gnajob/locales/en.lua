Locales['en'] = {
  ...
  ['carabineros_wear'] = 'carabineros Outfit',
  ...
  ['being_searched'] = 'you are being ~y~searched~s~ by the ~b~carabineros~s~',
  -- Vehicle interaction
