...
function spawnBusDriver(Depot, cb)
    Citizen.CreateThread(function()
        ...
        activeDriver = CreatePed(5, 's_m_m_pilot_01', Depot.zones.menu.x+1.0, Depot.zones.menu.y, Depot.zones.menu.z, 0.0, true, false)        
...
AddEventHandler('bdm:beginroute', function(busData)
    ...
    local busdriver = spawnBusDriver(zData, function(pData)
        Citizen.Wait(100)
        local drivenbus = spawnBusAtDepot('xd60', zData.zones.departure.x, zData.zones.departure.y, zData.zones.departure.z, zData.zones.departure.h, pData, 1, function(bData)
