...
$(document).ready(function(){
                    ...
                    html += `<div class="col-4 mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Precio: <b>`+car.price+`$</b></p>
                                    </div>
                                    <div class="card-footer bg-white border-0 ">
                                        ...
                                        <button type="button" id="action2" data-value="test-drive" data-model="`+ car.model +`" class="btn btn-success w-auto float-right btn-lg test-drive">Probar</button>
                                    </div>
                                </div>
                            </div>`
                    index++;
    ...
    window.addEventListener('message', function(event) {
        ...
        $('#brand').html(`<option selected value="-1">Todas las marcas</option>`)
