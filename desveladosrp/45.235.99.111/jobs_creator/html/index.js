...
function addGarageSpawnpoint(listDiv, spawnpointData) {
	let div = $(`
		<div class="input-group spawnpoint-div my-2">
			...
			<span class="input-group-text translatable" data-translation-id="menu:coords">Coords</span>
			...
			<span class="input-group-text translatable" data-translation-id="menu:heading">Heading</span>
			...
			<span class="input-group-text translatable ms-2" data-translation-id="menu:radius">Radius</span>
