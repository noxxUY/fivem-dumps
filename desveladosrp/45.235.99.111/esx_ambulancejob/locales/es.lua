Locales['es'] = {
  ...
  ['distress_send'] = 'Escribe [~b~/auxilio~s~] para enviar una señal de socorro',
  ['distress_sent'] = 'Se ha enviado una señal de socorro a las unidades disponibles.',
  ['combatlog_message'] = 'Ha sido reaparecido a la fuerza porque anteriormente abandonaste el servidor cuando estabas muerto.',
  -- Revive
