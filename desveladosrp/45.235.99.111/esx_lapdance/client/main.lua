...
local blips = {
     ...
     --{title="Strippklubb", colour=7, id=121, x = 128.87, y = -1298.93, z = 4.0};
...
Citizen.CreateThread(function()
    ...
    Citizen.Wait(0)
        ...
        if GetDistanceBetweenCoords(coords, 117.19, -1294.86, 28.42, true) < 100 then
            ...
            Draw3DText(117.19, -1294.86, 29.63, tostring("Presiona ~r~[E]~w~ para tener un baile privado por ~r~$10000"))
...
AddEventHandler('esx_lapdance:lapdance', function()
			RequestModel(1381498905)
			while not HasModelLoaded(1381498905) do
				Wait(0)
			end
			TriggerEvent("malte-cinema:activate")
			SetEntityHeading(GetPlayerPed(-1), 120.18)
			local SpawnObject = CreatePed(4, 1381498905, 116.59, -1301.04, 28.17)
